...
var RunStartQuest = {
  ...
  tasks: [{
    ...
    name: "Harvest Garden",
    completed: () => !getGarden() || getGarden() === template_string_$item(runstart_templateObject52 || (runstart_templateObject52 = runstart_taggedTemplateLiteral(["packet of mushroom spores"]))) || (0,external_kolmafia_namespaceObject.getCampground)()[getGarden().name] === 0,
