...
var MysticalityQuest = {
  ...
  tasks: [{
    ...
    prepare: () => {
      (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(stat_templateObject34 || (stat_templateObject34 = stat_taggedTemplateLiteral(["Bind Undead Elbow Macaroni"]))));
      var usefulEffects = [$effect(stat_templateObject35 || (stat_templateObject35 = stat_taggedTemplateLiteral(["Big"]))), $effect(stat_templateObject36 || (stat_templateObject36 = stat_taggedTemplateLiteral(["Glittering Eyelashes"]))), $effect(stat_templateObject37 || (stat_templateObject37 = stat_taggedTemplateLiteral(["Hulkien"]))), $effect(stat_templateObject38 || (stat_templateObject38 = stat_taggedTemplateLiteral(["The Magical Mojomuscular Melody"]))), $effect(stat_templateObject39 || (stat_templateObject39 = stat_taggedTemplateLiteral(["Triple-Sized"]))), $effect(stat_templateObject40 || (stat_templateObject40 = stat_taggedTemplateLiteral(["Pasta Oneness"]))), $effect(stat_templateObject41 || (stat_templateObject41 = stat_taggedTemplateLiteral(["Quiet Judgement"]))), $effect(stat_templateObject42 || (stat_templateObject42 = stat_taggedTemplateLiteral(["Song of Bravado"]))), $effect(stat_templateObject43 || (stat_templateObject43 = stat_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"])))];
      usefulEffects.forEach(ef => tryAcquiringEffect(ef, true));
    },
    do: () => {
...
var LevelingQuest = {
  ...
  tasks: [{
    ...
    completed: () => lib_have(template_string_$item(_templateObject280 || (_templateObject280 = leveling_taggedTemplateLiteral(["wad of dough"])))),
    do: () => {
