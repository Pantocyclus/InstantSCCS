...
function checkResources() {
  (0,external_kolmafia_namespaceObject.printHtml)("Legend: <font color='black'>✓ Saved Resource</font> / <font color='#888888'>X Usable Resource");
  (0,external_kolmafia_namespaceObject.print)("  pref - helptext", "blue");
...
var LevelingQuest = {
  ...
  tasks: [{
    ...
    completed: () => monstersReminisced().includes($monster(_templateObject225 || (_templateObject225 = leveling_taggedTemplateLiteral(["red skeleton"])))) || !availableLocketMonsters().includes($monster(_templateObject226 || (_templateObject226 = leveling_taggedTemplateLiteral(["red skeleton"])))) || property_get("instant_saveLocketRedSkeleton", false),
    ...
    completed: () => monstersReminisced().includes($monster(_templateObject299 || (_templateObject299 = leveling_taggedTemplateLiteral(["Witchess King"])))) || !availableLocketMonsters().includes($monster(_templateObject300 || (_templateObject300 = leveling_taggedTemplateLiteral(["Witchess King"])))) || property_get("instant_saveLocketWitchessKing", false),
