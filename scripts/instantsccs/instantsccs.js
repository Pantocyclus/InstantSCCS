...
var RunStartQuest = {
  ...
  tasks: [{
    ...
    completed: () => !lib_have(template_string_$item(runstart_templateObject50 || (runstart_templateObject50 = runstart_taggedTemplateLiteral(["potted power plant"])))) || property_get("_pottedPowerPlant").split(",").every(s => s === "0"),
    do: () => {
      (0,external_kolmafia_namespaceObject.visitUrl)("inv_use.php?pwd&whichitem=".concat((0,external_kolmafia_namespaceObject.toInt)(template_string_$item(runstart_templateObject51 || (runstart_templateObject51 = runstart_taggedTemplateLiteral(["potted power plant"]))))));
    ...
    name: "Harvest Garden",
    completed: () => !getGarden() || getGarden() === template_string_$item(runstart_templateObject52 || (runstart_templateObject52 = runstart_taggedTemplateLiteral(["packet of mushroom spores"]))) || (0,external_kolmafia_namespaceObject.getCampground)()[getGarden().name] === 0 || property_get("instant_saveGarden", false),
    ...
    name: "Autumnaton",
    completed: () => !lib_have(template_string_$item(runstart_templateObject53 || (runstart_templateObject53 = runstart_taggedTemplateLiteral(["autumn-aton"])))) || lib_have(template_string_$item(runstart_templateObject54 || (runstart_templateObject54 = runstart_taggedTemplateLiteral(["autumn leaf"])))) || lib_have($effect(runstart_templateObject55 || (runstart_templateObject55 = runstart_taggedTemplateLiteral(["Crunching Leaves"])))),
    ...
    completed: () => !lib_have(template_string_$item(runstart_templateObject56 || (runstart_templateObject56 = runstart_taggedTemplateLiteral(["model train set"])))) || (0,external_kolmafia_namespaceObject.getWorkshed)() === template_string_$item(runstart_templateObject57 || (runstart_templateObject57 = runstart_taggedTemplateLiteral(["model train set"]))) && !canConfigure(),
    do: () => {
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(runstart_templateObject58 || (runstart_templateObject58 = runstart_taggedTemplateLiteral(["model train set"]))));
    ...
    prepare: () => {
      if (lib_have(template_string_$item(runstart_templateObject59 || (runstart_templateObject59 = runstart_taggedTemplateLiteral(["unbreakable umbrella"])))) && property_get("umbrellaState") !== "pitchfork style") (0,external_kolmafia_namespaceObject.cliExecute)("umbrella weapon");
    },
    ...
    do: $location(runstart_templateObject60 || (runstart_templateObject60 = runstart_taggedTemplateLiteral(["The Dire Warren"]))),
    ...
    outfit: {
      ...
      familiar: template_string_$familiar(runstart_templateObject79 || (runstart_templateObject79 = runstart_taggedTemplateLiteral(["Cookbookbat"]))),
    ...
    completed: () => lib_have(template_string_$item(runstart_templateObject89 || (runstart_templateObject89 = runstart_taggedTemplateLiteral(["cherry"])))) && !lib_have(template_string_$item(runstart_templateObject90 || (runstart_templateObject90 = runstart_taggedTemplateLiteral(["cosmic bowling ball"])))) && property_get("_snokebombUsed") >= 1,
    ...
    outfit: {
      ...
      familiar: template_string_$familiar(runstart_templateObject98 || (runstart_templateObject98 = runstart_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape, -equip miniature crystal ball"
    },
    post: () => {
    ...
    outfit: {
      ...
      acc1: template_string_$item(runstart_templateObject119 || (runstart_templateObject119 = runstart_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(runstart_templateObject120 || (runstart_templateObject120 = runstart_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    combat: new CombatStrategy().macro(combat_Macro["default"]())
  }]
