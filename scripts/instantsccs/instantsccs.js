...
function checkResources() {
  (0,external_kolmafia_namespaceObject.printHtml)("Legend: <font color='black'>✓ Saved Resource</font> / <font color='#888888'>X Usable Resource <font color='black'>(prefname - helptext)");
