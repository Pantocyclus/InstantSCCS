...
var RunStartQuest = {
  ...
  tasks: [{
    ...
    do: () => {
      ...
      (0,external_kolmafia_namespaceObject.hermit)(template_string_$item(runstart_templateObject70 || (runstart_templateObject70 = runstart_taggedTemplateLiteral(["11-leaf clover"]))), 1);
    },
    acquire: [{
