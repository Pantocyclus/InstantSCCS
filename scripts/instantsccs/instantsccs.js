...
var LevelingQuest = {
  ...
  tasks: [{
    ...
    have(template_string_$item(_templateObject181 || (_templateObject181 = leveling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || property_get("_shadowRiftCombats", 0) >= 12,
    // eslint-disable-next-line libram/verify-constants
    do: () => {
    ...
    outfit: {
      ...
      familiar: template_string_$familiar(_templateObject185 || (_templateObject185 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    choices: {
      1498: 1
    ...
    post: () => {
      if (have((0,external_kolmafia_namespaceObject.toItem)(property_get("rufusQuestTarget", "")))) {
        // eslint-disable-next-line libram/verify-constants
        (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject186 || (_templateObject186 = leveling_taggedTemplateLiteral(["closed-circuit pay phone"]))));
      }
    ...
    do: $location(_templateObject187 || (_templateObject187 = leveling_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
    ...
    do: powerlevelingLocation(),
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject191 || (_templateObject191 = leveling_taggedTemplateLiteral(["Snokebomb"])))).abort()),
    outfit: {
    ...
    completed: () => {
      ...
      return !have(template_string_$item(_templateObject195 || (_templateObject195 = leveling_taggedTemplateLiteral(["backup camera"])))) || !freeFightMonsters.includes((_get2 = property_get("lastCopyableMonster")) !== null && _get2 !== void 0 ? _get2 : $monster.none) || property_get("_backUpUses") >= 11;
    },
    do: $location(_templateObject196 || (_templateObject196 = leveling_taggedTemplateLiteral(["The Dire Warren"]))),
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject197 || (_templateObject197 = leveling_taggedTemplateLiteral(["Back-Up to your Last Enemy"])))).default()),
    outfit: {
      back: template_string_$item(_templateObject198 || (_templateObject198 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      ...
      acc3: template_string_$item(_templateObject201 || (_templateObject201 = leveling_taggedTemplateLiteral(["backup camera"]))),
      familiar: template_string_$familiar(_templateObject202 || (_templateObject202 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    post: () => {
      var _get3;
    ...
    completed: () => getKramcoWandererChance() < 1.0 || !have(template_string_$item(_templateObject203 || (_templateObject203 = leveling_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))),
    do: $location(_templateObject204 || (_templateObject204 = leveling_taggedTemplateLiteral(["Noob Cave"]))),
    outfit: {
      back: template_string_$item(_templateObject205 || (_templateObject205 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject206 || (_templateObject206 = leveling_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))),
    ...
    name: "Red Skeleton",
    ready: () => !have($effect(_templateObject209 || (_templateObject209 = leveling_taggedTemplateLiteral(["Everything Looks Yellow"])))),
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));

      if (!have(template_string_$item(_templateObject210 || (_templateObject210 = leveling_taggedTemplateLiteral(["yellow rocket"]))))) {
        if ((0,external_kolmafia_namespaceObject.myMeat)() < 250) throw new Error("Insufficient Meat to purchase yellow rocket!");
        (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject211 || (_templateObject211 = leveling_taggedTemplateLiteral(["yellow rocket"]))), 1);
      }

      unbreakableUmbrella();
    },
    completed: () => monstersReminisced().includes($monster(_templateObject212 || (_templateObject212 = leveling_taggedTemplateLiteral(["red skeleton"])))) || !availableLocketMonsters().includes($monster(_templateObject213 || (_templateObject213 = leveling_taggedTemplateLiteral(["red skeleton"])))),
    do: () => reminisce($monster(_templateObject214 || (_templateObject214 = leveling_taggedTemplateLiteral(["red skeleton"])))),
    combat: new CombatStrategy().macro(combat_Macro.tryItem(template_string_$item(_templateObject215 || (_templateObject215 = leveling_taggedTemplateLiteral(["yellow rocket"])))).abort()),
    outfit: {
      back: template_string_$item(_templateObject216 || (_templateObject216 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
    ...
    post: () => {
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject220 || (_templateObject220 = leveling_taggedTemplateLiteral(["red box"]))), 1);
      sendAutumnaton();
      sellMiscellaneousItems();
    },
    limit: {
    ...
    prepare: () => {
      ...
      unbreakableUmbrella();
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
      tryAcquiringEffect($effect(_templateObject221 || (_templateObject221 = leveling_taggedTemplateLiteral(["Comic Violence"]))));
    },
    ...
    combat: new CombatStrategy().macro(combat_Macro.if_($monster(_templateObject222 || (_templateObject222 = leveling_taggedTemplateLiteral(["LOV Enforcer"]))), combat_Macro.attack().repeat()).if_($monster(_templateObject223 || (_templateObject223 = leveling_taggedTemplateLiteral(["LOV Engineer"]))), combat_Macro["default"]()).if_($monster(_templateObject224 || (_templateObject224 = leveling_taggedTemplateLiteral(["LOV Equivocator"]))), combat_Macro["default"]())),
    outfit: {
      offhand: template_string_$item(_templateObject225 || (_templateObject225 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject226 || (_templateObject226 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject227 || (_templateObject227 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 1
    ...
    post: () => {
      if (have($effect(_templateObject228 || (_templateObject228 = leveling_taggedTemplateLiteral(["Beaten Up"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("hottub");
      if (have(template_string_$item(_templateObject229 || (_templateObject229 = leveling_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject230 || (_templateObject230 = leveling_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"]))), 1);
      sendAutumnaton();
      sellMiscellaneousItems();
    }
  }, {
    ...
    do: $location(_templateObject231 || (_templateObject231 = leveling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
    ...
    completed: () => property_get("_godLobsterFights") >= 3 || !have(template_string_$familiar(_templateObject236 || (_templateObject236 = leveling_taggedTemplateLiteral(["God Lobster"])))),
    do: () => (0,external_kolmafia_namespaceObject.visitUrl)("main.php?fightgodlobster=1"),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    choices: {
      1310: () => have(template_string_$item(_templateObject237 || (_templateObject237 = leveling_taggedTemplateLiteral(["God Lobster's Ring"])))) ? 2 : 3
    },
    ...
    outfit: {
      ...
      famequip: template_string_$items(_templateObject241 || (_templateObject241 = leveling_taggedTemplateLiteral(["God Lobster's Ring, God Lobster's Scepter"]))),
      familiar: template_string_$familiar(_templateObject242 || (_templateObject242 = leveling_taggedTemplateLiteral(["God Lobster"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    acquire: [{
      item: template_string_$item(_templateObject243 || (_templateObject243 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }],
    limit: {
      tries: 3
    },
    ...
    completed: () => property_get("_eldritchHorrorEvoked") || !have(template_string_$skill(_templateObject244 || (_templateObject244 = leveling_taggedTemplateLiteral(["Evoke Eldritch Horror"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject245 || (_templateObject245 = leveling_taggedTemplateLiteral(["Evoke Eldritch Horror"])))),
    post: () => {
      if (have($effect(_templateObject246 || (_templateObject246 = leveling_taggedTemplateLiteral(["Beaten Up"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("hottub");
      sendAutumnaton();
      sellMiscellaneousItems();
    },
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    ...
    do: () => fightPiece($monster(_templateObject251 || (_templateObject251 = leveling_taggedTemplateLiteral(["Witchess Bishop"])))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      back: template_string_$item(_templateObject252 || (_templateObject252 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject253 || (_templateObject253 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject254 || (_templateObject254 = leveling_taggedTemplateLiteral(["codpiece"]))),
    ...
    completed: () => property_get("_machineTunnelsAdv") >= 5 || !have(template_string_$familiar(_templateObject256 || (_templateObject256 = leveling_taggedTemplateLiteral(["Machine Elf"])))),
    do: () => (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject257 || (_templateObject257 = leveling_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), -1),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      ...
      familiar: template_string_$familiar(_templateObject261 || (_templateObject261 = leveling_taggedTemplateLiteral(["Machine Elf"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 5
    ...
    name: "Powerlevel",
    completed: () => (0,external_kolmafia_namespaceObject.myBasestat)($stat(_templateObject262 || (_templateObject262 = leveling_taggedTemplateLiteral(["Mysticality"])))) >= 175 && ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject263 || (_templateObject263 = leveling_taggedTemplateLiteral(["Yeast of Boris"])))) >= 3 && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject264 || (_templateObject264 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 3 && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject265 || (_templateObject265 = leveling_taggedTemplateLiteral(["St. Sneaky Pete's Whey"])))) >= 6 || craftedCBBFoods.some(it => have((0,external_kolmafia_namespaceObject.effectModifier)(it, "effect")))) && (powerlevelingLocation() !== $location(_templateObject266 || (_templateObject266 = leveling_taggedTemplateLiteral(["The Neverending Party"]))) || property_get("_neverendingPartyFreeTurns") >= 10),
    do: powerlevelingLocation(),
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));
      unbreakableUmbrella();
    ...
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject271 || (_templateObject271 = leveling_taggedTemplateLiteral(["Bowl Sideways"])))).default()),
    post: () => {
      if (have(template_string_$item(_templateObject272 || (_templateObject272 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))))) (0,external_kolmafia_namespaceObject.chew)(template_string_$item(_templateObject273 || (_templateObject273 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))), 1);
      sendAutumnaton();
      sellMiscellaneousItems();
    }
  }, {
    name: "Acquire Wad of Dough",
    completed: () => have(template_string_$item(_templateObject274 || (_templateObject274 = leveling_taggedTemplateLiteral(["wad of dough"])))),
    do: () => {
      if ((0,external_kolmafia_namespaceObject.myMeat)() < 100) throw new Error("Insufficient Meat to purchase all-purpose flower!");
      if (!have(template_string_$item(_templateObject275 || (_templateObject275 = leveling_taggedTemplateLiteral(["all-purpose flower"]))))) (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject276 || (_templateObject276 = leveling_taggedTemplateLiteral(["all-purpose flower"]))), 1);
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject277 || (_templateObject277 = leveling_taggedTemplateLiteral(["all-purpose flower"]))), 1);
    },
    post: () => {
      if (!have(template_string_$item(_templateObject278 || (_templateObject278 = leveling_taggedTemplateLiteral(["flat dough"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject279 || (_templateObject279 = leveling_taggedTemplateLiteral(["wad of dough"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    do: () => {
      ...
      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject280 || (_templateObject280 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 4 && !have($effect(_templateObject281 || (_templateObject281 = leveling_taggedTemplateLiteral(["Pretty Delicious"]))))) {
        if (!have(template_string_$item(_templateObject282 || (_templateObject282 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject283 || (_templateObject283 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
        (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject284 || (_templateObject284 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
      }
    },
    limit: {
      tries: 1
    ...
    completed: () => monstersReminisced().includes($monster(_templateObject288 || (_templateObject288 = leveling_taggedTemplateLiteral(["Witchess King"])))) || !availableLocketMonsters().includes($monster(_templateObject289 || (_templateObject289 = leveling_taggedTemplateLiteral(["Witchess King"])))),
    ...
    outfit: {
      back: template_string_$item(_templateObject295 || (_templateObject295 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject296 || (_templateObject296 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject297 || (_templateObject297 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject298 || (_templateObject298 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    completed: () => (property_get("_shatteringPunchUsed") >= 3 || !have(template_string_$skill(_templateObject299 || (_templateObject299 = leveling_taggedTemplateLiteral(["Shattering Punch"]))))) && (property_get("_gingerbreadMobHitUsed") || !have(template_string_$skill(_templateObject300 || (_templateObject300 = leveling_taggedTemplateLiteral(["Gingerbread Mob Hit"]))))) && have($effect(_templateObject301 || (_templateObject301 = leveling_taggedTemplateLiteral(["Pretty Delicious"])))) && (have($effect(_templateObject302 || (_templateObject302 = leveling_taggedTemplateLiteral(["Awfully Wily"])))) || (0,external_kolmafia_namespaceObject.myBasestat)($stat(_templateObject303 || (_templateObject303 = leveling_taggedTemplateLiteral(["Mysticality"])))) >= 190),
    do: powerlevelingLocation(),
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject304 || (_templateObject304 = leveling_taggedTemplateLiteral(["Feel Pride"])))).trySkill(template_string_$skill(_templateObject305 || (_templateObject305 = leveling_taggedTemplateLiteral(["Chest X-Ray"])))).trySkill(template_string_$skill(_templateObject306 || (_templateObject306 = leveling_taggedTemplateLiteral(["Shattering Punch"])))).trySkill(template_string_$skill(_templateObject307 || (_templateObject307 = leveling_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill(template_string_$skill(_templateObject308 || (_templateObject308 = leveling_taggedTemplateLiteral(["Bowl Sideways"])))).default()),
    choices: {
      1094: 5,
      1115: 6,
      1322: 2,
    ...
    post: () => {
      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject309 || (_templateObject309 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 4 && !have($effect(_templateObject310 || (_templateObject310 = leveling_taggedTemplateLiteral(["Pretty Delicious"]))))) {
        if (!have(template_string_$item(_templateObject311 || (_templateObject311 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject312 || (_templateObject312 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
        (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject313 || (_templateObject313 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
      }

      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject314 || (_templateObject314 = leveling_taggedTemplateLiteral(["St. Sneaky Pete's Whey"])))) >= 1 && !have($effect(_templateObject315 || (_templateObject315 = leveling_taggedTemplateLiteral(["Awfully Wily"]))))) {
        (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject316 || (_templateObject316 = leveling_taggedTemplateLiteral(["Pete's wiley whey bar"]))), 1);
        (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject317 || (_templateObject317 = leveling_taggedTemplateLiteral(["Pete's wiley whey bar"]))), 1);
      }

      if (have(template_string_$item(_templateObject318 || (_templateObject318 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))))) (0,external_kolmafia_namespaceObject.chew)(template_string_$item(_templateObject319 || (_templateObject319 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))), 1);
      sendAutumnaton();
      sellMiscellaneousItems();
    },
    limit: {
