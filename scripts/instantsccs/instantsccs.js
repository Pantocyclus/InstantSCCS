...
var statCommunityServicePredictor = stat => {
  return () => 60 - Math.floor(1 / 30 * ((0,external_kolmafia_namespaceObject.myBuffedstat)(stat) - (0,external_kolmafia_namespaceObject.myBasestat)(thralls.get(stat) === (0,external_kolmafia_namespaceObject.myThrall)() && !have($effect(CommunityService_templateObject5 || (CommunityService_templateObject5 = CommunityService_taggedTemplateLiteral(["Expert Oiliness"])))) ? template_string_$stat(CommunityService_templateObject6 || (CommunityService_templateObject6 = CommunityService_taggedTemplateLiteral(["mysticality"]))) : stat)));
};
...
function docBag() {
  if (have(template_string_$item(engine_outfit_templateObject10 || (engine_outfit_templateObject10 = engine_outfit_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) && property_get("_chestXRayUsed") < 3 && !property_get("instant_saveDocBag", false)) (0,external_kolmafia_namespaceObject.equip)($slot(engine_outfit_templateObject11 || (engine_outfit_templateObject11 = engine_outfit_taggedTemplateLiteral(["acc3"]))), template_string_$item(engine_outfit_templateObject12 || (engine_outfit_templateObject12 = engine_outfit_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
}
;// CONCATENATED MODULE: ./src/combat.ts
var src_combat_templateObject, src_combat_templateObject2, combat_templateObject3, combat_templateObject4, combat_templateObject5, combat_templateObject6, combat_templateObject7, combat_templateObject8, combat_templateObject9;
...
var combat_Macro = /*#__PURE__*/function (_StrictMacro) {
  ...
  src_combat_createClass(Macro, [{
    key: "kill",
    value: function kill() {
      return this.trySkill(template_string_$skill(src_combat_templateObject || (src_combat_templateObject = src_combat_taggedTemplateLiteral(["Curse of Weaksauce"])))).if_("!mpbelow ".concat((0,external_kolmafia_namespaceObject.mpCost)(template_string_$skill(src_combat_templateObject2 || (src_combat_templateObject2 = src_combat_taggedTemplateLiteral(["Stuffed Mortar Shell"]))))), Macro.trySkill(template_string_$skill(combat_templateObject3 || (combat_templateObject3 = src_combat_taggedTemplateLiteral(["Stuffed Mortar Shell"]))))).while_("!mpbelow ".concat((0,external_kolmafia_namespaceObject.mpCost)(template_string_$skill(combat_templateObject4 || (combat_templateObject4 = src_combat_taggedTemplateLiteral(["Saucegeyser"])))), " && hasskill ").concat((0,external_kolmafia_namespaceObject.toInt)(template_string_$skill(combat_templateObject5 || (combat_templateObject5 = src_combat_taggedTemplateLiteral(["Saucegeyser"]))))), Macro.skill(template_string_$skill(combat_templateObject6 || (combat_templateObject6 = src_combat_taggedTemplateLiteral(["Saucegeyser"]))))).while_("!mpbelow ".concat((0,external_kolmafia_namespaceObject.mpCost)(template_string_$skill(combat_templateObject7 || (combat_templateObject7 = src_combat_taggedTemplateLiteral(["Saucestorm"])))), " && hasskill ").concat((0,external_kolmafia_namespaceObject.toInt)(template_string_$skill(combat_templateObject8 || (combat_templateObject8 = src_combat_taggedTemplateLiteral(["Saucestorm"]))))), Macro.skill(template_string_$skill(combat_templateObject9 || (combat_templateObject9 = src_combat_taggedTemplateLiteral(["Saucestorm"]))))).attack().repeat();
    }
  }, {
    key: "default",
...
var skill = template_string_$skill(Cartography_templateObject2 || (Cartography_templateObject2 = Cartography_taggedTemplateLiteral(["Map the Monsters"])));
/**
...
function mapMonster(location, monster) {
  ...
  (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(Cartography_templateObject3 || (Cartography_templateObject3 = Cartography_taggedTemplateLiteral(["Map the Monsters"]))));
...
function powerlevelingLocation() {
  if (property_get("neverendingPartyAlways")) return $location(leveling_templateObject26 || (leveling_templateObject26 = leveling_taggedTemplateLiteral(["The Neverending Party"])));else if (property_get("stenchAirportAlways") || property_get("_stenchAirportToday")) return $location(leveling_templateObject27 || (leveling_templateObject27 = leveling_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"])));else if (property_get("spookyAirportAlways")) return $location(leveling_templateObject28 || (leveling_templateObject28 = leveling_taggedTemplateLiteral(["The Deep Dark Jungle"])));else if (property_get("hotAirportAlways")) return $location(leveling_templateObject29 || (leveling_templateObject29 = leveling_taggedTemplateLiteral(["The SMOOCH Army HQ"])));else if (property_get("coldAirportAlways")) return $location(leveling_templateObject30 || (leveling_templateObject30 = leveling_taggedTemplateLiteral(["VYKEA"])));else if (property_get("sleazeAirportAlways")) return $location(leveling_templateObject31 || (leveling_templateObject31 = leveling_taggedTemplateLiteral(["Sloppy Seconds Diner"])));
  return $location(leveling_templateObject32 || (leveling_templateObject32 = leveling_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))); // Default location
}

function haveCBBIngredients() {
  var yeast = 0,
      vegetable = 0,
      whey = 0;
  if (!property_get("instant_saveHoneyBun", false) && !have($effect(leveling_templateObject33 || (leveling_templateObject33 = leveling_taggedTemplateLiteral(["Motherly Loved"]))))) yeast += 1;
  if (!property_get("instant_saveRoastedVegetableStats", false) && !have($effect(leveling_templateObject34 || (leveling_templateObject34 = leveling_taggedTemplateLiteral(["Wizard Sight"]))))) vegetable += 2;
  if (!property_get("instant_saveRichRicotta", false) && !have($effect(leveling_templateObject35 || (leveling_templateObject35 = leveling_taggedTemplateLiteral(["Rippin' Ricotta"]))))) whey += 2;

  if (!property_get("instant_savePlainCalzone", false) && !have($effect(leveling_templateObject36 || (leveling_templateObject36 = leveling_taggedTemplateLiteral(["Angering Pizza Purists"]))))) {
    yeast += 2;
    whey += 2;
  }

  return (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(leveling_templateObject37 || (leveling_templateObject37 = leveling_taggedTemplateLiteral(["Yeast of Boris"])))) >= yeast && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(leveling_templateObject38 || (leveling_templateObject38 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= vegetable && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(leveling_templateObject39 || (leveling_templateObject39 = leveling_taggedTemplateLiteral(["St. Sneaky Pete's Whey"])))) >= whey;
}

function sendAutumnaton() {
  if (have(template_string_$item(leveling_templateObject40 || (leveling_templateObject40 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");
}

function sellMiscellaneousItems() {
  var items = [template_string_$item(leveling_templateObject41 || (leveling_templateObject41 = leveling_taggedTemplateLiteral(["cardboard ore"]))), template_string_$item(leveling_templateObject42 || (leveling_templateObject42 = leveling_taggedTemplateLiteral(["hot buttered roll"]))), template_string_$item(leveling_templateObject43 || (leveling_templateObject43 = leveling_taggedTemplateLiteral(["toast"]))), template_string_$item(leveling_templateObject44 || (leveling_templateObject44 = leveling_taggedTemplateLiteral(["meat paste"]))), template_string_$item(leveling_templateObject45 || (leveling_templateObject45 = leveling_taggedTemplateLiteral(["meat stack"]))), template_string_$item(leveling_templateObject46 || (leveling_templateObject46 = leveling_taggedTemplateLiteral(["jar of swamp honey"]))), template_string_$item(leveling_templateObject47 || (leveling_templateObject47 = leveling_taggedTemplateLiteral(["turtle voicebox"]))), template_string_$item(leveling_templateObject48 || (leveling_templateObject48 = leveling_taggedTemplateLiteral(["grody jug"]))), template_string_$item(leveling_templateObject49 || (leveling_templateObject49 = leveling_taggedTemplateLiteral(["gas can"]))), template_string_$item(leveling_templateObject50 || (leveling_templateObject50 = leveling_taggedTemplateLiteral(["Middle of the Road\u2122 brand whiskey"]))), template_string_$item(leveling_templateObject51 || (leveling_templateObject51 = leveling_taggedTemplateLiteral(["neverending wallet chain"]))), template_string_$item(leveling_templateObject52 || (leveling_templateObject52 = leveling_taggedTemplateLiteral(["pentagram bandana"]))), template_string_$item(leveling_templateObject53 || (leveling_templateObject53 = leveling_taggedTemplateLiteral(["denim jacket"]))), template_string_$item(leveling_templateObject54 || (leveling_templateObject54 = leveling_taggedTemplateLiteral(["ratty knitted cap"]))), template_string_$item(leveling_templateObject55 || (leveling_templateObject55 = leveling_taggedTemplateLiteral(["jam band bootleg"]))), template_string_$item(leveling_templateObject56 || (leveling_templateObject56 = leveling_taggedTemplateLiteral(["Purple Beast energy drink"]))), template_string_$item(leveling_templateObject57 || (leveling_templateObject57 = leveling_taggedTemplateLiteral(["cosmetic football"]))), template_string_$item(leveling_templateObject58 || (leveling_templateObject58 = leveling_taggedTemplateLiteral(["shoe ad T-shirt"]))), template_string_$item(leveling_templateObject59 || (leveling_templateObject59 = leveling_taggedTemplateLiteral(["pump-up high-tops"]))), template_string_$item(leveling_templateObject60 || (leveling_templateObject60 = leveling_taggedTemplateLiteral(["noticeable pumps"]))), template_string_$item(_templateObject61 || (_templateObject61 = leveling_taggedTemplateLiteral(["surprisingly capacious handbag"]))), template_string_$item(_templateObject62 || (_templateObject62 = leveling_taggedTemplateLiteral(["electronics kit"]))), template_string_$item(_templateObject63 || (_templateObject63 = leveling_taggedTemplateLiteral(["PB&J with the crusts cut off"]))), template_string_$item(_templateObject64 || (_templateObject64 = leveling_taggedTemplateLiteral(["dorky glasses"]))), template_string_$item(_templateObject65 || (_templateObject65 = leveling_taggedTemplateLiteral(["ponytail clip"]))), template_string_$item(_templateObject66 || (_templateObject66 = leveling_taggedTemplateLiteral(["paint palette"])))].concat(leveling_toConsumableArray(baseBoozes));
  items.forEach(it => {
...
var LevelingQuest = {
  ...
  tasks: [{
    ...
    completed: () => (0,external_kolmafia_namespaceObject.mySoulsauce)() < 5 || (0,external_kolmafia_namespaceObject.myMp)() > (0,external_kolmafia_namespaceObject.myMaxmp)() - 15 || !have(template_string_$skill(_templateObject67 || (_templateObject67 = leveling_taggedTemplateLiteral(["Soul Food"])))),
    do: () => {
      while ((0,external_kolmafia_namespaceObject.mySoulsauce)() >= 5 && (0,external_kolmafia_namespaceObject.myMp)() <= (0,external_kolmafia_namespaceObject.myMaxmp)() - 15) {
        (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject68 || (_templateObject68 = leveling_taggedTemplateLiteral(["Soul Food"]))));
      }
    }
  }, {
    name: "Clan Shower",
    completed: () => property_get("_aprilShower"),
    do: () => ensureEffect($effect(_templateObject69 || (_templateObject69 = leveling_taggedTemplateLiteral(["Thaumodynamic"])))),
    limit: {
      tries: 1
    }
  }, {
    name: "Inscrutable Gaze",
    completed: () => have($effect(_templateObject70 || (_templateObject70 = leveling_taggedTemplateLiteral(["Inscrutable Gaze"])))) || !have(template_string_$skill(_templateObject71 || (_templateObject71 = leveling_taggedTemplateLiteral(["Inscrutable Gaze"])))),
    do: () => ensureEffect($effect(_templateObject72 || (_templateObject72 = leveling_taggedTemplateLiteral(["Inscrutable Gaze"]))))
  }, {
    name: "Pull Deep Dish of Legend",
    completed: () => have(template_string_$item(_templateObject73 || (_templateObject73 = leveling_taggedTemplateLiteral(["Deep Dish of Legend"])))) || have($effect(_templateObject74 || (_templateObject74 = leveling_taggedTemplateLiteral(["In the Depths"])))) || property_get("_roninStoragePulls").split(",").includes((0,external_kolmafia_namespaceObject.toInt)(template_string_$item(_templateObject75 || (_templateObject75 = leveling_taggedTemplateLiteral(["Deep Dish of Legend"])))).toString()) || property_get("_instant_skipDeepDishOfLegend", false),
    do: () => {
      if ((0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(_templateObject76 || (_templateObject76 = leveling_taggedTemplateLiteral(["Deep Dish of Legend"])))) === 0) {
      ...
      (0,external_kolmafia_namespaceObject.takeStorage)(template_string_$item(_templateObject77 || (_templateObject77 = leveling_taggedTemplateLiteral(["Deep Dish of Legend"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    completed: () => have(template_string_$item(_templateObject78 || (_templateObject78 = leveling_taggedTemplateLiteral(["Calzone of Legend"])))) || have($effect(_templateObject79 || (_templateObject79 = leveling_taggedTemplateLiteral(["In the 'zone zone!"])))) || property_get("_roninStoragePulls").split(",").includes((0,external_kolmafia_namespaceObject.toInt)(template_string_$item(_templateObject80 || (_templateObject80 = leveling_taggedTemplateLiteral(["Calzone of Legend"])))).toString()) || property_get("_instant_skipCalzoneOfLegend", false),
    do: () => {
      if ((0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(_templateObject81 || (_templateObject81 = leveling_taggedTemplateLiteral(["Calzone of Legend"])))) === 0) {
      ...
      (0,external_kolmafia_namespaceObject.takeStorage)(template_string_$item(_templateObject82 || (_templateObject82 = leveling_taggedTemplateLiteral(["Calzone of Legend"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    completed: () => have(template_string_$item(_templateObject83 || (_templateObject83 = leveling_taggedTemplateLiteral(["Pizza of Legend"])))) || have($effect(_templateObject84 || (_templateObject84 = leveling_taggedTemplateLiteral(["Endless Drool"])))) || property_get("_roninStoragePulls").split(",").includes((0,external_kolmafia_namespaceObject.toInt)(template_string_$item(_templateObject85 || (_templateObject85 = leveling_taggedTemplateLiteral(["Pizza of Legend"])))).toString()) || property_get("_instant_skipPizzaOfLegend", false),
    do: () => {
      if ((0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(_templateObject86 || (_templateObject86 = leveling_taggedTemplateLiteral(["Pizza of Legend"])))) === 0) {
      ...
      (0,external_kolmafia_namespaceObject.takeStorage)(template_string_$item(_templateObject87 || (_templateObject87 = leveling_taggedTemplateLiteral(["Pizza of Legend"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    name: "Pull Daypass",
    completed: () => powerlevelingLocation() !== $location(_templateObject88 || (_templateObject88 = leveling_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))) || property_get("stenchAirportAlways") || property_get("_stenchAirportToday"),
    do: () => {
      if ((0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(_templateObject89 || (_templateObject89 = leveling_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))) === 0) {
      ...
      (0,external_kolmafia_namespaceObject.takeStorage)(template_string_$item(_templateObject90 || (_templateObject90 = leveling_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"]))), 1);
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject91 || (_templateObject91 = leveling_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    completed: () => property_get("_roninStoragePulls").split(",").length >= 5 || property_get("_roninStoragePulls").split(",").includes((0,external_kolmafia_namespaceObject.toInt)(template_string_$item(_templateObject92 || (_templateObject92 = leveling_taggedTemplateLiteral(["non-Euclidean angle"])))).toString()) || have(template_string_$item(_templateObject93 || (_templateObject93 = leveling_taggedTemplateLiteral(["non-Euclidean angle"])))) || have($effect(_templateObject94 || (_templateObject94 = leveling_taggedTemplateLiteral(["Different Way of Seeing Things"])))) || (0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(_templateObject95 || (_templateObject95 = leveling_taggedTemplateLiteral(["non-Euclidean angle"])))) === 0 || property_get("instant_saveEuclideanAngle", false),
    do: () => {
      (0,external_kolmafia_namespaceObject.takeStorage)(template_string_$item(_templateObject96 || (_templateObject96 = leveling_taggedTemplateLiteral(["non-Euclidean angle"]))), 1);
      (0,external_kolmafia_namespaceObject.chew)(template_string_$item(_templateObject97 || (_templateObject97 = leveling_taggedTemplateLiteral(["non-Euclidean angle"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    completed: () => property_get("_roninStoragePulls").split(",").length >= 5 || property_get("_roninStoragePulls").split(",").includes((0,external_kolmafia_namespaceObject.toInt)(template_string_$item(_templateObject98 || (_templateObject98 = leveling_taggedTemplateLiteral(["abstraction: category"])))).toString()) || have(template_string_$item(_templateObject99 || (_templateObject99 = leveling_taggedTemplateLiteral(["abstraction: category"])))) || have($effect(_templateObject100 || (_templateObject100 = leveling_taggedTemplateLiteral(["Category"])))) || (0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(_templateObject101 || (_templateObject101 = leveling_taggedTemplateLiteral(["abstraction: category"])))) === 0 || property_get("instant_saveAbstraction", false),
    do: () => {
      (0,external_kolmafia_namespaceObject.takeStorage)(template_string_$item(_templateObject102 || (_templateObject102 = leveling_taggedTemplateLiteral(["abstraction: category"]))), 1);
      (0,external_kolmafia_namespaceObject.chew)(template_string_$item(_templateObject103 || (_templateObject103 = leveling_taggedTemplateLiteral(["abstraction: category"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    completed: () => !have(template_string_$item(_templateObject104 || (_templateObject104 = leveling_taggedTemplateLiteral(["a ten-percent bonus"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject105 || (_templateObject105 = leveling_taggedTemplateLiteral(["a ten-percent bonus"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    name: "Bastille",
    completed: () => property_get("_bastilleGames") > 0 || !have(template_string_$item(_templateObject106 || (_templateObject106 = leveling_taggedTemplateLiteral(["Bastille Battalion control rig"])))),
    ...
    prepare: () => {
      if (have(template_string_$item(_templateObject107 || (_templateObject107 = leveling_taggedTemplateLiteral(["Newbiesport\u2122 tent"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject108 || (_templateObject108 = leveling_taggedTemplateLiteral(["Newbiesport\u2122 tent"]))));
    },
    do: () => {
    ...
    name: "Alice Army",
    completed: () => property_get("grimoire3Summons") > 0 || !have(template_string_$skill(_templateObject109 || (_templateObject109 = leveling_taggedTemplateLiteral(["Summon Alice's Army Cards"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject110 || (_templateObject110 = leveling_taggedTemplateLiteral(["Summon Alice's Army Cards"])))),
    limit: {
      tries: 1
    }
  }, {
    name: "Confiscator's Grimoire",
    completed: () => property_get("_grimoireConfiscatorSummons") > 0 || !have(template_string_$skill(_templateObject111 || (_templateObject111 = leveling_taggedTemplateLiteral(["Summon Confiscated Things"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject112 || (_templateObject112 = leveling_taggedTemplateLiteral(["Summon Confiscated Things"])))),
    limit: {
      tries: 1
    }
  }, {
    name: "Eat Calzone",
    completed: () => property_get("calzoneOfLegendEaten") || !have(template_string_$item(_templateObject113 || (_templateObject113 = leveling_taggedTemplateLiteral(["Calzone of Legend"])))),
    do: () => (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject114 || (_templateObject114 = leveling_taggedTemplateLiteral(["Calzone of Legend"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    name: "Eat Deep Dish",
    completed: () => property_get("deepDishOfLegendEaten") || !have(template_string_$item(_templateObject115 || (_templateObject115 = leveling_taggedTemplateLiteral(["Deep Dish of Legend"])))),
    do: () => (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject116 || (_templateObject116 = leveling_taggedTemplateLiteral(["Deep Dish of Legend"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    name: "Cast Prevent Scurvy",
    completed: () => !have(template_string_$skill(_templateObject117 || (_templateObject117 = leveling_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"])))) || property_get("_preventScurvy"),
    prepare: () => (0,external_kolmafia_namespaceObject.restoreMp)((0,external_kolmafia_namespaceObject.mpCost)(template_string_$skill(_templateObject118 || (_templateObject118 = leveling_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject119 || (_templateObject119 = leveling_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"])))),
    limit: {
      tries: 1
    }
  }, {
    name: "Cast Perfect Freeze",
    completed: () => !have(template_string_$skill(_templateObject120 || (_templateObject120 = leveling_taggedTemplateLiteral(["Perfect Freeze"])))) || property_get("_perfectFreezeUsed") || property_get("instant_savePerfectFreeze", false),
    prepare: () => (0,external_kolmafia_namespaceObject.restoreMp)((0,external_kolmafia_namespaceObject.mpCost)(template_string_$skill(_templateObject121 || (_templateObject121 = leveling_taggedTemplateLiteral(["Perfect Freeze"]))))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject122 || (_templateObject122 = leveling_taggedTemplateLiteral(["Perfect Freeze"])))),
    limit: {
      tries: 1
    }
  }, {
    name: "Drink Perfect Drink",
    completed: () => (0,external_kolmafia_namespaceObject.myInebriety)() >= 3 || !have(template_string_$item(_templateObject123 || (_templateObject123 = leveling_taggedTemplateLiteral(["perfect ice cube"])))) || !baseBoozes.some(it => have(it)) || property_get("instant_savePerfectFreeze", false),
    do: () => {
      tryAcquiringEffect($effect(_templateObject124 || (_templateObject124 = leveling_taggedTemplateLiteral(["Ode to Booze"]))));
      var baseBooze = baseBoozes.filter(it => have(it))[0];
      var booze;

      switch (baseBooze) {
        case template_string_$item(_templateObject125 || (_templateObject125 = leveling_taggedTemplateLiteral(["bottle of vodka"]))):
          booze = template_string_$item(_templateObject126 || (_templateObject126 = leveling_taggedTemplateLiteral(["perfect cosmopolitan"])));
          break;

        case template_string_$item(_templateObject127 || (_templateObject127 = leveling_taggedTemplateLiteral(["bottle of whiskey"]))):
          booze = template_string_$item(_templateObject128 || (_templateObject128 = leveling_taggedTemplateLiteral(["perfect old-fashioned"])));
          break;

        case template_string_$item(_templateObject129 || (_templateObject129 = leveling_taggedTemplateLiteral(["boxed wine"]))):
          booze = template_string_$item(_templateObject130 || (_templateObject130 = leveling_taggedTemplateLiteral(["perfect mimosa"])));
          break;

        case template_string_$item(_templateObject131 || (_templateObject131 = leveling_taggedTemplateLiteral(["bottle of rum"]))):
          booze = template_string_$item(_templateObject132 || (_templateObject132 = leveling_taggedTemplateLiteral(["perfect dark and stormy"])));
          break;

        case template_string_$item(_templateObject133 || (_templateObject133 = leveling_taggedTemplateLiteral(["bottle of tequila"]))):
          booze = template_string_$item(_templateObject134 || (_templateObject134 = leveling_taggedTemplateLiteral(["perfect paloma"])));
          break;

        case template_string_$item(_templateObject135 || (_templateObject135 = leveling_taggedTemplateLiteral(["bottle of gin"]))):
          booze = template_string_$item(_templateObject136 || (_templateObject136 = leveling_taggedTemplateLiteral(["perfect negroni"])));
          break;
    ...
    completed: () => have($effect(_templateObject137 || (_templateObject137 = leveling_taggedTemplateLiteral(["Glittering Eyelashes"])))),
    do: () => ensureEffect($effect(_templateObject138 || (_templateObject138 = leveling_taggedTemplateLiteral(["Glittering Eyelashes"]))))
  }, {
    name: "Buy Oversized Sparkler",
    ready: () => have($effect(_templateObject139 || (_templateObject139 = leveling_taggedTemplateLiteral(["Everything Looks Blue"])))) && property_get("hasRange") && (0,external_kolmafia_namespaceObject.myMeat)() >= 1000,
    completed: () => have(template_string_$item(_templateObject140 || (_templateObject140 = leveling_taggedTemplateLiteral(["oversized sparkler"])))),
    do: () => (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject141 || (_templateObject141 = leveling_taggedTemplateLiteral(["oversized sparkler"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    name: "Eat Pizza",
    ready: () => have($effect(_templateObject142 || (_templateObject142 = leveling_taggedTemplateLiteral(["Ready to Eat"])))),
    // only eat this after we red rocket
    completed: () => property_get("pizzaOfLegendEaten") || !have(template_string_$item(_templateObject143 || (_templateObject143 = leveling_taggedTemplateLiteral(["Pizza of Legend"])))),
    do: () => (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject144 || (_templateObject144 = leveling_taggedTemplateLiteral(["Pizza of Legend"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    ...
    completed: () => (0,external_kolmafia_namespaceObject.myInebriety)() >= (0,external_kolmafia_namespaceObject.inebrietyLimit)() || !have(template_string_$item(_templateObject145 || (_templateObject145 = leveling_taggedTemplateLiteral(["astral six-pack"])))) && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject146 || (_templateObject146 = leveling_taggedTemplateLiteral(["astral pilsner"])))) <= property_get("instant_saveAstralPilsners", 0),
    prepare: () => tryAcquiringEffect($effect(_templateObject147 || (_templateObject147 = leveling_taggedTemplateLiteral(["Ode to Booze"])))),
    do: () => {
      if (have(template_string_$item(_templateObject148 || (_templateObject148 = leveling_taggedTemplateLiteral(["astral six-pack"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject149 || (_templateObject149 = leveling_taggedTemplateLiteral(["astral six-pack"]))), 1);
      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject150 || (_templateObject150 = leveling_taggedTemplateLiteral(["astral pilsner"])))) > property_get("instant_saveAstralPilsners", 0)) (0,external_kolmafia_namespaceObject.drink)(template_string_$item(_templateObject151 || (_templateObject151 = leveling_taggedTemplateLiteral(["astral pilsner"]))), 1);
    },
    post: () => {
      if (!have(template_string_$item(_templateObject152 || (_templateObject152 = leveling_taggedTemplateLiteral(["astral six-pack"])))) && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject153 || (_templateObject153 = leveling_taggedTemplateLiteral(["astral pilsner"])))) <= property_get("instant_saveAstralPilsners", 0)) uneffect($effect(_templateObject154 || (_templateObject154 = leveling_taggedTemplateLiteral(["Ode to Booze"]))));
    },
    limit: {
      tries: 6
    }
    ...
    completed: () => !have(template_string_$item(_templateObject155 || (_templateObject155 = leveling_taggedTemplateLiteral(["magical sausage"])))) && !have(template_string_$item(_templateObject156 || (_templateObject156 = leveling_taggedTemplateLiteral(["magical sausage casing"])))) || (0,external_kolmafia_namespaceObject.myMeat)() <= 3000 || property_get("_sausagesMade") >= 3,
    do: () => {
      if (have(template_string_$item(_templateObject157 || (_templateObject157 = leveling_taggedTemplateLiteral(["magical sausage casing"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject158 || (_templateObject158 = leveling_taggedTemplateLiteral(["magical sausage"]))), 1);
      (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject159 || (_templateObject159 = leveling_taggedTemplateLiteral(["magical sausage"]))), (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject160 || (_templateObject160 = leveling_taggedTemplateLiteral(["magical sausage"])))));
    },
    post: () => (0,external_kolmafia_namespaceObject.autosell)(template_string_$item(_templateObject161 || (_templateObject161 = leveling_taggedTemplateLiteral(["meat stack"]))), (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject162 || (_templateObject162 = leveling_taggedTemplateLiteral(["meat stack"]))))),
    limit: {
      tries: 23
    }
  }, {
    name: "BoomBox Meat",
    ready: () => have(template_string_$item(_templateObject163 || (_templateObject163 = leveling_taggedTemplateLiteral(["Punching Potion"])))),
    completed: () => song() === "Total Eclipse of Your Meat" || !have(template_string_$item(_templateObject164 || (_templateObject164 = leveling_taggedTemplateLiteral(["SongBoom\u2122 BoomBox"])))),
    ...
    prepare: () => {
      ...
      if (!have($effect(_templateObject168 || (_templateObject168 = leveling_taggedTemplateLiteral(["Everything Looks Red"])))) && !have(template_string_$item(_templateObject169 || (_templateObject169 = leveling_taggedTemplateLiteral(["red rocket"]))))) {
        if ((0,external_kolmafia_namespaceObject.myMeat)() >= 250) (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject170 || (_templateObject170 = leveling_taggedTemplateLiteral(["red rocket"]))), 1);
      }
    },
    completed: () => have($effect(_templateObject171 || (_templateObject171 = leveling_taggedTemplateLiteral(["Everything Looks Blue"])))),
    do: powerlevelingLocation(),
    // if your powerleveling location is the NEP you don't immediately get the MP regen
    combat: new CombatStrategy().macro(combat_Macro.tryItem(template_string_$item(_templateObject172 || (_templateObject172 = leveling_taggedTemplateLiteral(["blue rocket"])))).tryItem(template_string_$item(_templateObject173 || (_templateObject173 = leveling_taggedTemplateLiteral(["red rocket"])))).default()),
    outfit: {
      offhand: template_string_$item(_templateObject174 || (_templateObject174 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject175 || (_templateObject175 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject176 || (_templateObject176 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
    ...
    completed: () => powerlevelingLocation() !== $location(_templateObject177 || (_templateObject177 = leveling_taggedTemplateLiteral(["The Neverending Party"]))) || (0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject178 || (_templateObject178 = leveling_taggedTemplateLiteral(["Glowing Blue"])))) !== 10 || (0,external_kolmafia_namespaceObject.myMp)() >= 500,
    do: $location(_templateObject179 || (_templateObject179 = leveling_taggedTemplateLiteral(["The Dire Warren"]))),
    outfit: {
      offhand: template_string_$item(_templateObject180 || (_templateObject180 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject181 || (_templateObject181 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject182 || (_templateObject182 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    ...
    ready: () => have(template_string_$item(_templateObject183 || (_templateObject183 = leveling_taggedTemplateLiteral(["cosmic bowling ball"])))),
    // Grab this in between rift free fights (since we aren't using the bowling ball there)
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));
      unbreakableUmbrella();
      (0,external_kolmafia_namespaceObject.restoreMp)(50);
    },
    completed: () => !have(template_string_$skill(_templateObject184 || (_templateObject184 = leveling_taggedTemplateLiteral(["Map the Monsters"])))) || property_get("_monstersMapped") >= 3 || have(template_string_$item(_templateObject185 || (_templateObject185 = leveling_taggedTemplateLiteral(["li'l ninja costume"])))) || !have(template_string_$familiar(_templateObject186 || (_templateObject186 = leveling_taggedTemplateLiteral(["Trick-or-Treating Tot"])))),
    do: () => mapMonster($location(_templateObject187 || (_templateObject187 = leveling_taggedTemplateLiteral(["The Haiku Dungeon"]))), $monster(_templateObject188 || (_templateObject188 = leveling_taggedTemplateLiteral(["amateur ninja"])))),
    combat: new CombatStrategy().macro(combat_Macro.if_($monster(_templateObject189 || (_templateObject189 = leveling_taggedTemplateLiteral(["amateur ninja"]))), combat_Macro.trySkill(template_string_$skill(_templateObject190 || (_templateObject190 = leveling_taggedTemplateLiteral(["Bowl a Curveball"]))))).abort()),
    outfit: {
      offhand: template_string_$item(_templateObject191 || (_templateObject191 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject192 || (_templateObject192 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject193 || (_templateObject193 = leveling_taggedTemplateLiteral(["Trick-or-Treating Tot"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    post: () => {
      sendAutumnaton();
    ...
    completed: () => property_get("_shadowAffinityToday", false) || !have(template_string_$item(_templateObject194 || (_templateObject194 = leveling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject195 || (_templateObject195 = leveling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    choices: {
      1497: 2,
      1498: 6
    },
    ...
    prepare: () => {
      ...
      if (!have($effect(_templateObject196 || (_templateObject196 = leveling_taggedTemplateLiteral(["Everything Looks Red"])))) && !have(template_string_$item(_templateObject197 || (_templateObject197 = leveling_taggedTemplateLiteral(["red rocket"]))))) {
        if ((0,external_kolmafia_namespaceObject.myMeat)() >= 250) (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject198 || (_templateObject198 = leveling_taggedTemplateLiteral(["red rocket"]))), 1);
      }
    },
    completed: () => have(template_string_$item(_templateObject199 || (_templateObject199 = leveling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || property_get("_shadowRiftCombats", 0) >= 12 || !have(template_string_$item(_templateObject200 || (_templateObject200 = leveling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    do: () => {
      var target = property_get("rufusQuestTarget", "");

      if (have($effect(_templateObject201 || (_templateObject201 = leveling_taggedTemplateLiteral(["Shadow Affinity"]))))) {
    ...
    combat: new CombatStrategy().macro(combat_Macro.tryItem(template_string_$item(_templateObject202 || (_templateObject202 = leveling_taggedTemplateLiteral(["red rocket"])))).default()),
    outfit: {
      ...
      familiar: template_string_$familiar(_templateObject205 || (_templateObject205 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    choices: {
      1498: 1
    ...
    post: () => {
      if (have((0,external_kolmafia_namespaceObject.toItem)(property_get("rufusQuestTarget", "")))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject206 || (_templateObject206 = leveling_taggedTemplateLiteral(["closed-circuit pay phone"]))));
      sendAutumnaton();
      sellMiscellaneousItems();
    },
    limit: {
    ...
    completed: () => have($effect(_templateObject207 || (_templateObject207 = leveling_taggedTemplateLiteral(["Mystically Oiled"])))),
    do: () => {
      if (!have(template_string_$item(_templateObject208 || (_templateObject208 = leveling_taggedTemplateLiteral(["ointment of the occult"]))))) {
        ...
        (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject210 || (_templateObject210 = leveling_taggedTemplateLiteral(["ointment of the occult"]))), 1);
      }

      ensureEffect($effect(_templateObject211 || (_templateObject211 = leveling_taggedTemplateLiteral(["Mystically Oiled"]))));
    }
  }, {
    name: "Use Oil of Expertise",
    completed: () => !have(template_string_$item(_templateObject212 || (_templateObject212 = leveling_taggedTemplateLiteral(["cherry"])))) && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject213 || (_templateObject213 = leveling_taggedTemplateLiteral(["oil of expertise"])))) <= 1 || have($effect(_templateObject214 || (_templateObject214 = leveling_taggedTemplateLiteral(["Expert Oiliness"])))),
    do: () => {
      if (!have(template_string_$item(_templateObject215 || (_templateObject215 = leveling_taggedTemplateLiteral(["oil of expertise"]))))) {
        if (property_get("reagentSummons") === 0) (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject216 || (_templateObject216 = leveling_taggedTemplateLiteral(["Advanced Saucecrafting"]))), 1);
        (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject217 || (_templateObject217 = leveling_taggedTemplateLiteral(["oil of expertise"]))), 1);
      }

      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject218 || (_templateObject218 = leveling_taggedTemplateLiteral(["oil of expertise"])))) > 1) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject219 || (_templateObject219 = leveling_taggedTemplateLiteral(["oil of expertise"]))), (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject220 || (_templateObject220 = leveling_taggedTemplateLiteral(["oil of expertise"])))) - 1);
      if (have(template_string_$item(_templateObject221 || (_templateObject221 = leveling_taggedTemplateLiteral(["cherry"])))) && have($effect(_templateObject222 || (_templateObject222 = leveling_taggedTemplateLiteral(["Expert Oiliness"]))))) (0,external_kolmafia_namespaceObject.putCloset)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject223 || (_templateObject223 = leveling_taggedTemplateLiteral(["cherry"])))), template_string_$item(_templateObject224 || (_templateObject224 = leveling_taggedTemplateLiteral(["cherry"]))));
    },
    limit: {
      tries: 1
    }
    ...
    do: $location(_templateObject225 || (_templateObject225 = leveling_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      offhand: template_string_$item(_templateObject226 || (_templateObject226 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject227 || (_templateObject227 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject228 || (_templateObject228 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 10
    ...
    do: powerlevelingLocation(),
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject229 || (_templateObject229 = leveling_taggedTemplateLiteral(["Snokebomb"])))).abort()),
    outfit: {
      offhand: template_string_$item(_templateObject230 || (_templateObject230 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject231 || (_templateObject231 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject232 || (_templateObject232 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    choices: {
      1094: 5,
    ...
    completed: () => have(template_string_$item(_templateObject233 || (_templateObject233 = leveling_taggedTemplateLiteral(["turtle totem"])))) && have(template_string_$item(_templateObject234 || (_templateObject234 = leveling_taggedTemplateLiteral(["saucepan"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.buy)(1, template_string_$item(_templateObject235 || (_templateObject235 = leveling_taggedTemplateLiteral(["chewing gum on a string"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject236 || (_templateObject236 = leveling_taggedTemplateLiteral(["chewing gum on a string"]))));
    },
    limit: {
      tries: 50
    }
    ...
    completed: () => {
      ...
      return !have(template_string_$item(_templateObject237 || (_templateObject237 = leveling_taggedTemplateLiteral(["backup camera"])))) || !freeFightMonsters.includes((_get2 = property_get("lastCopyableMonster")) !== null && _get2 !== void 0 ? _get2 : $monster.none) || property_get("_backUpUses") >= 11 - clamp(property_get("instant_saveBackups", 0), 0, 11) || (0,external_kolmafia_namespaceObject.myBasestat)(template_string_$stat(_templateObject238 || (_templateObject238 = leveling_taggedTemplateLiteral(["Mysticality"])))) >= 190;
    },
    // no longer need to back up Witchess Kings
    do: $location(_templateObject239 || (_templateObject239 = leveling_taggedTemplateLiteral(["The Dire Warren"]))),
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject240 || (_templateObject240 = leveling_taggedTemplateLiteral(["Back-Up to your Last Enemy"])))).default()),
    outfit: {
      back: template_string_$item(_templateObject241 || (_templateObject241 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject242 || (_templateObject242 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject243 || (_templateObject243 = leveling_taggedTemplateLiteral(["codpiece"]))),
      acc3: template_string_$item(_templateObject244 || (_templateObject244 = leveling_taggedTemplateLiteral(["backup camera"]))),
      familiar: template_string_$familiar(_templateObject245 || (_templateObject245 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    post: () => {
      var _get3;
    ...
    completed: () => getKramcoWandererChance() < 1.0 || !have(template_string_$item(_templateObject246 || (_templateObject246 = leveling_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))),
    do: $location(_templateObject247 || (_templateObject247 = leveling_taggedTemplateLiteral(["Noob Cave"]))),
    outfit: {
      back: template_string_$item(_templateObject248 || (_templateObject248 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject249 || (_templateObject249 = leveling_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))),
      acc1: template_string_$item(_templateObject250 || (_templateObject250 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject251 || (_templateObject251 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    post: () => {
    ...
    name: "Red Skeleton",
    ready: () => !have($effect(_templateObject252 || (_templateObject252 = leveling_taggedTemplateLiteral(["Everything Looks Yellow"])))),
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));

      if (!have(template_string_$item(_templateObject253 || (_templateObject253 = leveling_taggedTemplateLiteral(["yellow rocket"]))))) {
    ...
    combat: new CombatStrategy().macro(combat_Macro.tryItem(template_string_$item(_templateObject258 || (_templateObject258 = leveling_taggedTemplateLiteral(["yellow rocket"])))).abort()),
    outfit: {
      back: template_string_$item(_templateObject259 || (_templateObject259 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject260 || (_templateObject260 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject261 || (_templateObject261 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject262 || (_templateObject262 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    post: () => {
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject263 || (_templateObject263 = leveling_taggedTemplateLiteral(["red box"]))), 1);
      sendAutumnaton();
      sellMiscellaneousItems();
    },
    limit: {
    ...
    prepare: () => {
      ...
      unbreakableUmbrella();
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
      tryAcquiringEffect($effect(_templateObject264 || (_templateObject264 = leveling_taggedTemplateLiteral(["Comic Violence"]))));
    },
    ...
    combat: new CombatStrategy().macro(combat_Macro.if_($monster(_templateObject265 || (_templateObject265 = leveling_taggedTemplateLiteral(["LOV Enforcer"]))), combat_Macro.attack().repeat()).if_($monster(_templateObject266 || (_templateObject266 = leveling_taggedTemplateLiteral(["LOV Engineer"]))), combat_Macro["default"]()).if_($monster(_templateObject267 || (_templateObject267 = leveling_taggedTemplateLiteral(["LOV Equivocator"]))), combat_Macro["default"]())),
    outfit: {
      weapon: template_string_$item(_templateObject268 || (_templateObject268 = leveling_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
      offhand: template_string_$item(_templateObject269 || (_templateObject269 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject270 || (_templateObject270 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject271 || (_templateObject271 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 1
    ...
    post: () => {
      if (have($effect(_templateObject272 || (_templateObject272 = leveling_taggedTemplateLiteral(["Beaten Up"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("hottub");
      if (have(template_string_$item(_templateObject273 || (_templateObject273 = leveling_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject274 || (_templateObject274 = leveling_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"]))), 1);
      sendAutumnaton();
      sellMiscellaneousItems();
    }
  }, {
    ...
    do: $location(_templateObject275 || (_templateObject275 = leveling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      back: template_string_$item(_templateObject276 || (_templateObject276 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject277 || (_templateObject277 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject278 || (_templateObject278 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject279 || (_templateObject279 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 3
    ...
    completed: () => property_get("_godLobsterFights") >= 3 || !have(template_string_$familiar(_templateObject280 || (_templateObject280 = leveling_taggedTemplateLiteral(["God Lobster"])))),
    do: () => (0,external_kolmafia_namespaceObject.visitUrl)("main.php?fightgodlobster=1"),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    choices: {
      1310: () => have(template_string_$item(_templateObject281 || (_templateObject281 = leveling_taggedTemplateLiteral(["God Lobster's Ring"])))) ? 2 : 3
    },
    // Get xp on last fight
    outfit: {
      back: template_string_$item(_templateObject282 || (_templateObject282 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject283 || (_templateObject283 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject284 || (_templateObject284 = leveling_taggedTemplateLiteral(["codpiece"]))),
      famequip: template_string_$items(_templateObject285 || (_templateObject285 = leveling_taggedTemplateLiteral(["God Lobster's Ring, God Lobster's Scepter"]))),
      familiar: template_string_$familiar(_templateObject286 || (_templateObject286 = leveling_taggedTemplateLiteral(["God Lobster"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    acquire: [{
      item: template_string_$item(_templateObject287 || (_templateObject287 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }],
    limit: {
      tries: 3
    },
    ...
    completed: () => property_get("_eldritchHorrorEvoked") || !have(template_string_$skill(_templateObject288 || (_templateObject288 = leveling_taggedTemplateLiteral(["Evoke Eldritch Horror"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject289 || (_templateObject289 = leveling_taggedTemplateLiteral(["Evoke Eldritch Horror"])))),
    post: () => {
      if (have($effect(_templateObject290 || (_templateObject290 = leveling_taggedTemplateLiteral(["Beaten Up"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("hottub");
      sendAutumnaton();
      sellMiscellaneousItems();
    },
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      back: template_string_$item(_templateObject291 || (_templateObject291 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject292 || (_templateObject292 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject293 || (_templateObject293 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject294 || (_templateObject294 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 1
    ...
    do: () => fightPiece($monster(_templateObject295 || (_templateObject295 = leveling_taggedTemplateLiteral(["Witchess Bishop"])))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      back: template_string_$item(_templateObject296 || (_templateObject296 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject297 || (_templateObject297 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject298 || (_templateObject298 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject299 || (_templateObject299 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    post: () => {
      sendAutumnaton();
    ...
    completed: () => property_get("_machineTunnelsAdv") >= 5 || !have(template_string_$familiar(_templateObject300 || (_templateObject300 = leveling_taggedTemplateLiteral(["Machine Elf"])))),
    do: () => (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject301 || (_templateObject301 = leveling_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), -1),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      back: template_string_$item(_templateObject302 || (_templateObject302 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject303 || (_templateObject303 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject304 || (_templateObject304 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject305 || (_templateObject305 = leveling_taggedTemplateLiteral(["Machine Elf"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 5
    ...
    name: "Powerlevel",
    completed: () => (0,external_kolmafia_namespaceObject.myBasestat)(template_string_$stat(_templateObject306 || (_templateObject306 = leveling_taggedTemplateLiteral(["Mysticality"])))) >= 175 && (haveCBBIngredients() || craftedCBBEffects.some(ef => have(ef)) || craftedCBBEffects.every(ef => forbiddenEffects.includes(ef))) && (powerlevelingLocation() !== $location(_templateObject307 || (_templateObject307 = leveling_taggedTemplateLiteral(["The Neverending Party"]))) || property_get("_neverendingPartyFreeTurns") >= 10),
    do: powerlevelingLocation(),
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));
      unbreakableUmbrella();
      ...
      if (!have($effect(_templateObject308 || (_templateObject308 = leveling_taggedTemplateLiteral(["Everything Looks Red"])))) && !have(template_string_$item(_templateObject309 || (_templateObject309 = leveling_taggedTemplateLiteral(["red rocket"]))))) {
        if ((0,external_kolmafia_namespaceObject.myMeat)() >= 250) (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject310 || (_templateObject310 = leveling_taggedTemplateLiteral(["red rocket"]))), 1);
      }
    },
    outfit: {
    ...
    combat: new CombatStrategy().macro(combat_Macro.tryItem(template_string_$item(_templateObject315 || (_templateObject315 = leveling_taggedTemplateLiteral(["red rocket"])))).trySkill(template_string_$skill(_templateObject316 || (_templateObject316 = leveling_taggedTemplateLiteral(["Bowl Sideways"])))).default()),
    post: () => {
      if (have(template_string_$item(_templateObject317 || (_templateObject317 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))))) (0,external_kolmafia_namespaceObject.chew)(template_string_$item(_templateObject318 || (_templateObject318 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))), 1);
      sendAutumnaton();
      sellMiscellaneousItems();
    }
  }, {
    name: "Acquire Wad of Dough",
    completed: () => have(template_string_$item(_templateObject319 || (_templateObject319 = leveling_taggedTemplateLiteral(["wad of dough"])))),
    do: () => {
      if ((0,external_kolmafia_namespaceObject.myMeat)() < 100) throw new Error("Insufficient Meat to purchase all-purpose flower!");
      if (!have(template_string_$item(_templateObject320 || (_templateObject320 = leveling_taggedTemplateLiteral(["all-purpose flower"]))))) (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject321 || (_templateObject321 = leveling_taggedTemplateLiteral(["all-purpose flower"]))), 1);
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject322 || (_templateObject322 = leveling_taggedTemplateLiteral(["all-purpose flower"]))), 1);
    },
    post: () => {
      if (!have(template_string_$item(_templateObject323 || (_templateObject323 = leveling_taggedTemplateLiteral(["flat dough"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject324 || (_templateObject324 = leveling_taggedTemplateLiteral(["wad of dough"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    do: () => {
      ...
      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject325 || (_templateObject325 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 2 && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject326 || (_templateObject326 = leveling_taggedTemplateLiteral(["St. Sneaky Pete's Whey"])))) >= 2 && !have($effect(_templateObject327 || (_templateObject327 = leveling_taggedTemplateLiteral(["Pretty Delicious"])))) && !property_get("instant_saveRicottaCasserole", false)) {
        if (!have(template_string_$item(_templateObject328 || (_templateObject328 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject329 || (_templateObject329 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
        (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject330 || (_templateObject330 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
      }
    },
    limit: {
      tries: 1
    ...
    after: ["Powerlevel"],
    completed: () => have($effect(_templateObject331 || (_templateObject331 = leveling_taggedTemplateLiteral(["On the Trolley"])))) || property_get("instant_saveBeesKnees", false),
    do: () => {
      if ((0,external_kolmafia_namespaceObject.myMeat)() < 500) throw new Error("Insufficient Meat to purchase Bee's Knees!");
      tryAcquiringEffect($effect(_templateObject332 || (_templateObject332 = leveling_taggedTemplateLiteral(["Ode to Booze"]))));
    ...
    prepare: () => {
      ...
      garbageShirt();
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
      tryAcquiringEffect($effect(_templateObject333 || (_templateObject333 = leveling_taggedTemplateLiteral(["Favored by Lyle"]))));
      tryAcquiringEffect($effect(_templateObject334 || (_templateObject334 = leveling_taggedTemplateLiteral(["Starry-Eyed"]))));
      (0,external_kolmafia_namespaceObject.restoreMp)(50);
    },
    completed: () => monstersReminisced().includes($monster(_templateObject335 || (_templateObject335 = leveling_taggedTemplateLiteral(["Witchess King"])))) || !availableLocketMonsters().includes($monster(_templateObject336 || (_templateObject336 = leveling_taggedTemplateLiteral(["Witchess King"])))) || property_get("instant_saveLocketWitchessKing", false),
    do: () => reminisce($monster(_templateObject337 || (_templateObject337 = leveling_taggedTemplateLiteral(["Witchess King"])))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      back: template_string_$item(_templateObject338 || (_templateObject338 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject339 || (_templateObject339 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject340 || (_templateObject340 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject341 || (_templateObject341 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    post: () => {
      sendAutumnaton();
    ...
    outfit: {
      back: template_string_$item(_templateObject342 || (_templateObject342 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject343 || (_templateObject343 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject344 || (_templateObject344 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject345 || (_templateObject345 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    completed: () => (property_get("_shatteringPunchUsed") >= 3 || !have(template_string_$skill(_templateObject346 || (_templateObject346 = leveling_taggedTemplateLiteral(["Shattering Punch"]))))) && (property_get("_gingerbreadMobHitUsed") || !have(template_string_$skill(_templateObject347 || (_templateObject347 = leveling_taggedTemplateLiteral(["Gingerbread Mob Hit"]))))) && (have($effect(_templateObject348 || (_templateObject348 = leveling_taggedTemplateLiteral(["Pretty Delicious"])))) || property_get("instant_saveRicottaCasserole", false)) && (property_get("instant_saveRoastedVegetableItem", false) || (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject349 || (_templateObject349 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 2) && (have($effect(_templateObject350 || (_templateObject350 = leveling_taggedTemplateLiteral(["Awfully Wily"])))) || property_get("instant_saveWileyWheyBar", false) || (0,external_kolmafia_namespaceObject.myBasestat)(template_string_$stat(_templateObject351 || (_templateObject351 = leveling_taggedTemplateLiteral(["Mysticality"])))) >= 190),
    do: powerlevelingLocation(),
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject352 || (_templateObject352 = leveling_taggedTemplateLiteral(["Feel Pride"])))).trySkill(template_string_$skill(_templateObject353 || (_templateObject353 = leveling_taggedTemplateLiteral(["Chest X-Ray"])))).trySkill(template_string_$skill(_templateObject354 || (_templateObject354 = leveling_taggedTemplateLiteral(["Shattering Punch"])))).trySkill(template_string_$skill(_templateObject355 || (_templateObject355 = leveling_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill(template_string_$skill(_templateObject356 || (_templateObject356 = leveling_taggedTemplateLiteral(["Bowl Sideways"])))).default()),
    choices: {
      1094: 5,
      1115: 6,
      1322: 2,
    ...
    post: () => {
      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject357 || (_templateObject357 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 2 && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject358 || (_templateObject358 = leveling_taggedTemplateLiteral(["St. Sneaky Pete's Whey"])))) >= 2 && !have($effect(_templateObject359 || (_templateObject359 = leveling_taggedTemplateLiteral(["Pretty Delicious"])))) && !property_get("instant_saveRicottaCasserole", false)) {
        if (!have(template_string_$item(_templateObject360 || (_templateObject360 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject361 || (_templateObject361 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
        (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject362 || (_templateObject362 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
      }

      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject363 || (_templateObject363 = leveling_taggedTemplateLiteral(["St. Sneaky Pete's Whey"])))) >= 1 && !have($effect(_templateObject364 || (_templateObject364 = leveling_taggedTemplateLiteral(["Awfully Wily"])))) && !property_get("instant_saveWileyWheyBar", false)) {
        (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject365 || (_templateObject365 = leveling_taggedTemplateLiteral(["Pete's wiley whey bar"]))), 1);
        (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject366 || (_templateObject366 = leveling_taggedTemplateLiteral(["Pete's wiley whey bar"]))), 1);
      }

      if (have(template_string_$item(_templateObject367 || (_templateObject367 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))))) (0,external_kolmafia_namespaceObject.chew)(template_string_$item(_templateObject368 || (_templateObject368 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))), 1);
      sendAutumnaton();
      sellMiscellaneousItems();
    },
    limit: {
...
var RunStartQuest = {
  ...
  tasks: [{
    ...
    completed: () => property_get("_deckCardsDrawn") >= 10 || !have(template_string_$item(runstart_templateObject15 || (runstart_templateObject15 = runstart_taggedTemplateLiteral(["Deck of Every Card"])))) || property_get("instant_saveDeck", false),
    do: () => {
    ...
    name: "KGB",
    completed: () => property_get("_kgbClicksUsed") > 0 || !have(template_string_$item(runstart_templateObject16 || (runstart_templateObject16 = runstart_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"])))) || property_get("instant_saveKGBClicks", false),
    ...
    do: () => {
      if ((0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(runstart_templateObject23 || (runstart_templateObject23 = runstart_taggedTemplateLiteral(["borrowed time"])))) === 0 && !have(template_string_$item(runstart_templateObject24 || (runstart_templateObject24 = runstart_taggedTemplateLiteral(["borrowed time"]))))) {
        (0,external_kolmafia_namespaceObject.print)("Uh oh! You do not seem to have a borrowed time in Hagnk's", "red");
        (0,external_kolmafia_namespaceObject.print)("Try to purchase one from the mall with your meat from Hagnk's before re-running instantsccs", "red");
      }

      (0,external_kolmafia_namespaceObject.use)(template_string_$item(runstart_templateObject25 || (runstart_templateObject25 = runstart_taggedTemplateLiteral(["borrowed time"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    do: () => {
      ...
      var juiceBarItems = [template_string_$item(runstart_templateObject26 || (runstart_templateObject26 = runstart_taggedTemplateLiteral(["clove-flavored lip balm"]))), template_string_$item(runstart_templateObject27 || (runstart_templateObject27 = runstart_taggedTemplateLiteral(["ectoplasm <i>au jus</i>"])))];
      if (property_get("_loveTunnelUsed") || !property_get("loveTunnelAvailable")) juiceBarItems.push(template_string_$item(runstart_templateObject28 || (runstart_templateObject28 = runstart_taggedTemplateLiteral(["gremlin juice"]))));
    ...
    name: "Cowboy Boots",
    completed: () => have(template_string_$item(runstart_templateObject29 || (runstart_templateObject29 = runstart_taggedTemplateLiteral(["your cowboy boots"])))) || !property_get("telegraphOfficeAvailable"),
    ...
    completed: () => have(template_string_$item(runstart_templateObject30 || (runstart_templateObject30 = runstart_taggedTemplateLiteral(["gold detective badge"])))) || !property_get("hasDetectiveSchool"),
    ...
    name: "Pantogramming",
    completed: () => havePants() || !have(template_string_$item(runstart_templateObject31 || (runstart_templateObject31 = runstart_taggedTemplateLiteral(["portable pantogram"])))) || property_get("instant_savePantogram", false),
    do: () => {
    ...
    name: "Mummery",
    completed: () => property_get("_mummeryMods").includes("Experience (Mysticality)") || !have(template_string_$item(runstart_templateObject32 || (runstart_templateObject32 = runstart_taggedTemplateLiteral(["mumming trunk"])))) || property_get("instant_saveMummingTrunk", false),
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("mummery myst"),
    outfit: {
      familiar: template_string_$familiar(runstart_templateObject33 || (runstart_templateObject33 = runstart_taggedTemplateLiteral(["Cookbookbat"])))
    },
    limit: {
      tries: 1
    }
    ...
    name: "BoomBox",
    completed: () => song() === "These Fists Were Made for Punchin'" || !have(template_string_$item(runstart_templateObject34 || (runstart_templateObject34 = runstart_taggedTemplateLiteral(["SongBoom\u2122 BoomBox"])))),
    ...
    name: "Vote",
    completed: () => have(template_string_$item(runstart_templateObject35 || (runstart_templateObject35 = runstart_taggedTemplateLiteral(["\"I Voted!\" sticker"])))) || !property_get("voteAlways"),
    ...
    name: "Cosplay Saber",
    completed: () => property_get("_saberMod") > 0 || !have(template_string_$item(runstart_templateObject36 || (runstart_templateObject36 = runstart_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))),
    ...
    name: "Bird Calendar",
    completed: () => have(template_string_$skill(runstart_templateObject37 || (runstart_templateObject37 = runstart_taggedTemplateLiteral(["Seek out a Bird"])))) || !have(template_string_$item(runstart_templateObject38 || (runstart_templateObject38 = runstart_taggedTemplateLiteral(["Bird-a-Day calendar"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(runstart_templateObject39 || (runstart_templateObject39 = runstart_taggedTemplateLiteral(["Bird-a-Day calendar"])))),
    limit: {
      tries: 1
    }
  }, {
    ...
    completed: () => have(template_string_$item(runstart_templateObject40 || (runstart_templateObject40 = runstart_taggedTemplateLiteral(["weeping willow wand"])))) || !have(template_string_$item(runstart_templateObject41 || (runstart_templateObject41 = runstart_taggedTemplateLiteral(["SpinMaster\u2122 lathe"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(runstart_templateObject42 || (runstart_templateObject42 = runstart_taggedTemplateLiteral(["weeping willow wand"])))),
    limit: {
      tries: 1
    }
  }, {
    name: "Backup Camera",
    completed: () => !have(template_string_$item(runstart_templateObject43 || (runstart_templateObject43 = runstart_taggedTemplateLiteral(["backup camera"])))) || property_get("backupCameraMode") === "ml" && property_get("backupCameraReverserEnabled"),
    do: () => {
    ...
    name: "Autumnaton",
    completed: () => !have(template_string_$item(runstart_templateObject44 || (runstart_templateObject44 = runstart_taggedTemplateLiteral(["autumn-aton"])))) || have(template_string_$item(runstart_templateObject45 || (runstart_templateObject45 = runstart_taggedTemplateLiteral(["autumn leaf"])))) || have($effect(runstart_templateObject46 || (runstart_templateObject46 = runstart_taggedTemplateLiteral(["Crunching Leaves"])))),
    ...
    completed: () => !have(template_string_$item(runstart_templateObject47 || (runstart_templateObject47 = runstart_taggedTemplateLiteral(["model train set"])))) || (0,external_kolmafia_namespaceObject.getWorkshed)() === template_string_$item(runstart_templateObject48 || (runstart_templateObject48 = runstart_taggedTemplateLiteral(["model train set"]))) && !canConfigure(),
    do: () => {
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(runstart_templateObject49 || (runstart_templateObject49 = runstart_taggedTemplateLiteral(["model train set"]))));
    ...
    prepare: () => {
      if (have(template_string_$item(runstart_templateObject50 || (runstart_templateObject50 = runstart_taggedTemplateLiteral(["unbreakable umbrella"])))) && property_get("umbrellaState") !== "pitchfork style") (0,external_kolmafia_namespaceObject.cliExecute)("umbrella weapon");
    },
    ...
    do: $location(runstart_templateObject51 || (runstart_templateObject51 = runstart_taggedTemplateLiteral(["The Dire Warren"]))),
    combat: new CombatStrategy().macro(combat_Macro.attack()),
    outfit: {
      offhand: template_string_$item(runstart_templateObject52 || (runstart_templateObject52 = runstart_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(runstart_templateObject53 || (runstart_templateObject53 = runstart_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(runstart_templateObject54 || (runstart_templateObject54 = runstart_taggedTemplateLiteral(["Cookbookbat"]))),
    ...
    name: "Soul Food",
    ready: () => (0,external_kolmafia_namespaceObject.mySoulsauce)() >= 5,
    completed: () => (0,external_kolmafia_namespaceObject.mySoulsauce)() < 5 || (0,external_kolmafia_namespaceObject.myMp)() > (0,external_kolmafia_namespaceObject.myMaxmp)() - 15 || !have(template_string_$skill(runstart_templateObject55 || (runstart_templateObject55 = runstart_taggedTemplateLiteral(["Soul Food"])))),
    do: () => {
      while ((0,external_kolmafia_namespaceObject.mySoulsauce)() >= 5 && (0,external_kolmafia_namespaceObject.myMp)() <= (0,external_kolmafia_namespaceObject.myMaxmp)() - 15) {
        (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(runstart_templateObject56 || (runstart_templateObject56 = runstart_taggedTemplateLiteral(["Soul Food"]))));
      }
    }
  }, {
    ...
    prepare: () => {
      if (!have(template_string_$item(runstart_templateObject57 || (runstart_templateObject57 = runstart_taggedTemplateLiteral(["yellow rocket"])))) && !have($effect(runstart_templateObject58 || (runstart_templateObject58 = runstart_taggedTemplateLiteral(["Everything Looks Yellow"]))))) {
        if ((0,external_kolmafia_namespaceObject.myMeat)() < 250) throw new Error("Insufficient Meat to purchase yellow rocket!");
        (0,external_kolmafia_namespaceObject.buy)(template_string_$item(runstart_templateObject59 || (runstart_templateObject59 = runstart_taggedTemplateLiteral(["yellow rocket"]))), 1);
      }

      unbreakableUmbrella();
      if ((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(runstart_templateObject60 || (runstart_templateObject60 = runstart_taggedTemplateLiteral(["miniature crystal ball"]))))) (0,external_kolmafia_namespaceObject.equip)($slot(runstart_templateObject61 || (runstart_templateObject61 = runstart_taggedTemplateLiteral(["familiar"]))), template_string_$item.none);
    },
    completed: () => !have(template_string_$skill(runstart_templateObject62 || (runstart_templateObject62 = runstart_taggedTemplateLiteral(["Map the Monsters"])))) || property_get("_monstersMapped") >= 3 || have(template_string_$item(runstart_templateObject63 || (runstart_templateObject63 = runstart_taggedTemplateLiteral(["cherry"])))) || (() => {
    ...
    do: () => mapMonster($location(runstart_templateObject64 || (runstart_templateObject64 = runstart_taggedTemplateLiteral(["The Skeleton Store"]))), $monster(runstart_templateObject65 || (runstart_templateObject65 = runstart_taggedTemplateLiteral(["novelty tropical skeleton"])))),
    combat: new CombatStrategy().macro(combat_Macro.if_($monster(runstart_templateObject66 || (runstart_templateObject66 = runstart_taggedTemplateLiteral(["novelty tropical skeleton"]))), combat_Macro.tryItem(template_string_$item(runstart_templateObject67 || (runstart_templateObject67 = runstart_taggedTemplateLiteral(["yellow rocket"]))))).abort()),
    outfit: {
      offhand: template_string_$item(runstart_templateObject68 || (runstart_templateObject68 = runstart_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(runstart_templateObject69 || (runstart_templateObject69 = runstart_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(runstart_templateObject70 || (runstart_templateObject70 = runstart_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape, -equip miniature crystal ball"
    },
    post: () => {
      if (have(template_string_$item(runstart_templateObject71 || (runstart_templateObject71 = runstart_taggedTemplateLiteral(["MayDay\u2122 supply package"])))) && !property_get("instant_saveMayday", false)) (0,external_kolmafia_namespaceObject.use)(template_string_$item(runstart_templateObject72 || (runstart_templateObject72 = runstart_taggedTemplateLiteral(["MayDay\u2122 supply package"]))), 1);
      if (have(template_string_$item(runstart_templateObject73 || (runstart_templateObject73 = runstart_taggedTemplateLiteral(["space blanket"]))))) (0,external_kolmafia_namespaceObject.autosell)(template_string_$item(runstart_templateObject74 || (runstart_templateObject74 = runstart_taggedTemplateLiteral(["space blanket"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    prepare: () => {
      if (!have(template_string_$item(runstart_templateObject75 || (runstart_templateObject75 = runstart_taggedTemplateLiteral(["yellow rocket"])))) && !have($effect(runstart_templateObject76 || (runstart_templateObject76 = runstart_taggedTemplateLiteral(["Everything Looks Yellow"]))))) {
        if ((0,external_kolmafia_namespaceObject.myMeat)() < 250) throw new Error("Insufficient Meat to purchase yellow rocket!");
        (0,external_kolmafia_namespaceObject.buy)(template_string_$item(runstart_templateObject77 || (runstart_templateObject77 = runstart_taggedTemplateLiteral(["yellow rocket"]))), 1);
      }

      unbreakableUmbrella();
      if (property_get("_snokebombUsed") === 0) (0,external_kolmafia_namespaceObject.restoreMp)(50);
      if ((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(runstart_templateObject78 || (runstart_templateObject78 = runstart_taggedTemplateLiteral(["miniature crystal ball"]))))) (0,external_kolmafia_namespaceObject.equip)($slot(runstart_templateObject79 || (runstart_templateObject79 = runstart_taggedTemplateLiteral(["familiar"]))), template_string_$item.none);
    },
    completed: () => have(template_string_$item(runstart_templateObject80 || (runstart_templateObject80 = runstart_taggedTemplateLiteral(["cherry"])))) && !have(template_string_$item(runstart_templateObject81 || (runstart_templateObject81 = runstart_taggedTemplateLiteral(["cosmic bowling ball"])))) && property_get("_snokebombUsed") >= 1,
    do: $location(runstart_templateObject82 || (runstart_templateObject82 = runstart_taggedTemplateLiteral(["The Skeleton Store"]))),
    combat: new CombatStrategy().macro(combat_Macro.if_($monster(runstart_templateObject83 || (runstart_templateObject83 = runstart_taggedTemplateLiteral(["novelty tropical skeleton"]))), combat_Macro.tryItem(template_string_$item(runstart_templateObject84 || (runstart_templateObject84 = runstart_taggedTemplateLiteral(["yellow rocket"]))))).trySkill(template_string_$skill(runstart_templateObject85 || (runstart_templateObject85 = runstart_taggedTemplateLiteral(["Bowl a Curveball"])))).trySkill(template_string_$skill(runstart_templateObject86 || (runstart_templateObject86 = runstart_taggedTemplateLiteral(["Snokebomb"])))).abort()),
    outfit: {
      offhand: template_string_$item(runstart_templateObject87 || (runstart_templateObject87 = runstart_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(runstart_templateObject88 || (runstart_templateObject88 = runstart_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(runstart_templateObject89 || (runstart_templateObject89 = runstart_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape, -equip miniature crystal ball"
    },
    post: () => {
      if (have(template_string_$item(runstart_templateObject90 || (runstart_templateObject90 = runstart_taggedTemplateLiteral(["MayDay\u2122 supply package"])))) && !property_get("instant_saveMayday", false)) (0,external_kolmafia_namespaceObject.use)(template_string_$item(runstart_templateObject91 || (runstart_templateObject91 = runstart_taggedTemplateLiteral(["MayDay\u2122 supply package"]))), 1);
      if (have(template_string_$item(runstart_templateObject92 || (runstart_templateObject92 = runstart_taggedTemplateLiteral(["space blanket"]))))) (0,external_kolmafia_namespaceObject.autosell)(template_string_$item(runstart_templateObject93 || (runstart_templateObject93 = runstart_taggedTemplateLiteral(["space blanket"]))), 1);
    },
    limit: {
      tries: 4
    }
    ...
    do: () => {
      (0,external_kolmafia_namespaceObject.buy)(1, template_string_$item(runstart_templateObject94 || (runstart_templateObject94 = runstart_taggedTemplateLiteral(["chewing gum on a string"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runstart_templateObject95 || (runstart_templateObject95 = runstart_taggedTemplateLiteral(["chewing gum on a string"]))));
      if (property_get("_cloversPurchased") < 3) (0,external_kolmafia_namespaceObject.hermit)(template_string_$item(runstart_templateObject96 || (runstart_templateObject96 = runstart_taggedTemplateLiteral(["11-leaf clover"]))), 1);
    },
    acquire: [{
      item: template_string_$item(runstart_templateObject97 || (runstart_templateObject97 = runstart_taggedTemplateLiteral(["toy accordion"])))
    }],
    limit: {
      tries: 50
    }
    ...
    ready: () => have(template_string_$item(runstart_templateObject98 || (runstart_templateObject98 = runstart_taggedTemplateLiteral(["11-leaf clover"])))) || have($effect(runstart_templateObject99 || (runstart_templateObject99 = runstart_taggedTemplateLiteral(["Lucky!"])))),
    completed: () => (0,external_kolmafia_namespaceObject.myInebriety)() >= 1 || property_get("instant_skipDistilledFortifiedWine", false),
    do: () => {
      if (!have($effect(runstart_templateObject100 || (runstart_templateObject100 = runstart_taggedTemplateLiteral(["Lucky!"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(runstart_templateObject101 || (runstart_templateObject101 = runstart_taggedTemplateLiteral(["11-leaf clover"]))));
      if (!have(template_string_$item(runstart_templateObject102 || (runstart_templateObject102 = runstart_taggedTemplateLiteral(["distilled fortified wine"]))))) (0,external_kolmafia_namespaceObject.adv1)($location(runstart_templateObject103 || (runstart_templateObject103 = runstart_taggedTemplateLiteral(["The Sleazy Back Alley"]))), -1);

      while (have(template_string_$item(runstart_templateObject104 || (runstart_templateObject104 = runstart_taggedTemplateLiteral(["distilled fortified wine"])))) && (0,external_kolmafia_namespaceObject.myInebriety)() < 1) {
        tryAcquiringEffect($effect(runstart_templateObject105 || (runstart_templateObject105 = runstart_taggedTemplateLiteral(["Ode to Booze"]))));
        (0,external_kolmafia_namespaceObject.drink)(template_string_$item(runstart_templateObject106 || (runstart_templateObject106 = runstart_taggedTemplateLiteral(["distilled fortified wine"]))), 1);
      }
    },
    limit: {
      tries: 1
    ...
    ready: () => getKramcoWandererChance() >= 1.0,
    completed: () => getKramcoWandererChance() < 1.0 || !have(template_string_$item(runstart_templateObject107 || (runstart_templateObject107 = runstart_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))),
    do: $location(runstart_templateObject108 || (runstart_templateObject108 = runstart_taggedTemplateLiteral(["Noob Cave"]))),
    outfit: {
      offhand: template_string_$item(runstart_templateObject109 || (runstart_templateObject109 = runstart_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))),
      acc1: template_string_$item(runstart_templateObject110 || (runstart_templateObject110 = runstart_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(runstart_templateObject111 || (runstart_templateObject111 = runstart_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    combat: new CombatStrategy().macro(combat_Macro["default"]())
  }]
...
var FamiliarWeightQuest = {
  ...
  tasks: [{
    ...
    prepare: () => {
      ...
      if (have(template_string_$skill(familiarweight_templateObject17 || (familiarweight_templateObject17 = familiarweight_taggedTemplateLiteral(["Summon Clip Art"])))) && !property_get("instant_saveClipArt", false) && $familiars(familiarweight_templateObject18 || (familiarweight_templateObject18 = familiarweight_taggedTemplateLiteral(["Mini-Trainbot, Exotic Parrot"]))).some(fam => have(fam))) {
        if (!have(template_string_$item(familiarweight_templateObject19 || (familiarweight_templateObject19 = familiarweight_taggedTemplateLiteral(["box of Familiar Jacks"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(familiarweight_templateObject20 || (familiarweight_templateObject20 = familiarweight_taggedTemplateLiteral(["box of Familiar Jacks"]))), 1);
        if (have(template_string_$familiar(familiarweight_templateObject21 || (familiarweight_templateObject21 = familiarweight_taggedTemplateLiteral(["Mini-Trainbot"]))))) (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(familiarweight_templateObject22 || (familiarweight_templateObject22 = familiarweight_taggedTemplateLiteral(["Mini-Trainbot"]))));else (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(familiarweight_templateObject23 || (familiarweight_templateObject23 = familiarweight_taggedTemplateLiteral(["Exotic Parrot"]))));
        (0,external_kolmafia_namespaceObject.use)(template_string_$item(familiarweight_templateObject24 || (familiarweight_templateObject24 = familiarweight_taggedTemplateLiteral(["box of Familiar Jacks"]))), 1);
    ...
    outfit: {
      ...
      familiar: template_string_$familiar(familiarweight_templateObject25 || (familiarweight_templateObject25 = familiarweight_taggedTemplateLiteral(["Cookbookbat"])))
    },
    limit: {
      tries: 1
    }
...
var BoozeDropQuest = {
  ...
  tasks: [{
    ...
    name: "Acquire Clover",
    completed: () => have(template_string_$item(boozedrop_templateObject2 || (boozedrop_templateObject2 = boozedrop_taggedTemplateLiteral(["11-leaf clover"])))) || property_get("_cloversPurchased") >= 2,
    do: () => {
      (0,external_kolmafia_namespaceObject.buy)(1, template_string_$item(boozedrop_templateObject3 || (boozedrop_templateObject3 = boozedrop_taggedTemplateLiteral(["chewing gum on a string"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(boozedrop_templateObject4 || (boozedrop_templateObject4 = boozedrop_taggedTemplateLiteral(["chewing gum on a string"]))));
      (0,external_kolmafia_namespaceObject.hermit)(template_string_$item(boozedrop_templateObject5 || (boozedrop_templateObject5 = boozedrop_taggedTemplateLiteral(["11-leaf clover"]))), 1);
    },
    limit: {
      tries: 50
    }
    ...
    completed: () => have(template_string_$item(boozedrop_templateObject6 || (boozedrop_templateObject6 = boozedrop_taggedTemplateLiteral(["cyclops eyedrops"])))) || have($effect(boozedrop_templateObject7 || (boozedrop_templateObject7 = boozedrop_taggedTemplateLiteral(["One Very Clear Eye"])))),
    do: () => {
      if (!have($effect(boozedrop_templateObject8 || (boozedrop_templateObject8 = boozedrop_taggedTemplateLiteral(["Lucky!"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(boozedrop_templateObject9 || (boozedrop_templateObject9 = boozedrop_taggedTemplateLiteral(["11-leaf clover"]))));
      if (!have(template_string_$item(boozedrop_templateObject10 || (boozedrop_templateObject10 = boozedrop_taggedTemplateLiteral(["cyclops eyedrops"]))))) (0,external_kolmafia_namespaceObject.adv1)($location(boozedrop_templateObject11 || (boozedrop_templateObject11 = boozedrop_taggedTemplateLiteral(["The Limerick Dungeon"]))), -1);
    },
    limit: {
      tries: 1
    }
    ...
    do: () => {
      ...
      if ((have(template_string_$item(boozedrop_templateObject12 || (boozedrop_templateObject12 = boozedrop_taggedTemplateLiteral(["photocopied monster"])))) || (0,external_kolmafia_namespaceObject.faxbot)($monster(boozedrop_templateObject13 || (boozedrop_templateObject13 = boozedrop_taggedTemplateLiteral(["ungulith"]))))) && property_get("photocopyMonster") === $monster(boozedrop_templateObject14 || (boozedrop_templateObject14 = boozedrop_taggedTemplateLiteral(["ungulith"])))) {
        (0,external_kolmafia_namespaceObject.use)(template_string_$item(boozedrop_templateObject15 || (boozedrop_templateObject15 = boozedrop_taggedTemplateLiteral(["photocopied monster"]))));
      }
    },
    outfit: {
      back: template_string_$item(boozedrop_templateObject16 || (boozedrop_templateObject16 = boozedrop_taggedTemplateLiteral(["vampyric cloake"]))),
      weapon: template_string_$item(boozedrop_templateObject17 || (boozedrop_templateObject17 = boozedrop_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
      offhand: template_string_$item(boozedrop_templateObject18 || (boozedrop_templateObject18 = boozedrop_taggedTemplateLiteral(["industrial fire extinguisher"]))),
      familiar: template_string_$familiar(boozedrop_templateObject19 || (boozedrop_templateObject19 = boozedrop_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "myst"
    },
    choices: {
      1387: 3
    },
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(boozedrop_templateObject20 || (boozedrop_templateObject20 = boozedrop_taggedTemplateLiteral(["Bowl Straight Up"])))).trySkill(template_string_$skill(boozedrop_templateObject21 || (boozedrop_templateObject21 = boozedrop_taggedTemplateLiteral(["Become a Bat"])))).trySkill(template_string_$skill(boozedrop_templateObject22 || (boozedrop_templateObject22 = boozedrop_taggedTemplateLiteral(["Fire Extinguisher: Polar Vortex"])))).trySkill(template_string_$skill(boozedrop_templateObject23 || (boozedrop_templateObject23 = boozedrop_taggedTemplateLiteral(["Use the Force"])))).default()),
    limit: {
      tries: 1
    }
  }, {
    name: "Eat roasted vegetable of Jarlsberg",
    completed: () => have($effect(boozedrop_templateObject24 || (boozedrop_templateObject24 = boozedrop_taggedTemplateLiteral(["Wizard Sight"])))) || property_get("instant_saveRoastedVegetableItem", false) || !have(template_string_$item(boozedrop_templateObject25 || (boozedrop_templateObject25 = boozedrop_taggedTemplateLiteral(["roasted vegetable of Jarlsberg"])))) && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(boozedrop_templateObject26 || (boozedrop_templateObject26 = boozedrop_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) < 2,
    do: () => {
      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(boozedrop_templateObject27 || (boozedrop_templateObject27 = boozedrop_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 2 && !have(template_string_$item(boozedrop_templateObject28 || (boozedrop_templateObject28 = boozedrop_taggedTemplateLiteral(["roasted vegetable of Jarlsberg"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(boozedrop_templateObject29 || (boozedrop_templateObject29 = boozedrop_taggedTemplateLiteral(["roasted vegetable of Jarlsberg"]))), 1);
      (0,external_kolmafia_namespaceObject.eat)(template_string_$item(boozedrop_templateObject30 || (boozedrop_templateObject30 = boozedrop_taggedTemplateLiteral(["roasted vegetable of Jarlsberg"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    completed: () => have($effect(boozedrop_templateObject31 || (boozedrop_templateObject31 = boozedrop_taggedTemplateLiteral(["Sacr\xE9 Mental"])))) || !have(template_string_$item(boozedrop_templateObject32 || (boozedrop_templateObject32 = boozedrop_taggedTemplateLiteral(["Sacramento wine"])))) || (0,external_kolmafia_namespaceObject.myInebriety)() >= (0,external_kolmafia_namespaceObject.inebrietyLimit)() || property_get("instant_saveSacramentoWine", false),
    do: () => {
      if ((0,external_kolmafia_namespaceObject.myInebriety)() < (0,external_kolmafia_namespaceObject.inebrietyLimit)()) {
        tryAcquiringEffect($effect(boozedrop_templateObject33 || (boozedrop_templateObject33 = boozedrop_taggedTemplateLiteral(["Ode to Booze"]))));
        (0,external_kolmafia_namespaceObject.drink)(template_string_$item(boozedrop_templateObject34 || (boozedrop_templateObject34 = boozedrop_taggedTemplateLiteral(["Sacramento wine"]))), 1);
        uneffect($effect(boozedrop_templateObject35 || (boozedrop_templateObject35 = boozedrop_taggedTemplateLiteral(["Ode to Booze"]))));
      }
    },
    limit: {
      tries: 1
    ...
    completed: () => property_get("_deckCardsDrawn") >= 15 || !have(template_string_$item(boozedrop_templateObject36 || (boozedrop_templateObject36 = boozedrop_taggedTemplateLiteral(["Deck of Every Card"])))) || property_get("instant_saveDeck", false),
    do: () => {
    ...
    name: "Power Seed",
    completed: () => !have(template_string_$item(boozedrop_templateObject37 || (boozedrop_templateObject37 = boozedrop_taggedTemplateLiteral(["potted power plant"])))) || (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(boozedrop_templateObject38 || (boozedrop_templateObject38 = boozedrop_taggedTemplateLiteral(["battery (AAA)"])))) < 5 && !have(template_string_$item(boozedrop_templateObject39 || (boozedrop_templateObject39 = boozedrop_taggedTemplateLiteral(["battery (lantern)"])))) || property_get("instant_savePowerSeed", false),
    do: () => {
      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(boozedrop_templateObject40 || (boozedrop_templateObject40 = boozedrop_taggedTemplateLiteral(["battery (AAA)"])))) >= 5) (0,external_kolmafia_namespaceObject.create)(template_string_$item(boozedrop_templateObject41 || (boozedrop_templateObject41 = boozedrop_taggedTemplateLiteral(["battery (lantern)"]))), 1);
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(boozedrop_templateObject42 || (boozedrop_templateObject42 = boozedrop_taggedTemplateLiteral(["battery (lantern)"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    name: "Pumpkin Juice",
    completed: () => have($effect(boozedrop_templateObject43 || (boozedrop_templateObject43 = boozedrop_taggedTemplateLiteral(["Juiced and Jacked"])))) || !have(template_string_$item(boozedrop_templateObject44 || (boozedrop_templateObject44 = boozedrop_taggedTemplateLiteral(["pumpkin"])))) && !have(template_string_$item(boozedrop_templateObject45 || (boozedrop_templateObject45 = boozedrop_taggedTemplateLiteral(["pumpkin juice"])))) || property_get("instant_savePumpkins", false),
    do: () => {
      if (!have(template_string_$item(boozedrop_templateObject46 || (boozedrop_templateObject46 = boozedrop_taggedTemplateLiteral(["pumpkin juice"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(boozedrop_templateObject47 || (boozedrop_templateObject47 = boozedrop_taggedTemplateLiteral(["pumpkin juice"]))), 1);
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(boozedrop_templateObject48 || (boozedrop_templateObject48 = boozedrop_taggedTemplateLiteral(["pumpkin juice"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    name: "Test",
    prepare: () => {
      var usefulEffects = [$effect(boozedrop_templateObject49 || (boozedrop_templateObject49 = boozedrop_taggedTemplateLiteral(["Blessing of the Bird"]))), $effect(boozedrop_templateObject50 || (boozedrop_templateObject50 = boozedrop_taggedTemplateLiteral(["Crunching Leaves"]))), $effect(boozedrop_templateObject51 || (boozedrop_templateObject51 = boozedrop_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), // $effect`Feeling Lost`,
      $effect(boozedrop_templateObject52 || (boozedrop_templateObject52 = boozedrop_taggedTemplateLiteral(["items.enh"]))), $effect(boozedrop_templateObject53 || (boozedrop_templateObject53 = boozedrop_taggedTemplateLiteral(["One Very Clear Eye"]))), $effect(boozedrop_templateObject54 || (boozedrop_templateObject54 = boozedrop_taggedTemplateLiteral(["Nearly All-Natural"]))), $effect(boozedrop_templateObject55 || (boozedrop_templateObject55 = boozedrop_taggedTemplateLiteral(["The Spirit of Taking"]))), $effect(boozedrop_templateObject56 || (boozedrop_templateObject56 = boozedrop_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), $effect(boozedrop_templateObject57 || (boozedrop_templateObject57 = boozedrop_taggedTemplateLiteral(["Steely-Eyed Squint"]))), $effect(boozedrop_templateObject58 || (boozedrop_templateObject58 = boozedrop_taggedTemplateLiteral(["Uncucumbered"])))];
      usefulEffects.forEach(ef => tryAcquiringEffect(ef, true));
      if (!have($effect(boozedrop_templateObject59 || (boozedrop_templateObject59 = boozedrop_taggedTemplateLiteral(["Infernal Thirst"])))) && have(template_string_$item(boozedrop_templateObject60 || (boozedrop_templateObject60 = boozedrop_taggedTemplateLiteral(["genie bottle"])))) && property_get("_genieWishesUsed") < 3 && !property_get("instant_saveWishes", false) && !forbiddenEffects.includes($effect(boozedrop_templateObject61 || (boozedrop_templateObject61 = boozedrop_taggedTemplateLiteral(["Infernal Thirst"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("genie effect infernal thirst");

      if (have(template_string_$familiar(boozedrop_templateObject62 || (boozedrop_templateObject62 = boozedrop_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && have(template_string_$item(boozedrop_templateObject63 || (boozedrop_templateObject63 = boozedrop_taggedTemplateLiteral(["li'l ninja costume"]))))) {
        (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(boozedrop_templateObject64 || (boozedrop_templateObject64 = boozedrop_taggedTemplateLiteral(["Trick-or-Treating Tot"]))));
        (0,external_kolmafia_namespaceObject.equip)($slot(boozedrop_templateObject65 || (boozedrop_templateObject65 = boozedrop_taggedTemplateLiteral(["familiar"]))), template_string_$item(boozedrop_templateObject66 || (boozedrop_templateObject66 = boozedrop_taggedTemplateLiteral(["li'l ninja costume"]))));
      }
    },
    completed: () => CommunityService.BoozeDrop.isDone(),
    do: () => {
...
var HotResQuest = {
  ...
  tasks: [{
    ...
    prepare: () => {
      if (!have(template_string_$item(hotres_templateObject || (hotres_templateObject = hotres_taggedTemplateLiteral(["yellow rocket"])))) && !have($effect(hotres_templateObject2 || (hotres_templateObject2 = hotres_taggedTemplateLiteral(["Everything Looks Yellow"]))))) (0,external_kolmafia_namespaceObject.buy)(template_string_$item(hotres_templateObject3 || (hotres_templateObject3 = hotres_taggedTemplateLiteral(["yellow rocket"]))), 1);
      if (have(template_string_$skill(hotres_templateObject4 || (hotres_templateObject4 = hotres_taggedTemplateLiteral(["Double-Fisted Skull Smashing"])))) && have(template_string_$item(hotres_templateObject5 || (hotres_templateObject5 = hotres_taggedTemplateLiteral(["industrial fire extinguisher"]))))) (0,external_kolmafia_namespaceObject.equip)($slot(hotres_templateObject6 || (hotres_templateObject6 = hotres_taggedTemplateLiteral(["offhand"]))), template_string_$item(hotres_templateObject7 || (hotres_templateObject7 = hotres_taggedTemplateLiteral(["industrial fire extinguisher"]))));
    },
    completed: () => monstersReminisced().includes($monster(hotres_templateObject8 || (hotres_templateObject8 = hotres_taggedTemplateLiteral(["factory worker (female)"])))) || !availableLocketMonsters().includes($monster(hotres_templateObject9 || (hotres_templateObject9 = hotres_taggedTemplateLiteral(["factory worker (female)"])))) || property_get("instant_saveLocketFactoryWorker", false),
    do: () => reminisce($monster(hotres_templateObject10 || (hotres_templateObject10 = hotres_taggedTemplateLiteral(["factory worker (female)"])))),
    outfit: {
      back: template_string_$item(hotres_templateObject11 || (hotres_templateObject11 = hotres_taggedTemplateLiteral(["vampyric cloake"]))),
      weapon: template_string_$item(hotres_templateObject12 || (hotres_templateObject12 = hotres_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
      familiar: template_string_$familiar(hotres_templateObject13 || (hotres_templateObject13 = hotres_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "Item Drop"
    },
    choices: {
      1387: 3
    },
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(hotres_templateObject14 || (hotres_templateObject14 = hotres_taggedTemplateLiteral(["Become a Cloud of Mist"])))).trySkill(template_string_$skill(hotres_templateObject15 || (hotres_templateObject15 = hotres_taggedTemplateLiteral(["Fire Extinguisher: Foam Yourself"])))).trySkill(template_string_$skill(hotres_templateObject16 || (hotres_templateObject16 = hotres_taggedTemplateLiteral(["Use the Force"])))).trySkill(template_string_$skill(hotres_templateObject17 || (hotres_templateObject17 = hotres_taggedTemplateLiteral(["Shocking Lick"])))).tryItem(template_string_$item(hotres_templateObject18 || (hotres_templateObject18 = hotres_taggedTemplateLiteral(["yellow rocket"])))).default()),
    limit: {
      tries: 1
    }
  }, {
...
var WeaponDamageQuest = {
  ...
  tasks: [{
    ...
    completed: () => have(template_string_$item(weapondamage_templateObject3 || (weapondamage_templateObject3 = weapondamage_taggedTemplateLiteral(["potion of potency"])))) || have($effect(weapondamage_templateObject4 || (weapondamage_templateObject4 = weapondamage_taggedTemplateLiteral(["Pronounced Potency"])))) || !have(template_string_$item(weapondamage_templateObject5 || (weapondamage_templateObject5 = weapondamage_taggedTemplateLiteral(["scrumptious reagent"])))),
    do: () => (0,external_kolmafia_namespaceObject.create)(template_string_$item(weapondamage_templateObject6 || (weapondamage_templateObject6 = weapondamage_taggedTemplateLiteral(["potion of potency"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    name: "Cargo Shorts",
    completed: () => property_get("_cargoPocketEmptied") || !have(template_string_$item(weapondamage_templateObject7 || (weapondamage_templateObject7 = weapondamage_taggedTemplateLiteral(["Cargo Cultist Shorts"])))) || property_get("instant_saveCargoShorts", false),
    do: () => {
    ...
    name: "Meteor Shower",
    completed: () => have($effect(weapondamage_templateObject8 || (weapondamage_templateObject8 = weapondamage_taggedTemplateLiteral(["Meteor Showered"])))) || !have(template_string_$item(weapondamage_templateObject9 || (weapondamage_templateObject9 = weapondamage_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))) || !have(template_string_$skill(weapondamage_templateObject10 || (weapondamage_templateObject10 = weapondamage_taggedTemplateLiteral(["Meteor Lore"])))) || property_get("_saberForceUses") >= 5,
    ...
    outfit: {
      ...
      familiar: template_string_$familiar(weapondamage_templateObject15 || (weapondamage_templateObject15 = weapondamage_taggedTemplateLiteral(["Cookbookbat"])))
    },
    choices: {
      1387: 3
    },
    ...
    name: "Test",
    prepare: () => {
      if (have(template_string_$item(weapondamage_templateObject16 || (weapondamage_templateObject16 = weapondamage_taggedTemplateLiteral(["SongBoom\u2122 BoomBox"]))))) setSong("These Fists Were Made for Punchin'");
      if (!have(template_string_$item(weapondamage_templateObject17 || (weapondamage_templateObject17 = weapondamage_taggedTemplateLiteral(["goofily-plumed helmet"]))))) (0,external_kolmafia_namespaceObject.buy)(template_string_$item(weapondamage_templateObject18 || (weapondamage_templateObject18 = weapondamage_taggedTemplateLiteral(["goofily-plumed helmet"]))), 1);
      if (have(template_string_$item(weapondamage_templateObject19 || (weapondamage_templateObject19 = weapondamage_taggedTemplateLiteral(["Ye Wizard's Shack snack voucher"]))))) (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(weapondamage_templateObject20 || (weapondamage_templateObject20 = weapondamage_taggedTemplateLiteral(["wasabi marble soda"]))));
      ...
      usefulEffects.forEach(ef => tryAcquiringEffect(ef, true));
      if (!have($effect(weapondamage_templateObject42 || (weapondamage_templateObject42 = weapondamage_taggedTemplateLiteral(["Outer Wolf\u2122"])))) && have(template_string_$item(weapondamage_templateObject43 || (weapondamage_templateObject43 = weapondamage_taggedTemplateLiteral(["genie bottle"])))) && property_get("_genieWishesUsed") < 3 && !property_get("instant_saveWishes", false) && !forbiddenEffects.includes($effect(weapondamage_templateObject44 || (weapondamage_templateObject44 = weapondamage_taggedTemplateLiteral(["Outer Wolf\u2122"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("genie effect outer wolf");
    },
    completed: () => CommunityService.WeaponDamage.isDone(),
    do: () => {
...
var SpellDamageQuest = {
  ...
  tasks: [{
    ...
    prepare: () => {
      ...
      while (advCost(CommunityServiceTests.SPELLTEST) > (0,external_kolmafia_namespaceObject.myAdventures)() && (0,external_kolmafia_namespaceObject.myInebriety)() < (0,external_kolmafia_namespaceObject.inebrietyLimit)() && wines.some(booze => have(booze))) {
        ...
        (0,external_kolmafia_namespaceObject.drink)(wines.filter(booze => have(booze))[0], 1);
      }
    },
    completed: () => CommunityService.SpellDamage.isDone(),
    do: () => {
...
var isGarden = x => utils_arrayContains(x, gardens);
...
function buildIotmList() {
  return [{
    ...
    thing: new Hardcoded(have(template_string_$item(sim_templateObject2 || (sim_templateObject2 = sim_taggedTemplateLiteral(["cosmic bowling ball"])))) || (0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(sim_templateObject3 || (sim_templateObject3 = sim_taggedTemplateLiteral(["cosmic bowling ball"])))) > 0 || property_get("cosmicBowlingBallReturnCombats", -1) >= 0, "Cosmic bowling ball"),
    why: "Leveling + banish"
  }, {
    thing: template_string_$familiar(sim_templateObject4 || (sim_templateObject4 = sim_taggedTemplateLiteral(["Cookbookbat"]))),
    why: "Turngen, stat tests"
  }, {
    thing: template_string_$item(sim_templateObject5 || (sim_templateObject5 = sim_taggedTemplateLiteral(["combat lover's locket"]))),
    why: "Summons for various tests",
    optional: true,
    recommended: true
  }, {
    thing: template_string_$item(sim_templateObject6 || (sim_templateObject6 = sim_taggedTemplateLiteral(["unbreakable umbrella"]))),
    why: "Various leveling and test improvements",
    optional: true,
    recommended: true
  }, {
    // eslint-disable-next-line libram/verify-constants
    thing: template_string_$item(sim_templateObject7 || (sim_templateObject7 = sim_taggedTemplateLiteral(["closed-circuit pay phone"]))),
    why: "Free fights, Non-combat, Item Drop",
    optional: true,
    recommended: true
  }, {
    thing: new Hardcoded(have(template_string_$item(sim_templateObject8 || (sim_templateObject8 = sim_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))) || (0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(sim_templateObject9 || (sim_templateObject9 = sim_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"])))) > 0 || property_get("stenchAirportAlways"), "Scaler Zone Access"),
...
function buildMiscList() {
  return [{
    ...
    thing: template_string_$skill(sim_templateObject52 || (sim_templateObject52 = sim_taggedTemplateLiteral(["Pride of the Puffin"]))),
    why: "Monster Level",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject53 || (sim_templateObject53 = sim_taggedTemplateLiteral(["Drescher's Annoying Noise"]))),
    why: "Monster Level",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject54 || (sim_templateObject54 = sim_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))),
    why: "Monster Level",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject55 || (sim_templateObject55 = sim_taggedTemplateLiteral(["Master Saucier"]))),
    why: "Spell Damage",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject56 || (sim_templateObject56 = sim_taggedTemplateLiteral(["Subtle and Quick to Anger"]))),
    why: "Spell Damage",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject57 || (sim_templateObject57 = sim_taggedTemplateLiteral(["Simmer"]))),
    why: "Spell Damage",
    optional: true,
    recommended: true
  }, {
    thing: template_string_$skill(sim_templateObject58 || (sim_templateObject58 = sim_taggedTemplateLiteral(["Always Never Not Guzzling"]))),
    why: "Item Drop",
    optional: true,
    recommended: true
  }, {
    thing: template_string_$skill(sim_templateObject59 || (sim_templateObject59 = sim_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))),
    why: "Item Drop",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject60 || (sim_templateObject60 = sim_taggedTemplateLiteral(["Mad Looting Skillz"]))),
    why: "Item Drop",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject61 || (sim_templateObject61 = sim_taggedTemplateLiteral(["Object Quasi-Permanence"]))),
    why: "Item Drop",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject62 || (sim_templateObject62 = sim_taggedTemplateLiteral(["Powers of Observatiogn"]))),
    why: "Item Drop",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject63 || (sim_templateObject63 = sim_taggedTemplateLiteral(["Bind Spice Ghost"]))),
    why: "Item Drop",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject64 || (sim_templateObject64 = sim_taggedTemplateLiteral(["Thief Among the Honorable"]))),
    why: "Item Drop",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject65 || (sim_templateObject65 = sim_taggedTemplateLiteral(["Natural Born Scrabbler"]))),
    why: "Item Drop",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject66 || (sim_templateObject66 = sim_taggedTemplateLiteral(["20/20 Vision"]))),
    why: "Item Drop",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject67 || (sim_templateObject67 = sim_taggedTemplateLiteral(["Carol of the Bulls"]))),
    why: "Weapon Damage",
    optional: true,
    recommended: true
  }, {
    thing: template_string_$skill(sim_templateObject68 || (sim_templateObject68 = sim_taggedTemplateLiteral(["Carol of the Hells"]))),
    why: "Spell Damage",
    optional: true,
    recommended: true
  }, {
    thing: template_string_$skill(sim_templateObject69 || (sim_templateObject69 = sim_taggedTemplateLiteral(["Song of Sauce"]))),
    why: "Spell Damage",
    optional: true,
    recommended: true
  }, {
    thing: template_string_$skill(sim_templateObject70 || (sim_templateObject70 = sim_taggedTemplateLiteral(["Song of the North"]))),
    why: "Weapon Damage",
    optional: true,
    recommended: true
  }, {
    thing: template_string_$skill(sim_templateObject71 || (sim_templateObject71 = sim_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))),
    why: "Weapon Damage",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject72 || (sim_templateObject72 = sim_taggedTemplateLiteral(["Scowl of the Auk"]))),
    why: "Weapon Damage",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject73 || (sim_templateObject73 = sim_taggedTemplateLiteral(["Rage of the Reindeer"]))),
    why: "Weapon Damage",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject74 || (sim_templateObject74 = sim_taggedTemplateLiteral(["Tenacity of the Snapper"]))),
    why: "Weapon Damage",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject75 || (sim_templateObject75 = sim_taggedTemplateLiteral(["Claws of the Walrus"]))),
    why: "Weapon Damage",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject76 || (sim_templateObject76 = sim_taggedTemplateLiteral(["Blessing of the War Snapper"]))),
    why: "Weapon Damage",
    optional: true
  }, {
    thing: template_string_$skill(sim_templateObject77 || (sim_templateObject77 = sim_taggedTemplateLiteral(["Evoke Eldritch Horror"]))),
    why: "Free Fight",
    optional: true,
    recommended: true
  }, {
    thing: template_string_$item(sim_templateObject78 || (sim_templateObject78 = sim_taggedTemplateLiteral(["Calzone of Legend"]))),
    why: "Turngen + Stat %"
  }, {
    thing: template_string_$item(sim_templateObject79 || (sim_templateObject79 = sim_taggedTemplateLiteral(["Deep Dish of Legend"]))),
    why: "Turngen + Stat %"
  }, {
    thing: template_string_$item(sim_templateObject80 || (sim_templateObject80 = sim_taggedTemplateLiteral(["Pizza of Legend"]))),
    why: "Turngen + Stat %"
  }, {
    thing: new Hardcoded(have(template_string_$item(sim_templateObject81 || (sim_templateObject81 = sim_taggedTemplateLiteral(["borrowed time"])))) || (0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(sim_templateObject82 || (sim_templateObject82 = sim_taggedTemplateLiteral(["borrowed time"])))) > 0 || have(template_string_$skill(sim_templateObject83 || (sim_templateObject83 = sim_taggedTemplateLiteral(["Summon Clip Art"])))), "borrowed time"),
    why: "Turngen"
  }, {
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = 7545);
