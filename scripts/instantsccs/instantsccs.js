...
var resources = [new Resource("instant_savePorquoise", "Do not autosell your porquoise"), new Resource("instant_saveEuclideanAngle", "Do not pull a non-Euclidean Angle"), new Resource("instant_saveAbstraction", "Do not pull an Abstraction: Category"), new Resource("instant_savePerfectFreeze", "Do not craft and drink a perfect drink"), new Resource("instant_saveBeesKnees", "Do not buy and drink Bee's Knees"), new Resource("instant_saveSockdollager", "Do not buy and drink a sockdollager"), new Resource("instant_saveFloundry", "Do not create a codpiece"), new Resource("instant_saveFortuneTeller", "Do not consult Zatara for the myst buff"), new Resource("instant_saveSnackVoucher", "Do not use your snack voucher", $effects(resources_templateObject || (resources_templateObject = resources_taggedTemplateLiteral(["Wasabi With You, Pisces in the Skyces"])))), new Resource("instant_saveClipArt", "Only summon borrowed time"), new Resource("instant_saveDeck", "Do not use any deck summons"), new Resource("instant_saveBarrelShrine", "Do not get the barrel shrine buff", [$effect(resources_templateObject2 || (resources_templateObject2 = resources_taggedTemplateLiteral(["Warlock, Warstock, and Warbarrel"])))]), new Resource("instant_saveWitchess", "Do not fight witchess monsters nor acquire Puzzle Champ", $effects(resources_templateObject3 || (resources_templateObject3 = resources_taggedTemplateLiteral(["Puzzle Champ"])))), new Resource("instant_saveTerminal", "Do not acquire items.enh and substats.enh", $effects(resources_templateObject4 || (resources_templateObject4 = resources_taggedTemplateLiteral(["items.enh, substats.enh"])))), new Resource("instant_saveCopDollars", "Do not acquire shoe gum with cop dollars", $effects(resources_templateObject5 || (resources_templateObject5 = resources_taggedTemplateLiteral(["Gummed Shoes"])))), new Resource("instant_saveKGBClicks", "Do not use any KGB clicks"), new Resource("instant_saveWishes", "Do not use any wishes", $effects(resources_templateObject6 || (resources_templateObject6 = resources_taggedTemplateLiteral(["Outer Wolf\u2122"])))), new Resource("instant_savePantogram", "Do not use your pantogram"), new Resource("instant_saveMummingTrunk", "Do not use your mumming trunk"), new Resource("instant_saveBodySpradium", "Do not chew the body spradium if we have it", $effects(resources_templateObject7 || (resources_templateObject7 = resources_taggedTemplateLiteral(["Boxing Day Glow"])))), new Resource("instant_saveDocBag", "Do not use Chest X-Rays"), new Resource("instant_savePillkeeper", "Do not acquire Hulkien, Rainbowolin and Fidoxene", $effects(resources_templateObject8 || (resources_templateObject8 = resources_taggedTemplateLiteral(["Hulkien, Rainbowolin, Fidoxene"])))), new Resource("instant_savePowerfulGlove", "Do not acquire Triple-Sized and Invisible Avatar", $effects(resources_templateObject9 || (resources_templateObject9 = resources_taggedTemplateLiteral(["Triple-Sized, Invisible Avatar"])))), new Resource("instant_saveCargoShorts", "Do not use a pull from your Cargo Shorts"), new Resource("instant_savePowerSeed", "Do not use any batteries", $effects(resources_templateObject10 || (resources_templateObject10 = resources_taggedTemplateLiteral(["AAA-Charged"])))), new Resource("instant_saveBackups", "Do not use any backups"), new Resource("instant_saveMayday", "Do not use your Mayday survival package")];
...
function sendAutumnaton() {
  if (have(template_string_$item(leveling_templateObject32 || (leveling_templateObject32 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");
}
...
var LevelingQuest = {
  ...
  tasks: [{
    ...
    completed: () => (0,external_kolmafia_namespaceObject.mySoulsauce)() < 5 || (0,external_kolmafia_namespaceObject.myMp)() > (0,external_kolmafia_namespaceObject.myMaxmp)() - 15 || !have(template_string_$skill(leveling_templateObject59 || (leveling_templateObject59 = leveling_taggedTemplateLiteral(["Soul Food"])))),
    do: () => {
    ...
    completed: () => have($effect(_templateObject62 || (_templateObject62 = leveling_taggedTemplateLiteral(["Inscrutable Gaze"])))) || !have(template_string_$skill(_templateObject63 || (_templateObject63 = leveling_taggedTemplateLiteral(["Inscrutable Gaze"])))),
    ...
    completed: () => have(template_string_$item(_templateObject65 || (_templateObject65 = leveling_taggedTemplateLiteral(["Deep Dish of Legend"])))) || have($effect(_templateObject66 || (_templateObject66 = leveling_taggedTemplateLiteral(["In the Depths"])))) || property_get("_roninStoragePulls").split(",").includes((0,external_kolmafia_namespaceObject.toInt)(template_string_$item(_templateObject67 || (_templateObject67 = leveling_taggedTemplateLiteral(["Deep Dish of Legend"])))).toString()),
    do: () => (0,external_kolmafia_namespaceObject.takeStorage)(template_string_$item(_templateObject68 || (_templateObject68 = leveling_taggedTemplateLiteral(["Deep Dish of Legend"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    name: "Pull Calzone of Legend",
    completed: () => have(template_string_$item(_templateObject69 || (_templateObject69 = leveling_taggedTemplateLiteral(["Calzone of Legend"])))) || have($effect(_templateObject70 || (_templateObject70 = leveling_taggedTemplateLiteral(["In the 'zone zone!"])))) || property_get("_roninStoragePulls").split(",").includes((0,external_kolmafia_namespaceObject.toInt)(template_string_$item(_templateObject71 || (_templateObject71 = leveling_taggedTemplateLiteral(["Calzone of Legend"])))).toString()),
    do: () => (0,external_kolmafia_namespaceObject.takeStorage)(template_string_$item(_templateObject72 || (_templateObject72 = leveling_taggedTemplateLiteral(["Calzone of Legend"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    name: "Pull Pizza of Legend",
    completed: () => have(template_string_$item(_templateObject73 || (_templateObject73 = leveling_taggedTemplateLiteral(["Pizza of Legend"])))) || have($effect(_templateObject74 || (_templateObject74 = leveling_taggedTemplateLiteral(["Endless Drool"])))) || property_get("_roninStoragePulls").split(",").includes((0,external_kolmafia_namespaceObject.toInt)(template_string_$item(_templateObject75 || (_templateObject75 = leveling_taggedTemplateLiteral(["Pizza of Legend"])))).toString()),
    do: () => (0,external_kolmafia_namespaceObject.takeStorage)(template_string_$item(_templateObject76 || (_templateObject76 = leveling_taggedTemplateLiteral(["Pizza of Legend"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    ...
    do: () => {
      (0,external_kolmafia_namespaceObject.takeStorage)(template_string_$item(_templateObject77 || (_templateObject77 = leveling_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"]))), 1);
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject78 || (_templateObject78 = leveling_taggedTemplateLiteral(["one-day ticket to Dinseylandfill"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    completed: () => property_get("_roninStoragePulls").split(",").length >= 5 || property_get("_roninStoragePulls").split(",").includes((0,external_kolmafia_namespaceObject.toInt)(template_string_$item(_templateObject79 || (_templateObject79 = leveling_taggedTemplateLiteral(["non-Euclidean angle"])))).toString()) || have(template_string_$item(_templateObject80 || (_templateObject80 = leveling_taggedTemplateLiteral(["non-Euclidean angle"])))) || have($effect(_templateObject81 || (_templateObject81 = leveling_taggedTemplateLiteral(["Different Way of Seeing Things"])))) || (0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(_templateObject82 || (_templateObject82 = leveling_taggedTemplateLiteral(["non-Euclidean angle"])))) === 0 || property_get("instant_saveEuclideanAngle", false),
    do: () => {
      (0,external_kolmafia_namespaceObject.takeStorage)(template_string_$item(_templateObject83 || (_templateObject83 = leveling_taggedTemplateLiteral(["non-Euclidean angle"]))), 1);
      (0,external_kolmafia_namespaceObject.chew)(template_string_$item(_templateObject84 || (_templateObject84 = leveling_taggedTemplateLiteral(["non-Euclidean angle"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    completed: () => property_get("_roninStoragePulls").split(",").length >= 5 || property_get("_roninStoragePulls").split(",").includes((0,external_kolmafia_namespaceObject.toInt)(template_string_$item(_templateObject85 || (_templateObject85 = leveling_taggedTemplateLiteral(["abstraction: category"])))).toString()) || have(template_string_$item(_templateObject86 || (_templateObject86 = leveling_taggedTemplateLiteral(["abstraction: category"])))) || have($effect(_templateObject87 || (_templateObject87 = leveling_taggedTemplateLiteral(["Category"])))) || (0,external_kolmafia_namespaceObject.storageAmount)(template_string_$item(_templateObject88 || (_templateObject88 = leveling_taggedTemplateLiteral(["abstraction: category"])))) === 0 || property_get("instant_saveAbstraction", false),
    do: () => {
      (0,external_kolmafia_namespaceObject.takeStorage)(template_string_$item(_templateObject89 || (_templateObject89 = leveling_taggedTemplateLiteral(["abstraction: category"]))), 1);
      (0,external_kolmafia_namespaceObject.chew)(template_string_$item(_templateObject90 || (_templateObject90 = leveling_taggedTemplateLiteral(["abstraction: category"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    completed: () => !have(template_string_$item(_templateObject91 || (_templateObject91 = leveling_taggedTemplateLiteral(["a ten-percent bonus"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject92 || (_templateObject92 = leveling_taggedTemplateLiteral(["a ten-percent bonus"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    name: "Bastille",
    completed: () => property_get("_bastilleGames") > 0 || !have(template_string_$item(_templateObject93 || (_templateObject93 = leveling_taggedTemplateLiteral(["Bastille Battalion control rig"])))),
    ...
    prepare: () => {
      if (have(template_string_$item(_templateObject94 || (_templateObject94 = leveling_taggedTemplateLiteral(["Newbiesport\u2122 tent"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject95 || (_templateObject95 = leveling_taggedTemplateLiteral(["Newbiesport\u2122 tent"]))));
    },
    do: () => {
    ...
    name: "Alice Army",
    completed: () => property_get("grimoire3Summons") > 0 || !have(template_string_$skill(_templateObject96 || (_templateObject96 = leveling_taggedTemplateLiteral(["Summon Alice's Army Cards"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject97 || (_templateObject97 = leveling_taggedTemplateLiteral(["Summon Alice's Army Cards"])))),
    limit: {
      tries: 1
    }
  }, {
    name: "Confiscator's Grimoire",
    completed: () => property_get("_grimoireConfiscatorSummons") > 0 || !have(template_string_$skill(_templateObject98 || (_templateObject98 = leveling_taggedTemplateLiteral(["Summon Confiscated Things"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject99 || (_templateObject99 = leveling_taggedTemplateLiteral(["Summon Confiscated Things"])))),
    limit: {
      tries: 1
    }
  }, {
    ...
    do: () => (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject100 || (_templateObject100 = leveling_taggedTemplateLiteral(["Calzone of Legend"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    ...
    do: () => (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject101 || (_templateObject101 = leveling_taggedTemplateLiteral(["Deep Dish of Legend"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    name: "Cast Prevent Scurvy",
    completed: () => !have(template_string_$skill(_templateObject102 || (_templateObject102 = leveling_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"])))) || property_get("_preventScurvy"),
    prepare: () => (0,external_kolmafia_namespaceObject.restoreMp)((0,external_kolmafia_namespaceObject.mpCost)(template_string_$skill(_templateObject103 || (_templateObject103 = leveling_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject104 || (_templateObject104 = leveling_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"])))),
    limit: {
      tries: 1
    }
  }, {
    name: "Cast Perfect Freeze",
    completed: () => !have(template_string_$skill(_templateObject105 || (_templateObject105 = leveling_taggedTemplateLiteral(["Perfect Freeze"])))) || property_get("_perfectFreezeUsed") || property_get("instant_savePerfectFreeze", false),
    prepare: () => (0,external_kolmafia_namespaceObject.restoreMp)((0,external_kolmafia_namespaceObject.mpCost)(template_string_$skill(_templateObject106 || (_templateObject106 = leveling_taggedTemplateLiteral(["Perfect Freeze"]))))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject107 || (_templateObject107 = leveling_taggedTemplateLiteral(["Perfect Freeze"])))),
    limit: {
      tries: 1
    }
  }, {
    name: "Drink Perfect Drink",
    completed: () => (0,external_kolmafia_namespaceObject.myInebriety)() >= 3 || !have(template_string_$item(_templateObject108 || (_templateObject108 = leveling_taggedTemplateLiteral(["perfect ice cube"])))) || !baseBoozes.some(it => have(it)) || property_get("instant_savePerfectFreeze", false),
    do: () => {
      tryAcquiringEffect($effect(_templateObject109 || (_templateObject109 = leveling_taggedTemplateLiteral(["Ode to Booze"]))));
      var baseBooze = baseBoozes.filter(it => have(it))[0];
      var booze;

      switch (baseBooze) {
        case template_string_$item(_templateObject110 || (_templateObject110 = leveling_taggedTemplateLiteral(["bottle of vodka"]))):
          booze = template_string_$item(_templateObject111 || (_templateObject111 = leveling_taggedTemplateLiteral(["perfect cosmopolitan"])));
          break;

        case template_string_$item(_templateObject112 || (_templateObject112 = leveling_taggedTemplateLiteral(["bottle of whiskey"]))):
          booze = template_string_$item(_templateObject113 || (_templateObject113 = leveling_taggedTemplateLiteral(["perfect old-fashioned"])));
          break;

        case template_string_$item(_templateObject114 || (_templateObject114 = leveling_taggedTemplateLiteral(["boxed wine"]))):
          booze = template_string_$item(_templateObject115 || (_templateObject115 = leveling_taggedTemplateLiteral(["perfect mimosa"])));
          break;

        case template_string_$item(_templateObject116 || (_templateObject116 = leveling_taggedTemplateLiteral(["bottle of rum"]))):
          booze = template_string_$item(_templateObject117 || (_templateObject117 = leveling_taggedTemplateLiteral(["perfect dark and stormy"])));
          break;

        case template_string_$item(_templateObject118 || (_templateObject118 = leveling_taggedTemplateLiteral(["bottle of tequila"]))):
          booze = template_string_$item(_templateObject119 || (_templateObject119 = leveling_taggedTemplateLiteral(["perfect paloma"])));
          break;

        case template_string_$item(_templateObject120 || (_templateObject120 = leveling_taggedTemplateLiteral(["bottle of gin"]))):
          booze = template_string_$item(_templateObject121 || (_templateObject121 = leveling_taggedTemplateLiteral(["perfect negroni"])));
          break;
    ...
    completed: () => have($effect(_templateObject122 || (_templateObject122 = leveling_taggedTemplateLiteral(["Glittering Eyelashes"])))),
    do: () => ensureEffect($effect(_templateObject123 || (_templateObject123 = leveling_taggedTemplateLiteral(["Glittering Eyelashes"]))))
  }, {
    name: "Use Ointment of the Occult",
    completed: () => have($effect(_templateObject124 || (_templateObject124 = leveling_taggedTemplateLiteral(["Mystically Oiled"])))),
    do: () => {
      if (!have(template_string_$item(_templateObject125 || (_templateObject125 = leveling_taggedTemplateLiteral(["ointment of the occult"]))))) {
        if (property_get("reagentSummons") === 0) (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject126 || (_templateObject126 = leveling_taggedTemplateLiteral(["Advanced Saucecrafting"]))), 1);
        (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject127 || (_templateObject127 = leveling_taggedTemplateLiteral(["ointment of the occult"]))), 1);
      }

      ensureEffect($effect(_templateObject128 || (_templateObject128 = leveling_taggedTemplateLiteral(["Mystically Oiled"]))));
    }
  }, {
    name: "Use Oil of Expertise",
    completed: () => !have(template_string_$item(_templateObject129 || (_templateObject129 = leveling_taggedTemplateLiteral(["cherry"])))) && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject130 || (_templateObject130 = leveling_taggedTemplateLiteral(["oil of expertise"])))) <= 1 || have($effect(_templateObject131 || (_templateObject131 = leveling_taggedTemplateLiteral(["Expert Oiliness"])))),
    do: () => {
      if (!have(template_string_$item(_templateObject132 || (_templateObject132 = leveling_taggedTemplateLiteral(["oil of expertise"]))))) {
        ...
        (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject134 || (_templateObject134 = leveling_taggedTemplateLiteral(["oil of expertise"]))), 1);
      }

      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject135 || (_templateObject135 = leveling_taggedTemplateLiteral(["oil of expertise"])))) > 1) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject136 || (_templateObject136 = leveling_taggedTemplateLiteral(["oil of expertise"]))), (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject137 || (_templateObject137 = leveling_taggedTemplateLiteral(["oil of expertise"])))) - 1);
      if (have(template_string_$item(_templateObject138 || (_templateObject138 = leveling_taggedTemplateLiteral(["cherry"])))) && have($effect(_templateObject139 || (_templateObject139 = leveling_taggedTemplateLiteral(["Expert Oiliness"]))))) (0,external_kolmafia_namespaceObject.putCloset)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject140 || (_templateObject140 = leveling_taggedTemplateLiteral(["cherry"])))), template_string_$item(_templateObject141 || (_templateObject141 = leveling_taggedTemplateLiteral(["cherry"]))));
    },
    limit: {
      tries: 1
    }
    ...
    ready: () => have($effect(_templateObject142 || (_templateObject142 = leveling_taggedTemplateLiteral(["Everything Looks Blue"])))) && (0,external_kolmafia_namespaceObject.myMeat)() >= 1000,
    completed: () => have(template_string_$item(_templateObject143 || (_templateObject143 = leveling_taggedTemplateLiteral(["oversized sparkler"])))),
    do: () => (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject144 || (_templateObject144 = leveling_taggedTemplateLiteral(["oversized sparkler"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    name: "Eat Pizza",
    ready: () => have($effect(_templateObject145 || (_templateObject145 = leveling_taggedTemplateLiteral(["Ready to Eat"])))),
    // only eat this after we red rocket
    completed: () => property_get("pizzaOfLegendEaten"),
    do: () => (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject146 || (_templateObject146 = leveling_taggedTemplateLiteral(["Pizza of Legend"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    ...
    completed: () => (0,external_kolmafia_namespaceObject.myInebriety)() >= (0,external_kolmafia_namespaceObject.inebrietyLimit)() || !have(template_string_$item(_templateObject147 || (_templateObject147 = leveling_taggedTemplateLiteral(["astral six-pack"])))) && !have(template_string_$item(_templateObject148 || (_templateObject148 = leveling_taggedTemplateLiteral(["astral pilsner"])))),
    prepare: () => tryAcquiringEffect($effect(_templateObject149 || (_templateObject149 = leveling_taggedTemplateLiteral(["Ode to Booze"])))),
    do: () => {
      if (have(template_string_$item(_templateObject150 || (_templateObject150 = leveling_taggedTemplateLiteral(["astral six-pack"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject151 || (_templateObject151 = leveling_taggedTemplateLiteral(["astral six-pack"]))), 1);
      (0,external_kolmafia_namespaceObject.drink)(template_string_$item(_templateObject152 || (_templateObject152 = leveling_taggedTemplateLiteral(["astral pilsner"]))), 1);
    },
    post: () => {
      if (!have(template_string_$item(_templateObject153 || (_templateObject153 = leveling_taggedTemplateLiteral(["astral six-pack"])))) && !have(template_string_$item(_templateObject154 || (_templateObject154 = leveling_taggedTemplateLiteral(["astral pilsner"]))))) uneffect($effect(_templateObject155 || (_templateObject155 = leveling_taggedTemplateLiteral(["Ode to Booze"]))));
    },
    limit: {
      tries: 6
    }
    ...
    completed: () => !have(template_string_$item(_templateObject156 || (_templateObject156 = leveling_taggedTemplateLiteral(["magical sausage"])))) && !have(template_string_$item(_templateObject157 || (_templateObject157 = leveling_taggedTemplateLiteral(["magical sausage casing"])))) || (0,external_kolmafia_namespaceObject.myMeat)() <= 3000 || property_get("_sausagesMade") >= 3,
    do: () => {
      if (have(template_string_$item(_templateObject158 || (_templateObject158 = leveling_taggedTemplateLiteral(["magical sausage casing"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject159 || (_templateObject159 = leveling_taggedTemplateLiteral(["magical sausage"]))), 1);
      (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject160 || (_templateObject160 = leveling_taggedTemplateLiteral(["magical sausage"]))), (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject161 || (_templateObject161 = leveling_taggedTemplateLiteral(["magical sausage"])))));
    },
    post: () => (0,external_kolmafia_namespaceObject.autosell)(template_string_$item(_templateObject162 || (_templateObject162 = leveling_taggedTemplateLiteral(["meat stack"]))), (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject163 || (_templateObject163 = leveling_taggedTemplateLiteral(["meat stack"]))))),
    limit: {
      tries: 23
    }
  }, {
    name: "BoomBox Meat",
    ready: () => have(template_string_$item(_templateObject164 || (_templateObject164 = leveling_taggedTemplateLiteral(["Punching Potion"])))),
    completed: () => song() === "Total Eclipse of Your Meat" || !have(template_string_$item(_templateObject165 || (_templateObject165 = leveling_taggedTemplateLiteral(["SongBoom\u2122 BoomBox"])))),
    ...
    prepare: () => {
      ...
      if (!have($effect(_templateObject166 || (_templateObject166 = leveling_taggedTemplateLiteral(["Everything Looks Red"])))) && !have(template_string_$item(_templateObject167 || (_templateObject167 = leveling_taggedTemplateLiteral(["red rocket"]))))) {
        if ((0,external_kolmafia_namespaceObject.myMeat)() < 250) throw new Error("Insufficient Meat to purchase red rocket!");
        (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject168 || (_templateObject168 = leveling_taggedTemplateLiteral(["red rocket"]))), 1);
      }
    ...
    completed: () => have($effect(_templateObject172 || (_templateObject172 = leveling_taggedTemplateLiteral(["Everything Looks Blue"])))),
    do: powerlevelingLocation(),
    // if your powerleveling location is the NEP you don't immediately get the MP regen
    combat: new CombatStrategy().macro(combat_Macro.tryItem(template_string_$item(_templateObject173 || (_templateObject173 = leveling_taggedTemplateLiteral(["red rocket"])))).tryItem(template_string_$item(_templateObject174 || (_templateObject174 = leveling_taggedTemplateLiteral(["blue rocket"])))).default()),
    outfit: {
    ...
    outfit: {
      offhand: template_string_$item(_templateObject181 || (_templateObject181 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject182 || (_templateObject182 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject183 || (_templateObject183 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    ...
    // eslint-disable-next-line libram/verify-constants
    completed: () => property_get("_shadowAffinityToday", false) || !have(template_string_$item(_templateObject184 || (_templateObject184 = leveling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    do: () => // eslint-disable-next-line libram/verify-constants
    (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject185 || (_templateObject185 = leveling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    choices: {
      1497: 2,
      1498: 6
    },
    ...
    have(template_string_$item(_templateObject186 || (_templateObject186 = leveling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || property_get("_shadowRiftCombats", 0) >= 12 || // eslint-disable-next-line libram/verify-constants
    !have(template_string_$item(_templateObject187 || (_templateObject187 = leveling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    // eslint-disable-next-line libram/verify-constants
    do: () => {
      var target = property_get("rufusQuestTarget", ""); // eslint-disable-next-line libram/verify-constants

      if (have($effect(_templateObject188 || (_templateObject188 = leveling_taggedTemplateLiteral(["Shadow Affinity"]))))) {
    ...
    outfit: {
      ...
      familiar: template_string_$familiar(_templateObject191 || (_templateObject191 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    choices: {
      1498: 1
    ...
    do: $location(_templateObject193 || (_templateObject193 = leveling_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      offhand: template_string_$item(_templateObject194 || (_templateObject194 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject195 || (_templateObject195 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject196 || (_templateObject196 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 10
    ...
    do: powerlevelingLocation(),
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject197 || (_templateObject197 = leveling_taggedTemplateLiteral(["Snokebomb"])))).abort()),
    outfit: {
    ...
    completed: () => {
      ...
      return !have(template_string_$item(_templateObject201 || (_templateObject201 = leveling_taggedTemplateLiteral(["backup camera"])))) || !freeFightMonsters.includes((_get2 = property_get("lastCopyableMonster")) !== null && _get2 !== void 0 ? _get2 : $monster.none) || property_get("_backUpUses") >= 11 || property_get("instant_saveBackups", false);
    },
    do: $location(_templateObject202 || (_templateObject202 = leveling_taggedTemplateLiteral(["The Dire Warren"]))),
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject203 || (_templateObject203 = leveling_taggedTemplateLiteral(["Back-Up to your Last Enemy"])))).default()),
    outfit: {
      back: template_string_$item(_templateObject204 || (_templateObject204 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      ...
      acc3: template_string_$item(_templateObject207 || (_templateObject207 = leveling_taggedTemplateLiteral(["backup camera"]))),
    ...
    completed: () => getKramcoWandererChance() < 1.0 || !have(template_string_$item(_templateObject209 || (_templateObject209 = leveling_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))),
    do: $location(_templateObject210 || (_templateObject210 = leveling_taggedTemplateLiteral(["Noob Cave"]))),
    outfit: {
      back: template_string_$item(_templateObject211 || (_templateObject211 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject212 || (_templateObject212 = leveling_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))),
    ...
    name: "Red Skeleton",
    ready: () => !have($effect(_templateObject215 || (_templateObject215 = leveling_taggedTemplateLiteral(["Everything Looks Yellow"])))),
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));

      if (!have(template_string_$item(_templateObject216 || (_templateObject216 = leveling_taggedTemplateLiteral(["yellow rocket"]))))) {
        if ((0,external_kolmafia_namespaceObject.myMeat)() < 250) throw new Error("Insufficient Meat to purchase yellow rocket!");
        (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject217 || (_templateObject217 = leveling_taggedTemplateLiteral(["yellow rocket"]))), 1);
      }

      unbreakableUmbrella();
    },
    completed: () => monstersReminisced().includes($monster(_templateObject218 || (_templateObject218 = leveling_taggedTemplateLiteral(["red skeleton"])))) || !availableLocketMonsters().includes($monster(_templateObject219 || (_templateObject219 = leveling_taggedTemplateLiteral(["red skeleton"])))),
    do: () => reminisce($monster(_templateObject220 || (_templateObject220 = leveling_taggedTemplateLiteral(["red skeleton"])))),
    combat: new CombatStrategy().macro(combat_Macro.tryItem(template_string_$item(_templateObject221 || (_templateObject221 = leveling_taggedTemplateLiteral(["yellow rocket"])))).abort()),
    outfit: {
    ...
    post: () => {
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject226 || (_templateObject226 = leveling_taggedTemplateLiteral(["red box"]))), 1);
      sendAutumnaton();
      sellMiscellaneousItems();
    },
    limit: {
    ...
    prepare: () => {
      ...
      unbreakableUmbrella();
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
      tryAcquiringEffect($effect(_templateObject227 || (_templateObject227 = leveling_taggedTemplateLiteral(["Comic Violence"]))));
    },
    ...
    combat: new CombatStrategy().macro(combat_Macro.if_($monster(_templateObject228 || (_templateObject228 = leveling_taggedTemplateLiteral(["LOV Enforcer"]))), combat_Macro.attack().repeat()).if_($monster(_templateObject229 || (_templateObject229 = leveling_taggedTemplateLiteral(["LOV Engineer"]))), combat_Macro["default"]()).if_($monster(_templateObject230 || (_templateObject230 = leveling_taggedTemplateLiteral(["LOV Equivocator"]))), combat_Macro["default"]())),
    outfit: {
    ...
    post: () => {
      if (have($effect(_templateObject234 || (_templateObject234 = leveling_taggedTemplateLiteral(["Beaten Up"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("hottub");
      if (have(template_string_$item(_templateObject235 || (_templateObject235 = leveling_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject236 || (_templateObject236 = leveling_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"]))), 1);
      sendAutumnaton();
      sellMiscellaneousItems();
    }
  }, {
    ...
    do: $location(_templateObject237 || (_templateObject237 = leveling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
    ...
    completed: () => property_get("_godLobsterFights") >= 3 || !have(template_string_$familiar(_templateObject242 || (_templateObject242 = leveling_taggedTemplateLiteral(["God Lobster"])))),
    do: () => (0,external_kolmafia_namespaceObject.visitUrl)("main.php?fightgodlobster=1"),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    choices: {
      1310: () => have(template_string_$item(_templateObject243 || (_templateObject243 = leveling_taggedTemplateLiteral(["God Lobster's Ring"])))) ? 2 : 3
    },
    ...
    outfit: {
      ...
      offhand: template_string_$item(_templateObject245 || (_templateObject245 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject246 || (_templateObject246 = leveling_taggedTemplateLiteral(["codpiece"]))),
      famequip: template_string_$items(_templateObject247 || (_templateObject247 = leveling_taggedTemplateLiteral(["God Lobster's Ring, God Lobster's Scepter"]))),
      familiar: template_string_$familiar(_templateObject248 || (_templateObject248 = leveling_taggedTemplateLiteral(["God Lobster"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    acquire: [{
      item: template_string_$item(_templateObject249 || (_templateObject249 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }],
    limit: {
      tries: 3
    },
    ...
    completed: () => property_get("_eldritchHorrorEvoked") || !have(template_string_$skill(_templateObject250 || (_templateObject250 = leveling_taggedTemplateLiteral(["Evoke Eldritch Horror"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject251 || (_templateObject251 = leveling_taggedTemplateLiteral(["Evoke Eldritch Horror"])))),
    post: () => {
    ...
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      back: template_string_$item(_templateObject253 || (_templateObject253 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject254 || (_templateObject254 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject255 || (_templateObject255 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject256 || (_templateObject256 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 1
    ...
    do: () => fightPiece($monster(_templateObject257 || (_templateObject257 = leveling_taggedTemplateLiteral(["Witchess Bishop"])))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      back: template_string_$item(_templateObject258 || (_templateObject258 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      offhand: template_string_$item(_templateObject259 || (_templateObject259 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject260 || (_templateObject260 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject261 || (_templateObject261 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    post: () => {
      sendAutumnaton();
    ...
    completed: () => property_get("_machineTunnelsAdv") >= 5 || !have(template_string_$familiar(_templateObject262 || (_templateObject262 = leveling_taggedTemplateLiteral(["Machine Elf"])))),
    do: () => (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject263 || (_templateObject263 = leveling_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), -1),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      back: template_string_$item(_templateObject264 || (_templateObject264 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
      ...
      familiar: template_string_$familiar(_templateObject267 || (_templateObject267 = leveling_taggedTemplateLiteral(["Machine Elf"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 5
    ...
    name: "Powerlevel",
    completed: () => (0,external_kolmafia_namespaceObject.myBasestat)(template_string_$stat(_templateObject268 || (_templateObject268 = leveling_taggedTemplateLiteral(["Mysticality"])))) >= 175 && ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject269 || (_templateObject269 = leveling_taggedTemplateLiteral(["Yeast of Boris"])))) >= 3 && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject270 || (_templateObject270 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 3 && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject271 || (_templateObject271 = leveling_taggedTemplateLiteral(["St. Sneaky Pete's Whey"])))) >= 6 || craftedCBBFoods.some(it => have((0,external_kolmafia_namespaceObject.effectModifier)(it, "effect")))) && (powerlevelingLocation() !== $location(_templateObject272 || (_templateObject272 = leveling_taggedTemplateLiteral(["The Neverending Party"]))) || property_get("_neverendingPartyFreeTurns") >= 10),
    do: powerlevelingLocation(),
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));
      unbreakableUmbrella();
    ...
    outfit: {
      ...
      familiar: template_string_$familiar(_templateObject276 || (_templateObject276 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 60
    ...
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject277 || (_templateObject277 = leveling_taggedTemplateLiteral(["Bowl Sideways"])))).default()),
    post: () => {
      if (have(template_string_$item(_templateObject278 || (_templateObject278 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))))) (0,external_kolmafia_namespaceObject.chew)(template_string_$item(_templateObject279 || (_templateObject279 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))), 1);
      sendAutumnaton();
      sellMiscellaneousItems();
    }
  }, {
    name: "Acquire Wad of Dough",
    completed: () => have(template_string_$item(_templateObject280 || (_templateObject280 = leveling_taggedTemplateLiteral(["wad of dough"])))),
    do: () => {
      if ((0,external_kolmafia_namespaceObject.myMeat)() < 100) throw new Error("Insufficient Meat to purchase all-purpose flower!");
      if (!have(template_string_$item(_templateObject281 || (_templateObject281 = leveling_taggedTemplateLiteral(["all-purpose flower"]))))) (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject282 || (_templateObject282 = leveling_taggedTemplateLiteral(["all-purpose flower"]))), 1);
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject283 || (_templateObject283 = leveling_taggedTemplateLiteral(["all-purpose flower"]))), 1);
    },
    post: () => {
      if (!have(template_string_$item(_templateObject284 || (_templateObject284 = leveling_taggedTemplateLiteral(["flat dough"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject285 || (_templateObject285 = leveling_taggedTemplateLiteral(["wad of dough"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    after: ["Powerlevel"],
    completed: () => craftedCBBFoods.every(it => have((0,external_kolmafia_namespaceObject.effectModifier)(it, "effect"))),
    do: () => {
      ...
      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject286 || (_templateObject286 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 4 && !have($effect(_templateObject287 || (_templateObject287 = leveling_taggedTemplateLiteral(["Pretty Delicious"]))))) {
        if (!have(template_string_$item(_templateObject288 || (_templateObject288 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject289 || (_templateObject289 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
        (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject290 || (_templateObject290 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
      }
    },
    limit: {
      tries: 1
    ...
    after: ["Powerlevel"],
    completed: () => have($effect(_templateObject291 || (_templateObject291 = leveling_taggedTemplateLiteral(["On the Trolley"])))) || property_get("instant_saveBeesKnees", false),
    do: () => {
      if ((0,external_kolmafia_namespaceObject.myMeat)() < 500) throw new Error("Insufficient Meat to purchase Bee's Knees!");
      tryAcquiringEffect($effect(_templateObject292 || (_templateObject292 = leveling_taggedTemplateLiteral(["Ode to Booze"]))));
    ...
    prepare: () => {
      ...
      garbageShirt();
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
      tryAcquiringEffect($effect(_templateObject293 || (_templateObject293 = leveling_taggedTemplateLiteral(["Favored by Lyle"]))));
      tryAcquiringEffect($effect(_templateObject294 || (_templateObject294 = leveling_taggedTemplateLiteral(["Starry-Eyed"]))));
      (0,external_kolmafia_namespaceObject.restoreMp)(50);
    },
    completed: () => monstersReminisced().includes($monster(_templateObject295 || (_templateObject295 = leveling_taggedTemplateLiteral(["Witchess King"])))) || !availableLocketMonsters().includes($monster(_templateObject296 || (_templateObject296 = leveling_taggedTemplateLiteral(["Witchess King"])))),
    do: () => reminisce($monster(_templateObject297 || (_templateObject297 = leveling_taggedTemplateLiteral(["Witchess King"])))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      ...
      familiar: template_string_$familiar(_templateObject301 || (_templateObject301 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    post: () => {
      sendAutumnaton();
    ...
    completed: () => (property_get("_shatteringPunchUsed") >= 3 || !have(template_string_$skill(_templateObject306 || (_templateObject306 = leveling_taggedTemplateLiteral(["Shattering Punch"]))))) && (property_get("_gingerbreadMobHitUsed") || !have(template_string_$skill(_templateObject307 || (_templateObject307 = leveling_taggedTemplateLiteral(["Gingerbread Mob Hit"]))))) && have($effect(_templateObject308 || (_templateObject308 = leveling_taggedTemplateLiteral(["Pretty Delicious"])))) && (have($effect(_templateObject309 || (_templateObject309 = leveling_taggedTemplateLiteral(["Awfully Wily"])))) || (0,external_kolmafia_namespaceObject.myBasestat)(template_string_$stat(_templateObject310 || (_templateObject310 = leveling_taggedTemplateLiteral(["Mysticality"])))) >= 190),
    do: powerlevelingLocation(),
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject311 || (_templateObject311 = leveling_taggedTemplateLiteral(["Feel Pride"])))).trySkill(template_string_$skill(_templateObject312 || (_templateObject312 = leveling_taggedTemplateLiteral(["Chest X-Ray"])))).trySkill(template_string_$skill(_templateObject313 || (_templateObject313 = leveling_taggedTemplateLiteral(["Shattering Punch"])))).trySkill(template_string_$skill(_templateObject314 || (_templateObject314 = leveling_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill(template_string_$skill(_templateObject315 || (_templateObject315 = leveling_taggedTemplateLiteral(["Bowl Sideways"])))).default()),
    choices: {
      1094: 5,
      1115: 6,
      1322: 2,
    ...
    post: () => {
      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject316 || (_templateObject316 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 4 && !have($effect(_templateObject317 || (_templateObject317 = leveling_taggedTemplateLiteral(["Pretty Delicious"]))))) {
        if (!have(template_string_$item(_templateObject318 || (_templateObject318 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject319 || (_templateObject319 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
        (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject320 || (_templateObject320 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
      }

      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject321 || (_templateObject321 = leveling_taggedTemplateLiteral(["St. Sneaky Pete's Whey"])))) >= 1 && !have($effect(_templateObject322 || (_templateObject322 = leveling_taggedTemplateLiteral(["Awfully Wily"]))))) {
        (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject323 || (_templateObject323 = leveling_taggedTemplateLiteral(["Pete's wiley whey bar"]))), 1);
        (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject324 || (_templateObject324 = leveling_taggedTemplateLiteral(["Pete's wiley whey bar"]))), 1);
      }

      if (have(template_string_$item(_templateObject325 || (_templateObject325 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))))) (0,external_kolmafia_namespaceObject.chew)(template_string_$item(_templateObject326 || (_templateObject326 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))), 1);
      sendAutumnaton();
      sellMiscellaneousItems();
    },
    limit: {
...
var BoozeDropQuest = {
  ...
  tasks: [{
    ...
    completed: () => have($effect(boozedrop_templateObject23 || (boozedrop_templateObject23 = boozedrop_taggedTemplateLiteral(["Wizard Sight"])))),
    do: () => {
      if (!have(template_string_$item(boozedrop_templateObject24 || (boozedrop_templateObject24 = boozedrop_taggedTemplateLiteral(["roasted vegetable of Jarlsberg"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(boozedrop_templateObject25 || (boozedrop_templateObject25 = boozedrop_taggedTemplateLiteral(["roasted vegetable of Jarlsberg"]))), 1);
...
var WeaponDamageQuest = {
  ...
  tasks: [{
    ...
    completed: () => (0,external_kolmafia_namespaceObject.myInebriety)() >= (0,external_kolmafia_namespaceObject.inebrietyLimit)() - 1 || (0,external_kolmafia_namespaceObject.myMeat)() < 500 || property_get("instant_saveSockdollager", false),
    do: () => {
    ...
    name: "Cargo Shorts",
    completed: () => property_get("_cargoPocketEmptied") || !have(template_string_$item(weapondamage_templateObject6 || (weapondamage_templateObject6 = weapondamage_taggedTemplateLiteral(["Cargo Cultist Shorts"])))) || property_get("instant_saveCargoShorts", false),
    do: () => {
    ...
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(weapondamage_templateObject11 || (weapondamage_templateObject11 = weapondamage_taggedTemplateLiteral(["Meteor Shower"])))).trySkill(template_string_$skill(weapondamage_templateObject12 || (weapondamage_templateObject12 = weapondamage_taggedTemplateLiteral(["Use the Force"])))).abort()),
    outfit: {
