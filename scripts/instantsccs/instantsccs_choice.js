...
function totalFamiliarWeight() {
  ...
  return clamp(clamp(kolmafia.familiarWeight(familiar), have($effect(_templateObject47$2 || (_templateObject47$2 = _taggedTemplateLiteral(["Fidoxene"])))) ? 20 : 0, Infinity) + familiar.soupWeight + (considerAdjustment ? kolmafia.weightAdjustment() : 0) + (familiar.feasted ? 10 : 0), 1, Infinity);
}
...
var modeableItems = {
  backupcamera: $item(_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteral(["backup camera"]))),
  umbrella: $item(_templateObject2$8 || (_templateObject2$8 = _taggedTemplateLiteral(["unbreakable umbrella"]))),
  ...
  parka: $item(_templateObject6$6 || (_templateObject6$6 = _taggedTemplateLiteral(["Jurassic Parka"]))),
...
function canEquipItemCount() {
  var stats = $stats(_templateObject9$4 || (_templateObject9$4 = _taggedTemplateLiteral(["Muscle, Mysticality, Moxie"]))).map(stat => Math.min(kolmafia.myBasestat(stat), 300));
...
function applyCached(entry, options) {
  ...
  if (outfitName) {
    ...
    if (familiarEquip) kolmafia.equip($slot(_templateObject1$4 || (_templateObject1$4 = _taggedTemplateLiteral(["familiar"]))), familiarEquip);
  } else {
  ...
  if (kolmafia.equippedAmount($item(_templateObject10$4 || (_templateObject10$4 = _taggedTemplateLiteral(["Crown of Thrones"])))) > 0 && entry.rider.get($item(_templateObject11$4 || (_templateObject11$4 = _taggedTemplateLiteral(["Crown of Thrones"]))))) {
    kolmafia.enthroneFamiliar(entry.rider.get($item(_templateObject12$4 || (_templateObject12$4 = _taggedTemplateLiteral(["Crown of Thrones"])))) || $familiar.none);
  }
...
function verifyCached(entry) {
  ...
  if (kolmafia.equippedAmount($item(_templateObject23$3 || (_templateObject23$3 = _taggedTemplateLiteral(["Crown of Thrones"])))) > 0 && entry.rider.get($item(_templateObject24$3 || (_templateObject24$3 = _taggedTemplateLiteral(["Crown of Thrones"]))))) {
    if (entry.rider.get($item(_templateObject25$3 || (_templateObject25$3 = _taggedTemplateLiteral(["Crown of Thrones"])))) !== kolmafia.myEnthronedFamiliar()) {
      if (warn) {
...
var _templateObject$8, _templateObject2$7, _templateObject3$7, _templateObject4$5, _templateObject5$5, _templateObject6$5, _CommunityService, _templateObject7$3, _templateObject8$3, _templateObject9$3, _templateObject0$3, _templateObject1$3, _templateObject10$3, _templateObject11$3, _templateObject12$3, _templateObject13$2, _templateObject14$2, _templateObject15$2, _templateObject16$2, _templateObject17$2, _templateObject18$2, _templateObject19$3, _templateObject20$2, _templateObject21$2, _templateObject22$2, _templateObject23$2, _templateObject24$2, _templateObject25$2, _templateObject26$2, _templateObject27$1, _templateObject28$1, _templateObject29$1;
var thralls = new Map([[$stat(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral(["muscle"]))), $thrall(_templateObject2$7 || (_templateObject2$7 = _taggedTemplateLiteral(["Elbow Macaroni"])))], [$stat(_templateObject3$7 || (_templateObject3$7 = _taggedTemplateLiteral(["moxie"]))), $thrall(_templateObject4$5 || (_templateObject4$5 = _taggedTemplateLiteral(["Penne Dreadful"])))]]);
var statCommunityServicePredictor = stat => {
  return () => 60 - Math.floor(1 / 30 * (kolmafia.myBuffedstat(stat) - kolmafia.myBasestat(thralls.get(stat) === kolmafia.myThrall() && !have($effect(_templateObject5$5 || (_templateObject5$5 = _taggedTemplateLiteral(["Expert Oiliness"])))) ? $stat(_templateObject6$5 || (_templateObject6$5 = _taggedTemplateLiteral(["mysticality"]))) : stat)));
};
...
_defineProperty(CommunityService, "HP", new _CommunityService(1, "HP", "Donate Blood", () => 60 - Math.floor((kolmafia.myMaxhp() - kolmafia.myBuffedstat($stat(_templateObject7$3 || (_templateObject7$3 = _taggedTemplateLiteral(["muscle"])))) - 3) / 30), new Requirement(["HP"], {})));
...
_defineProperty(CommunityService, "WeaponDamage", new _CommunityService(6, "Weapon Damage", "Reduce Gazelle Population", function () {
  var weaponPower = kolmafia.getPower(kolmafia.equippedItem($slot(_templateObject1$3 || (_templateObject1$3 = _taggedTemplateLiteral(["weapon"])))));
  var offhandPower = kolmafia.toSlot(kolmafia.equippedItem($slot(_templateObject10$3 || (_templateObject10$3 = _taggedTemplateLiteral(["off-hand"]))))) === $slot(_templateObject11$3 || (_templateObject11$3 = _taggedTemplateLiteral(["weapon"]))) ? kolmafia.getPower(kolmafia.equippedItem($slot(_templateObject12$3 || (_templateObject12$3 = _taggedTemplateLiteral(["off-hand"]))))) : 0;
...
_defineProperty(CommunityService, "Noncombat", new _CommunityService(8, "Non-Combat", "Be a Living Statue", function () {
  ...
  var currentFamiliarModifier = -1 * kolmafia.numericModifier(kolmafia.myFamiliar(), "Raw Combat Rate", totalFamiliarWeight(), kolmafia.equippedItem($slot(_templateObject19$3 || (_templateObject19$3 = _taggedTemplateLiteral(["familiar"])))));
...
_defineProperty(CommunityService, "BoozeDrop", new _CommunityService(9, "Item Drop", "Make Margaritas", function () {
  ...
  var multiplier = kolmafia.haveEquipped($item(_templateObject25$2 || (_templateObject25$2 = _taggedTemplateLiteral(["broken champagne bottle"])))) && get("garbageChampagneCharge") > 0 ? 0.5 : 1;
  // We add 0.001 because the floor function sometimes introduces weird rounding errors
...
_defineProperty(CommunityService, "HotRes", new _CommunityService(10, "Hot Resistance", "Clean Steam Tunnels", function () {
  var currentFamiliarModifier = kolmafia.numericModifier(kolmafia.myFamiliar(), "Hot Resistance", totalFamiliarWeight(), kolmafia.equippedItem($slot(_templateObject27$1 || (_templateObject27$1 = _taggedTemplateLiteral(["familiar"])))));
  for (var _len7 = arguments.length, effects = new Array(_len7), _key7 = 0; _key7 < _len7; _key7++) {
    effects[_key7] = arguments[_key7];
  }
  var newFamiliarModifier = kolmafia.numericModifier(kolmafia.myFamiliar(), "Hot Resistance", totalFamiliarWeight(kolmafia.myFamiliar(), false) + hypotheticalModifier.apply(void 0, ["Familiar Weight"].concat(effects)), kolmafia.equippedItem($slot(_templateObject28$1 || (_templateObject28$1 = _taggedTemplateLiteral(["familiar"])))));
...
var consumptionResources = [new Resource("instant_skipDistilledFortifiedWine", "Do not grab the DFW lucky adventure (if you have numberology)"), new Resource("instant_saveAstralPilsners", n => "Save ".concat(n, "/6 astral pilsners (set a number)"), [], get("instant_saveAstralPilsners", false) ? 6 : 0), new Resource("instant_saveEuclideanAngle", "Do not pull a non-Euclidean Angle"), new Resource("instant_saveAbstraction", "Do not pull an Abstraction: Category"), new Resource("instant_savePerfectFreeze", "Do not craft and drink a perfect drink"), new Resource("instant_saveHoneyBun", "Do not eat a Honey Bun of Boris for the stats test", $effects(_templateObject$7 || (_templateObject$7 = _taggedTemplateLiteral(["Motherly Loved"])))), new Resource("instant_saveRoastedVegetableStats", "Do not eat a Roasted Vegetable of Jarlsberg for the stats test", $effects(_templateObject2$6 || (_templateObject2$6 = _taggedTemplateLiteral(["Wizard Sight"])))), new Resource("instant_saveRichRicotta", "Do not eat a Pete's Rich Ricotta for the stats test", $effects(_templateObject3$6 || (_templateObject3$6 = _taggedTemplateLiteral(["Rippin' Ricotta"])))), new Resource("instant_saveWileyWheyBar", "Do not eat a Pete's Wiley Whey Bar for the stats test"), new Resource("instant_saveRicottaCasserole", "Do not eat a Bake Veggie Ricotta Casserole for the stats test"), new Resource("instant_savePlainCalzone", "Do not eat a Plain Calzone", $effects(_templateObject4$4 || (_templateObject4$4 = _taggedTemplateLiteral(["Angering Pizza Purists"])))), new Resource("instant_saveBeesKnees", "Do not buy and drink Bee's Knees"), new Resource("instant_saveSockdollager", "Do not buy and drink a sockdollager"), new Resource("instant_saveBorisBeer", "Do not drink a Boris's Beer for the hot test"), new Resource("instant_saveRoastedVegetableItem", "Do not eat a Roasted Vegetable of Jarlsberg for the item test"), new Resource("instant_saveSacramentoWine", "Do not drink a Sacramento Wine for the item test"), new Resource("instant_savePillkeeper", "Do not acquire Hulkien, Rainbowolin and Fidoxene", $effects(_templateObject5$4 || (_templateObject5$4 = _taggedTemplateLiteral(["Hulkien, Rainbowolin, Fidoxene"])))), new Resource("instant_skipSynthExp", "Do not use synth for the Xp% buff"), new Resource("instant_skipSynthCold", "Do not use synth for the Cold Res buff"), new Resource("instant_saveBodySpradium", "Do not chew the body spradium if we have it", $effects(_templateObject6$4 || (_templateObject6$4 = _taggedTemplateLiteral(["Boxing Day Glow"])))), new Resource("instant_skipCabernetSauvignon", "Do not summon and drink a bottle of Cabernet Sauvignon", $effects(_templateObject7$2 || (_templateObject7$2 = _taggedTemplateLiteral(["Cabernet Hunter"]))))];
...
$monsters(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral(["Witchess Bishop, Witchess King, Witchess Witch, sausage goblin, Eldritch Tentacle"])));

var _templateObject$5, _templateObject2$5, _templateObject3$5, _templateObject4$3, _templateObject5$3, _templateObject6$3, _templateObject19$1;
...
get("instant_prioritizeParkaSpit", false) || have($item(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))) && have($skill(_templateObject2$5 || (_templateObject2$5 = _taggedTemplateLiteral(["Feel Envy"]))));
have($item(_templateObject3$5 || (_templateObject3$5 = _taggedTemplateLiteral(["Sept-Ember Censer"])))) && !get("instant_saveEmbers", false);
!get("instant_saveCinch", false);
var mainStat = kolmafia.myPrimestat();
var mainStatStr = mainStat.toString();
mainStat === $stat(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral(["Muscle"]))) ? "mus" : mainStat === $stat(_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteral(["Mysticality"]))) ? "myst" : "mox";
get("instant_targetBaseMainStat", 190);
get("instant_targetBaseMainStatGap", 15);
$items(_templateObject6$3 || (_templateObject6$3 = _taggedTemplateLiteral(["packet of pumpkin seeds, Peppermint Pip Packet, packet of dragon's teeth, packet of beer seeds, packet of winter seeds, packet of thanksgarden seeds, packet of tall grass seeds, packet of mushroom spores, packet of rock seeds"])));
...
craftedCBBFoods.map(it => kolmafia.effectModifier(it, "effect"));

var _templateObject$4, _templateObject2$4, _templateObject3$4, _templateObject32$1;
$items(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral(["bottle of rum, boxed wine, bottle of gin, bottle of vodka, bottle of tequila, bottle of whiskey"])));
$items(_templateObject2$4 || (_templateObject2$4 = _taggedTemplateLiteral(["sea tangelo, sea persimmon, sea lychee, sea honeydew, sea blueberry"])));
$items(_templateObject3$4 || (_templateObject3$4 = _taggedTemplateLiteral(["beefy fish meat, glistening fish meat, slick fish meat, dull fish scale, rough fish scale, pristine fish scale"])));
...
var _templateObject$3, _templateObject2$3, _templateObject3$3, _templateObject4$2, _templateObject5$2, _templateObject6$2, _templateObject7$1, _templateObject8$1, _templateObject9$1, _templateObject0$1, _templateObject1$1, _templateObject10$1, _templateObject11$1, _templateObject12$1, _templateObject13, _templateObject14, _templateObject15, _templateObject16, _templateObject17, _templateObject18, _templateObject19, _templateObject20, _templateObject21, _templateObject22, _templateObject23, _templateObject24, _templateObject25, _templateObject26, _templateObject27, _templateObject28, _templateObject29, _templateObject30, _templateObject31, _templateObject32, _templateObject33, _templateObject34, _templateObject35, _templateObject36, _templateObject37, _templateObject38, _templateObject39, _templateObject40, _templateObject41, _templateObject42, _templateObject43, _templateObject44, _templateObject45, _templateObject46, _templateObject47, _templateObject48, _templateObject49, _templateObject50, _templateObject51, _templateObject52, _templateObject53, _templateObject54, _templateObject55, _templateObject56, _templateObject57, _templateObject58, _templateObject59, _templateObject60, _templateObject61, _templateObject62, _templateObject63, _templateObject64, _templateObject65, _templateObject66, _templateObject67, _templateObject68, _templateObject69, _templateObject70, _templateObject71, _templateObject72, _templateObject73, _templateObject74, _templateObject75, _templateObject76, _templateObject77, _templateObject78, _templateObject79, _templateObject80, _templateObject81, _templateObject82, _templateObject83, _templateObject84, _templateObject85, _templateObject86, _templateObject87, _templateObject88, _templateObject89, _templateObject90, _templateObject91, _templateObject92, _templateObject93, _templateObject94, _templateObject95, _templateObject96, _templateObject97, _templateObject98, _templateObject99, _templateObject100, _templateObject101, _templateObject102, _templateObject103, _templateObject104, _templateObject105, _templateObject106, _templateObject123, _templateObject124, _templateObject125, _templateObject126, _templateObject127, _templateObject128, _templateObject129, _templateObject130, _templateObject131, _templateObject132, _templateObject133, _templateObject134, _templateObject135, _templateObject136;
({
  Muscle: $effect(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["Stabilizing Oiliness"]))),
  Mysticality: $effect(_templateObject2$3 || (_templateObject2$3 = _taggedTemplateLiteral(["Expert Oiliness"]))),
  Moxie: $effect(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral(["Slippery Oiliness"])))
})[mainStatStr];
({
  Muscle: $item(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteral(["oil of stability"]))),
  Mysticality: $item(_templateObject5$2 || (_templateObject5$2 = _taggedTemplateLiteral(["oil of expertise"]))),
  Moxie: $item(_templateObject6$2 || (_templateObject6$2 = _taggedTemplateLiteral(["oil of slipperiness"])))
})[mainStatStr];
({
...
var _templateObject$2, _templateObject2$2, _templateObject3$2, _templateObject4$1, _templateObject5$1, _templateObject6$1, _templateObject7, _templateObject8, _templateObject9, _templateObject0, _templateObject1, _templateObject10, _templateObject11, _templateObject12;
[$item(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["snorkel"]))), $item(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral(["Kentucky-style derby"]))), $item(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral(["pentacorn hat"]))), $item(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral(["goofily-plumed helmet"]))), $item(_templateObject5$1 || (_templateObject5$1 = _taggedTemplateLiteral(["yellow plastic hard hat"]))), $item(_templateObject6$1 || (_templateObject6$1 = _taggedTemplateLiteral(["wooden salad bowl"]))), $item(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["football helmet"]))), $item(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["fishin' hat"])))];
...
mainStatStr === $stat(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["Muscle"]))) ? "LOV Eardigan" : mainStatStr === $stat(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["Mysticality"]))) ? "LOV Epaulettes" : "LOV Earring";
$slots(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["codpiece1, codpiece2, codpiece3, codpiece4, codpiece5"])));
kolmafia.Item.all().filter(gem => kolmafia.stringModifier("EternityCodpiece:".concat(gem), "Modifiers").length > 0);
