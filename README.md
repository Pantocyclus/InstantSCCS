...
`InstantSCCS` is a softcore Community Service script for looping in Kingdom of Loathing designed to work for low-shiny accounts (i.e. accounts with minimal expensive items/skills) and mostly requires only cheap resources. Unfortunately, this means that the user is expected to have a bunch of softcore-permed skills, and at least ~6 IotMs in order to enable this (one of which is the [Clan VIP Lounge key](https://kol.coldfront.net/thekolwiki/index.php/Clan_VIP_Lounge_key)).
...
Once you start getting more and more [free fight sources](https://kol.coldfront.net/thekolwiki/index.php/Free_Fights), the less reliant you will be on the trainset and bowling ball for xp (they may be swapped out). Shinies that reduce turncount on the tests will then reduce the reliance on the cookbookbat for turngen.<br/>
...
| [mint-in-box Powerful Glove](https://kol.coldfront.net/thekolwiki/index.php/Mint-in-box_Powerful_Glove)                               | stat%, wdmg, sdmg and NC                        | 11\*                  |
| [January's Garbage Tote](https://kol.coldfront.net/thekolwiki/index.php/January%27s_Garbage_Tote)                                     | xp                                              | 11\*                  |
...
| [Distant Woods Getaway Brochure](https://kol.coldfront.net/thekolwiki/index.php/Distant_Woods_Getaway_Brochure)                       | xp                                              | 7                     |
...
![image](https://user-images.githubusercontent.com/98746573/221542555-c7c69f7b-ea61-42a3-a013-bdec3b9e50cf.png)<br/>
...
| [Ish Kabibble](https://kol.coldfront.net/thekolwiki/index.php/Feeling_No_Pain)                    | 2         | 1      | 6 + 2               | hot test                           |
| [sockdollager](https://kol.coldfront.net/thekolwiki/index.php/In_a_Lather)                        | 2         | 1      | 6 + 2               | wdmg test                          |
...
| [Speakeasy](https://kol.coldfront.net/thekolwiki/index.php/A_Speakeasy)                                              | leveling, myst test, <br/>mox test, mus test, <br/>hot test, wdmg test | [Bee's Knees](https://kol.coldfront.net/thekolwiki/index.php/Bee%27s_Knees), [Ish Kabibble](https://kol.coldfront.net/thekolwiki/index.php/Ish_Kabibble), [Sockdollager](https://kol.coldfront.net/thekolwiki/index.php/Sockdollager)                                                                                                                                                                                            |
...
| [Locket](https://kol.coldfront.net/thekolwiki/index.php/Combat_lover%27s_locket)                          | mox test, mus test, <br/>item test, wdmg test                | [ungulith](https://kol.coldfront.net/thekolwiki/index.php/Ungulith), [Witchess King](https://kol.coldfront.net/thekolwiki/index.php/Witchess_King), <br/>[Black Crayon Pirate](https://kol.coldfront.net/thekolwiki/index.php/Black_Crayon_Pirate)                                                                                                                      |
...
- Equip [codpiece](https://kol.coldfront.net/thekolwiki/index.php/Codpiece) to increase mp limit (coiling wire with [Inner Sauce](https://kol.coldfront.net/thekolwiki/index.php/Inner_Sauce) restores 180-240mp) <br/>
...
- Pull and use a [borrowed time](https://kol.coldfront.net/thekolwiki/index.php/Borrowed_time) (60 turns remaining, 0/0/0 organs) <br/>
...
- Pull and consume 1x [Pizza of Legend](https://kol.coldfront.net/thekolwiki/index.php/Pizza_of_Legend) (+2adv from [pizza lover](https://kol.coldfront.net/thekolwiki/index.php/Pizza_Lover), +5adv from [Opossum](https://kol.coldfront.net/thekolwiki/index.php/The_Opossum)) (25+ adv remaining, 2/0/0 organs) <br/>
...
- Maximize myst and equip your [cookbookbat](https://kol.coldfront.net/thekolwiki/index.php/Cookbookbat) <br/>
- Configure your [trainset](https://kol.coldfront.net/thekolwiki/index.php/Model_Train_Set) (coal/brain silo/viewing platform/water bridge/fizzy tower/frozen tower/meat/candy) <br/>
- Spend 1adv in [Gator's](https://kol.coldfront.net/thekolwiki/index.php/Uncle_Gator%27s_Country_Fun-Time_Liquid_Waste_Sluice) to get [red](https://kol.coldfront.net/thekolwiki/index.php/Ready_to_Eat) and [blue rocket buffs](https://kol.coldfront.net/thekolwiki/index.php/Glowing_Blue) (no free kills - adventure needs to be spent to restore mp; ensure you have at least 32mp for [saucegeyser](https://kol.coldfront.net/thekolwiki/index.php/Saucegeyser) + [curse of weaksauce](https://kol.coldfront.net/thekolwiki/index.php/Curse_of_Weaksauce), and always use the curse to restore mp) (1 turn, 24+ adv remaining, 2/0/0 organs) <br/>
- Pull and consume 1x [Calzone of Legend](https://kol.coldfront.net/thekolwiki/index.php/Calzone_of_Legend) (+2adv from [pizza lover](https://kol.coldfront.net/thekolwiki/index.php/Pizza_Lover)) (44+ adv remaining, 4/0/0 organs) <br/>
...
- Craft and drink a [Perfect Dark and Stormy](https://kol.coldfront.net/thekolwiki/index.php/Perfect_dark_and_stormy) (with [ode](https://kol.coldfront.net/thekolwiki/index.php/Ode_to_Booze)) (65+ adv remaining, 4/3/0 organs)
...
- Spend up to 3 turns banishing, first with your [cosmic bowling ball](https://kol.coldfront.net/thekolwiki/index.php/Bowl_a_Curveball), then subsequently with [snokebomb](https://kol.coldfront.net/thekolwiki/index.php/Snokebomb) in [the skeleton store](https://kol.coldfront.net/thekolwiki/index.php/The_Skeleton_Store) until you find a [novelty tropical skeleton](https://kol.coldfront.net/thekolwiki/index.php/Novelty_tropical_skeleton). You should be guaranteed to hit the novelty tropical skeleton by the 3rd try (before the [scheduled NC](https://kol.coldfront.net/thekolwiki/index.php/Temporarily_Out_of_Skeletons) on the 4th turn) if you have set up your [ice house](https://kol.coldfront.net/thekolwiki/index.php/Ice_house) correctly. <br/>
- [Yellow rocket](https://kol.coldfront.net/thekolwiki/index.php/Yellow_rocket) the [novelty tropical skeleton](https://kol.coldfront.net/thekolwiki/index.php/Novelty_tropical_skeleton) (1 turn, 64+ adv remaining, 4/3/0 organs)<br/>
- Continue banishing until all 4 (or more) banishes have been used (in total, we should have advanced the [cookbookbat](https://kol.coldfront.net/thekolwiki/index.php/Cookbookbat) and [trainset](https://kol.coldfront.net/thekolwiki/index.php/Model_Train_Set) counters at least 5 times)<br/>
...
- Drink 6x [astral pilsners](https://kol.coldfront.net/thekolwiki/index.php/Astral_pilsner) (with [ode](https://kol.coldfront.net/thekolwiki/index.php/Ode_to_Booze)) while leveling in [Gator's](https://kol.coldfront.net/thekolwiki/index.php/Uncle_Gator%27s_Country_Fun-Time_Liquid_Waste_Sluice) as soon as you hit level 11 (80+ adv remaining, 4/9/0 organs) <br/>
- Also drink 1x [Bee's Knees](https://kol.coldfront.net/thekolwiki/index.php/Bee%27s_Knees) (with [ode](https://kol.coldfront.net/thekolwiki/index.php/Ode_to_Booze)) prior to using your 4x free kills (88+ adv remaining, 4/11/0 organs) <br/>
- Similarly, use [Lyle's buff](https://kol.coldfront.net/thekolwiki/index.php/Favored_by_Lyle) prior to the 4x free kills<br/>
- Craft and eat 1x [roasted vegetable of Jarlsberg](https://kol.coldfront.net/thekolwiki/index.php/Roasted_vegetable_of_Jarlsberg) prior to the 4x free kills as well (this can be done earlier than [Lyle's buff](https://kol.coldfront.net/thekolwiki/index.php/Favored_by_Lyle) since we only need it to last through the Myst test, not all the stat tests) (94+ adv remaining, 5/11/0 organs)<br/>
- Cook and consume 1x [baked veggie ricotta casserole](https://kol.coldfront.net/thekolwiki/index.php/Baked_veggie_ricotta_casserole) (109+ adv remaining, 7/11/0 organs) <br/>
- Buff up as necessary for the myst test <br/>

> Myst Test (1 turn, 108+ adv remaining, 7/11/0 organs) <br/>

- Save the [reward](https://kol.coldfront.net/thekolwiki/index.php/Pocket_maze) <br/>
- Pull and eat 1x [Deep Dish of Legend](https://kol.coldfront.net/thekolwiki/index.php/Deep_Dish_of_Legend) (+2adv from [pizza lover](https://kol.coldfront.net/thekolwiki/index.php/Pizza_Lover)) (128+ adv remaining, 9/11/0 organs)<br/>
- Buff up as necessary for the HP test <br/>

> HP Test (1 turn, 127+ adv remaining, 9/11/0 organs) <br/>
...
- Craft and consume 1x [Pete's wiley whey bar](https://kol.coldfront.net/thekolwiki/index.php/Pete%27s_wiley_whey_bar) (132+ adv remaining, 10/11/0 organs)<br/>
- Craft and consume 1x [Petes Rich Ricotta](https://kol.coldfront.net/thekolwiki/index.php/Pete%27s_rich_ricotta) (138+ adv remaining, 11/11/0 organs)<br/>
- Craft and consume 1x [plain calzone](https://kol.coldfront.net/thekolwiki/index.php/Plain_calzone) (+2adv from [pizza lover](https://kol.coldfront.net/thekolwiki/index.php/Pizza_Lover)) (155+ adv remaining, 13/11/0 organs)<br/>
...
> Mox Test (~4 turns, 154+ adv remaining, 13/11/0 organs) <br/>

- Save the [reward](https://kol.coldfront.net/thekolwiki/index.php/Shady_shades)
- Craft and consume 1x [honey bun of Boris](https://kol.coldfront.net/thekolwiki/index.php/Honey_bun_of_Boris) (159+ adv remaining, 14/11/0 organs)<br/>
...
> Mus Test (1 turn, 158+ adv remaining, 14/11/0 organs) <br/>

![image](https://user-images.githubusercontent.com/98746573/221542410-11cb65c5-a1e1-4d20-b63e-5ae08805fe2b.png)<br/>
...
> Fam Test (50 turns, 108+ adv remaining, 14/11/0 organs) <br/>
...
> NC Test (9 turns, 99+ adv remaining, 14/11/0 organs) <br/>

- Use a [clover](https://kol.coldfront.net/thekolwiki/index.php/11-leaf_clover) to grab a [cyclops eyedrops](https://kol.coldfront.net/thekolwiki/index.php/Cyclops_eyedrops) from the [Limerick Dungeon](https://kol.coldfront.net/thekolwiki/index.php/The_Limerick_Dungeon) (1 turn, 98+ adv remaining, 14/11/0 organs) <br/>
- [Bowl Straight Up](https://kol.coldfront.net/thekolwiki/index.php/Bowl_Straight_Up) and [yellow rocket](https://kol.coldfront.net/thekolwiki/index.php/Yellow_rocket) a [faxed](https://kol.coldfront.net/thekolwiki/index.php/A_Fax_Machine) [factory worker (female)](<https://kol.coldfront.net/thekolwiki/index.php/Factory_worker_(female)>) (1 turn, 97+ adv remaining, 14/11/0 organs)
...
- Craft and eat a [roasted vegetable of Jarlsberg](https://kol.coldfront.net/thekolwiki/index.php/Roasted_vegetable_of_Jarlsberg) (103+ adv remaining, 15/11/0 organs)<br/>
...
> Item Test (28 turns, 75+ adv remaining, 15/11/0 organs) <br/>
...
- [Reminisce](https://kol.coldfront.net/thekolwiki/index.php/Reminiscing_About_Those_Monsters_You_Fought) an [ungulith](https://kol.coldfront.net/thekolwiki/index.php/Ungulith) for the [cowrrupted marrow](https://kol.coldfront.net/thekolwiki/index.php/Corrupted_marrow) (1 turn, 74+ adv remaining, 15/11/0 organs)<br/>
- Spend a turn in [The Dire Warren](https://kol.coldfront.net/thekolwiki/index.php/The_Dire_Warren) to get [Double Frozen](https://kol.coldfront.net/thekolwiki/index.php/Double_Frozen) from your [trainset](https://kol.coldfront.net/thekolwiki/index.php/Model_Train_Set) (1 turn, 73+ adv remaining, 15/11/0 organs).
...
- Cast [ode](https://kol.coldfront.net/thekolwiki/index.php/Ode_to_Booze) and drink an [Ish Kabibble](https://kol.coldfront.net/thekolwiki/index.php/Ish_Kabibble) (81+ adv remaining, 15/13/0 organs)<bre/>
...
> Hot Resist Test (27 turns, 54+ adv remaining, 15/13/0 organs) <br/>

- Cast [ode](https://kol.coldfront.net/thekolwiki/index.php/Ode_to_Booze) and drink a [Sockdollager](https://kol.coldfront.net/thekolwiki/index.php/Sockdollager) (62+ adv remaining, 15/15/0 organs) <br/>
...
> Weapon Test (35 turns, 27+ adv remaining, 15/15/0 organs) <br/>
...
- Cast [simmer](https://kol.coldfront.net/thekolwiki/index.php/Simmer) (1 turn, 26+ adv remaining, 15/15/0 organs) <br/>
...
> Spell Test (51 turns, -25+ adv remaining, 15/15/0 organs) <br/>
