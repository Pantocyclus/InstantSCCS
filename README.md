...
- Configure your [trainset](https://kol.coldfront.net/thekolwiki/index.php/Model_Train_Set) (coal/meat/brain silo/any other 5 stations) <br/>
- Equip your [cookbookbat](https://kol.coldfront.net/thekolwiki/index.php/Cookbookbat) as your active familiar <br/>
- Purchase a [yellow rocket](https://kol.coldfront.net/thekolwiki/index.php/Yellow_rocket)
- Restore your MP to at least 50 (using [Doc Galaktik's Invigorating Tonic](https://kol.coldfront.net/thekolwiki/index.php/Doc_Galaktik%27s_Invigorating_Tonic) if necessary).
- Adventure 3 times in [the skeleton store](https://kol.coldfront.net/thekolwiki/index.php/The_Skeleton_Store), using the [yellow rocket](https://kol.coldfront.net/thekolwiki/index.php/Yellow_rocket) on the [novelty tropical skeleton](https://kol.coldfront.net/thekolwiki/index.php/Novelty_tropical_skeleton), [Bowl a Curveball](https://kol.coldfront.net/thekolwiki/index.php/Bowl_a_Curveball) on the first non-novelty skeleton, and [snokebomb](https://kol.coldfront.net/thekolwiki/index.php/Snokebomb) on the second non-novelty skeleton (1 turn, 59 adv remaining, 0/0/0 organs).
- Purchase and use [chewing gum on a string](https://kol.coldfront.net/thekolwiki/index.php/Chewing_gum_on_a_string) until you get a [worthless trinket](https://kol.coldfront.net/thekolwiki/index.php/Worthless_trinket) (you will need 2x [worthless trinkets](https://kol.coldfront.net/thekolwiki/index.php/Worthless_trinket), 1x [turtle totem](https://kol.coldfront.net/thekolwiki/index.php/Turtle_totem) and 1x [saucepan](https://kol.coldfront.net/thekolwiki/index.php/Saucepan) from the gums)
- Purchase a [hermit permit](https://kol.coldfront.net/thekolwiki/index.php/Hermit_permit), then purchase an [11-leaf clover](https://kol.coldfront.net/thekolwiki/index.php/11-leaf_clover) from the hermitage.
- Use the [11-leaf clover](https://kol.coldfront.net/thekolwiki/index.php/11-leaf_clover), then grab 3x [distilled fortified wines](https://kol.coldfront.net/thekolwiki/index.php/Distilled_fortified_wine) from [The Sleazy Back Alley](https://kol.coldfront.net/thekolwiki/index.php/The_Sleazy_Back_Alley) (1 turn, 58 adv remaining, 0/0/0 organs)
- Drink 2x [distilled fortified wines](https://kol.coldfront.net/thekolwiki/index.php/Distilled_fortified_wine) (with [ode](https://kol.coldfront.net/thekolwiki/index.php/Ode_to_Booze)) (70+ adv remaining, 0/2/0 organs)
...
- Spend turns and free fights powerleveling until you get the [cookbookbat](https://kol.coldfront.net/thekolwiki/index.php/Cookbookbat) to drop its ingredients 6 times (this can be dropped to 5 if you have additional shinies as shown in the graph above), and a base myst of no less than 195 (which also can be lowered with more stat%-granting shinies). For the minimal route:<br/>
  ...
  - Consume the following foods/booze and acquire the following effects after the turn-taking adventures, prior to your free kills/fights (you may do this earlier to benefit from the myst% buffs during leveling, but do ensure that the buffs do not run out before you take the relevant tests):
    ...
    - Craft and eat 1x [roasted vegetable of Jarlsberg](https://kol.coldfront.net/thekolwiki/index.php/Roasted_vegetable_of_Jarlsberg) (111+ adv remaining, 6/13/0 organs)<br/>
    - Craft and eat 1x [Petes Rich Ricotta](https://kol.coldfront.net/thekolwiki/index.php/Pete%27s_rich_ricotta) (117+ adv remaining, 7/13/0 organs)<br/>
    - Craft and eat 1x [plain calzone](https://kol.coldfront.net/thekolwiki/index.php/Plain_calzone) (+2adv from [pizza lover](https://kol.coldfront.net/thekolwiki/index.php/Pizza_Lover)) (134+ adv remaining, 9/11/0 organs)<br/>
    - Craft and eat 1x [baked veggie ricotta casserole](https://kol.coldfront.net/thekolwiki/index.php/Baked_veggie_ricotta_casserole) (149+ adv remaining, 11/13/0 organs)<br/>
    - Pull and eat 1x [Deep Dish of Legend](https://kol.coldfront.net/thekolwiki/index.php/Deep_Dish_of_Legend) (+2adv from [pizza lover](https://kol.coldfront.net/thekolwiki/index.php/Pizza_Lover)) (169+ adv remaining, 13/13/0 organs)<br/>
...
> Mox Test (1 turns, 171+ adv remaining, 14/13/0 organs) <br/>
...
> Mus Test (1 turn, 170+ adv remaining, 14/13/0 organs) <br/>

![image](https://user-images.githubusercontent.com/98746573/221615221-b5214d5a-1d85-49b9-860e-62a879ed4961.png)<br/>
...
> Fam Test (50 turns, 120+ adv remaining, 14/13/0 organs) <br/>
...
- Craft and eat a [roasted vegetable of Jarlsberg](https://kol.coldfront.net/thekolwiki/index.php/Roasted_vegetable_of_Jarlsberg) (115+ adv remaining, 15/13/0 organs)<br/>
- +60%booze from [Mus Test reward](https://kol.coldfront.net/thekolwiki/index.php/Nearly_All-Natural), +25%booze from [Always Never Not Guzzling](https://kol.coldfront.net/thekolwiki/index.php/Always_Never_Not_Guzzling) (totalling +85%booze)
