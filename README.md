...
- [The Opposum](https://kol.coldfront.net/thekolwiki/index.php/The_Opposum)
...
- Equip codpiece to increase mp limit (coiling wire with Inner Sauce restores 180-240mp) <br/>
- Configure your umbrella to the broken state, then equip it<br/>
...
- Buy and consume 1x fire crackers (+5adv from Opposum) (8 adv remaining, 1/0/0 organs) <br/>
...
- Yellow rocket the novelty tropical skeleton (1 turn, 67+ adv remaining, 5/3/0 organs)<br/>
...
- Use 2x scrumptious reagents to craft 6x ointment of the occults and get the mystically oiled buff, which should last for 90turns <br/>
...
- Spend ~46 more adventures + 4x free kills (shattering punch + mob hit, done after the turn-taking fights) in Gator's (reconfigure trainset to ensure at least 8 brain silos), hitting no less than 195 base myst and ensuring that you have gotten your CBB to drop ingredients 5 times (~46 turns, 21+ adv remaining, 5/3/0 organs) <br/>
- Reminisce a Witchess King for the dented scepter and tuning your locket to the Dude phylum<br/>
...
- Craft and eat 1x roasted vegetable of Jarlsberg prior to the 4x free kills as well (this can be done earlier than Lyle's buff since we only need it to last through the Myst test, not all the stat tests) (106+ adv remaining, 6/11/0 organs)<br/>
...
- Save the reward <br/>
- Pull and eat 1x Deep Dish of Legend (+2adv from pizza lover) (140+ adv remaining, 10/11/0 organs)<br/>
...
- Configure your umbrella to the cocoon state, then equip it<br/>
- Grab Silent Running from the pool <br/>
- Use the shady shades <br/>
...
- You should have -20% from Fam Test, -20% from Mox Test, -10% from codpiece, -10% from skills, -10% from the unbreakable umbrella, -5% from the porkpie-mounted popper, -5% from silent running and -5% from your Disgeist (combat freq) <br/>

> NC Test (9 turns, 103+ adv remaining, 14/11/0 organs) <br/>

- Use a clover to grab a cyclops eyedrops from the Limerick Dungeon (1 turn, 102+ adv remaining, 14/11/0 organs) <br/>
- [Bowl Straight Up](https://kol.coldfront.net/thekolwiki/index.php/Bowl_Straight_Up) and yellow rocket a faxed factory worker (female) (1 turn, 101+ adv remaining, 14/11/0 organs)
- Configure your umbrella to the bucket state, then equip it<br/>
- Use Mus Test reward and cyclops eyedrops <br/>
- Summon Spice Ghost (non-pastamancer) <br/>
- Craft and eat a roasted vegetable of Jarlsberg (107+ adv remaining, 15/11/0 organs)<br/>
- Reminisce a black crayon pirate to tune your locket<br/>
- +60%booze from Mus Test reward, +50%booze from locket, +25%booze from Always Never Not Guzzling (totalling +125%booze)
- +100%item from cyclops eyedrops, +100% from wizard sight, +25%item from Cosmic Ball in the Air, +25% from unbreakable umbrella, +20%item from Phat Loot, +20%item from Mad Looting Skillz, +20%item from oversized sparkler, +10%item from Object Quasi-Permeance, +10%item from Powers of Observatiogn, +5%item from Spice Ghost, +5%item from Natural Born Scrabbler and +5%item from Thief among the Honorable (totalling 345%item) <br/>
- Cast Steely-Eyed Squint (+345%item)<br/>
...
- Cast ode and drink a Sockdollager (67+ adv remaining, 15/15/0 organs) <br/>
- Configure your umbrella to the pitchfork state, then equip it<br/>
...
- Reminisce an ungulith for the cowrrupted marrow (1 turn, 66+ adv remaining, 15/15/0 organs)<br/>
- +200% from cowrruption, +100% from song of the north, +100% from carol of the bulls, +50% from pool table, +50% from sockdollager, +30% from hatter buff (totalling +530%) <br/>
- +25 from umbrella, +20 from sockdollager, +12 from Jackasses' Symphony, +10 from Scowl of the Auk, +10 from Rage of the Reindeer, +8 from Tenacity of the Snapper, +7 from Claws of the Walrus, +5 from Disdain of the War Snapper and +5 from potion of potency (totalling +102 flat) <br/>
- Cast bow-legged swagger (+530%wdmg +102flat) <br/>

> Weapon Test (35 turns, 31+ adv remaining, 15/15/0 organs) <br/>

- Buy an obsidian nutcracker <br/>
- Configure your umbrella to the constant twirl state, then equip it<br/>
- Cast simmer (1 turn, 30+ adv remaining, 15/15/0 organs) <br/>
