...
import { camelFightsLeft, haveCBBIngredients, mainStatMaximizerString } from "../lib";
...
export function baseOutfit(allowAttackingFamiliars = true): OutfitSpec {
  ...
  return {
    ...
    modifier: `0.25 ${mainStatMaximizerString}, 0.33 ML, -equip tinsel tights, -equip wad of used tape`,
    avoid: [
