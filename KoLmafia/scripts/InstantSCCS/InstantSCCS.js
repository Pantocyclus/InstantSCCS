...
var LevelingQuest = {
  ...
  tasks: [{
    ...
    completed: () => !have(template_string_$item(_templateObject72 || (_templateObject72 = leveling_taggedTemplateLiteral(["cherry"])))),
    do: () => {
      if (!have(template_string_$item(_templateObject73 || (_templateObject73 = leveling_taggedTemplateLiteral(["oil of expertise"]))))) {
        if (property_get("reagentSummons") === 0) (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject74 || (_templateObject74 = leveling_taggedTemplateLiteral(["Advanced Saucecrafting"]))), 1);
        (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject75 || (_templateObject75 = leveling_taggedTemplateLiteral(["oil of expertise"]))), 1);
      }

      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject76 || (_templateObject76 = leveling_taggedTemplateLiteral(["oil of expertise"])))) > 1) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject77 || (_templateObject77 = leveling_taggedTemplateLiteral(["oil of expertise"]))), (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject78 || (_templateObject78 = leveling_taggedTemplateLiteral(["oil of expertise"])))) - 1);
    }
  }, {
    name: "Buy Oversized Sparkler",
    ready: () => have($effect(_templateObject79 || (_templateObject79 = leveling_taggedTemplateLiteral(["Everything Looks Blue"])))) && (0,external_kolmafia_namespaceObject.myMeat)() >= 1000,
    completed: () => have(template_string_$item(_templateObject80 || (_templateObject80 = leveling_taggedTemplateLiteral(["oversized sparkler"])))),
    do: () => (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject81 || (_templateObject81 = leveling_taggedTemplateLiteral(["oversized sparkler"]))), 1),
    limit: {
      tries: 1
    }
  }, {
    name: "Eat Pizza",
    ready: () => have($effect(_templateObject82 || (_templateObject82 = leveling_taggedTemplateLiteral(["Ready to Eat"])))),
    // only eat this after we red rocket
    completed: () => property_get("pizzaOfLegendEaten"),
    do: () => {
      (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject83 || (_templateObject83 = leveling_taggedTemplateLiteral(["Pizza of Legend"]))), 1);
    },
    limit: {
      tries: 1
    }
    ...
    completed: () => (0,external_kolmafia_namespaceObject.myInebriety)() >= (0,external_kolmafia_namespaceObject.inebrietyLimit)() || !have(template_string_$item(_templateObject84 || (_templateObject84 = leveling_taggedTemplateLiteral(["astral six-pack"])))) && !have(template_string_$item(_templateObject85 || (_templateObject85 = leveling_taggedTemplateLiteral(["astral pilsner"])))),
    prepare: () => tryAcquiringEffect($effect(_templateObject86 || (_templateObject86 = leveling_taggedTemplateLiteral(["Ode to Booze"])))),
    do: () => {
      if (have(template_string_$item(_templateObject87 || (_templateObject87 = leveling_taggedTemplateLiteral(["astral six-pack"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject88 || (_templateObject88 = leveling_taggedTemplateLiteral(["astral six-pack"]))), 1);
      (0,external_kolmafia_namespaceObject.drink)(template_string_$item(_templateObject89 || (_templateObject89 = leveling_taggedTemplateLiteral(["astral pilsner"]))), 1);
    },
    post: () => {
      if (!have(template_string_$item(_templateObject90 || (_templateObject90 = leveling_taggedTemplateLiteral(["astral six-pack"])))) && !have(template_string_$item(_templateObject91 || (_templateObject91 = leveling_taggedTemplateLiteral(["astral pilsner"]))))) uneffect($effect(_templateObject92 || (_templateObject92 = leveling_taggedTemplateLiteral(["Ode to Booze"]))));
    },
    limit: {
      tries: 6
    }
    ...
    have(template_string_$item(_templateObject93 || (_templateObject93 = leveling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || (0,external_kolmafia_namespaceObject.toItem)(property_get("rufusQuestTarget", "")) !== template_string_$item.none,
    do: () => // eslint-disable-next-line libram/verify-constants
    (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject94 || (_templateObject94 = leveling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    choices: {
      1497: 2,
      1498: 6
    },
    ...
    have($effect(_templateObject95 || (_templateObject95 = leveling_taggedTemplateLiteral(["Shadow Affinity"])))) && (0,external_kolmafia_namespaceObject.toItem)(property_get("rufusQuestTarget", "")) !== template_string_$item.none,
    prepare: () => {
      ...
      if (!have($effect(_templateObject96 || (_templateObject96 = leveling_taggedTemplateLiteral(["Everything Looks Red"])))) && !have(template_string_$item(_templateObject97 || (_templateObject97 = leveling_taggedTemplateLiteral(["red rocket"]))))) (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject98 || (_templateObject98 = leveling_taggedTemplateLiteral(["red rocket"]))), 1);
      if (!have($effect(_templateObject99 || (_templateObject99 = leveling_taggedTemplateLiteral(["Everything Looks Blue"])))) && !have(template_string_$item(_templateObject100 || (_templateObject100 = leveling_taggedTemplateLiteral(["blue rocket"]))))) (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject101 || (_templateObject101 = leveling_taggedTemplateLiteral(["blue rocket"]))), 1);
    ...
    completed: () => // eslint-disable-next-line libram/verify-constants
    have(template_string_$item(_templateObject102 || (_templateObject102 = leveling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))),
    // eslint-disable-next-line libram/verify-constants
    do: () => {
    ...
    combat: new CombatStrategy().macro(combat_Macro.tryItem(template_string_$item(_templateObject103 || (_templateObject103 = leveling_taggedTemplateLiteral(["red rocket"])))).tryItem(template_string_$item(_templateObject104 || (_templateObject104 = leveling_taggedTemplateLiteral(["blue rocket"])))).default()),
    outfit: {
      offhand: template_string_$item(_templateObject105 || (_templateObject105 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject106 || (_templateObject106 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject107 || (_templateObject107 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
    ...
    post: () => {
      if (have(template_string_$item(_templateObject108 || (_templateObject108 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");

      if (have((0,external_kolmafia_namespaceObject.toItem)(property_get("_rufusArtifact", "")))) {
        // eslint-disable-next-line libram/verify-constants
        (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject109 || (_templateObject109 = leveling_taggedTemplateLiteral(["closed-circuit pay phone"]))));
        _set("_rufusArtifact", "");
      }
    },
    limit: {
    ...
    prepare: () => {
      ...
      if (have(template_string_$item(_templateObject110 || (_templateObject110 = leveling_taggedTemplateLiteral(["unbreakable umbrella"])))) && property_get("umbrellaState") !== "broken") (0,external_kolmafia_namespaceObject.cliExecute)("umbrella ml");
      (0,external_kolmafia_namespaceObject.restoreMp)(50);
    },
    completed: () => property_get("_snojoFreeFights") >= 10 || !property_get("snojoAvailable"),
    do: $location(_templateObject111 || (_templateObject111 = leveling_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      offhand: template_string_$item(_templateObject112 || (_templateObject112 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject113 || (_templateObject113 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject114 || (_templateObject114 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 10
    ...
    post: () => {
      ...
      if (have(template_string_$item(_templateObject115 || (_templateObject115 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");
    }
  }, {
    name: "Snokebomb",
    prepare: () => {
    ...
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject116 || (_templateObject116 = leveling_taggedTemplateLiteral(["Snokebomb"])))).abort()),
    outfit: {
      offhand: template_string_$item(_templateObject117 || (_templateObject117 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject118 || (_templateObject118 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject119 || (_templateObject119 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    choices: {
      1094: 5,
    ...
    post: () => {
      if (have(template_string_$item(_templateObject120 || (_templateObject120 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");
    },
    limit: {
      tries: 4
    }
    ...
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));
      if (have(template_string_$item(_templateObject121 || (_templateObject121 = leveling_taggedTemplateLiteral(["unbreakable umbrella"])))) && property_get("umbrellaState") !== "broken") (0,external_kolmafia_namespaceObject.cliExecute)("umbrella ml");

      if (have(template_string_$item(_templateObject122 || (_templateObject122 = leveling_taggedTemplateLiteral(["January's Garbage Tote"])))) && property_get("garbageShirtCharge") > 0 && have(template_string_$skill(_templateObject123 || (_templateObject123 = leveling_taggedTemplateLiteral(["Torso Awareness"]))))) {
        if (property_get("garbageShirtCharge") === 1) {
          if ((0,external_kolmafia_namespaceObject.equippedItem)($slot(_templateObject124 || (_templateObject124 = leveling_taggedTemplateLiteral(["shirt"])))) === template_string_$item(_templateObject125 || (_templateObject125 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject126 || (_templateObject126 = leveling_taggedTemplateLiteral(["shirt"]))), template_string_$item.none);
        } else {
          if (!have(template_string_$item(_templateObject127 || (_templateObject127 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("fold makeshift garbage shirt");
          (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject128 || (_templateObject128 = leveling_taggedTemplateLiteral(["shirt"]))), template_string_$item(_templateObject129 || (_templateObject129 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))));
        }
      }

      if (have(template_string_$item(_templateObject130 || (_templateObject130 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject131 || (_templateObject131 = leveling_taggedTemplateLiteral(["back"]))), template_string_$item(_templateObject132 || (_templateObject132 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))));
    ...
    completed: () => {
      ...
      return !have(template_string_$item(_templateObject133 || (_templateObject133 = leveling_taggedTemplateLiteral(["backup camera"])))) || !freeFightMonsters.includes((_get2 = property_get("lastCopyableMonster")) !== null && _get2 !== void 0 ? _get2 : $monster.none) || property_get("_backUpUses") >= 11;
    },
    do: $location(_templateObject134 || (_templateObject134 = leveling_taggedTemplateLiteral(["The Dire Warren"]))),
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject135 || (_templateObject135 = leveling_taggedTemplateLiteral(["Back-Up to your Last Enemy"])))).default()),
    outfit: {
      ...
      acc3: template_string_$item(_templateObject138 || (_templateObject138 = leveling_taggedTemplateLiteral(["backup camera"]))),
      familiar: template_string_$familiar(_templateObject139 || (_templateObject139 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    post: () => {
      var _get3;
    ...
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));
      if (have(template_string_$item(_templateObject140 || (_templateObject140 = leveling_taggedTemplateLiteral(["unbreakable umbrella"])))) && property_get("umbrellaState") !== "broken") (0,external_kolmafia_namespaceObject.cliExecute)("umbrella ml");

      if (have(template_string_$item(_templateObject141 || (_templateObject141 = leveling_taggedTemplateLiteral(["January's Garbage Tote"])))) && property_get("garbageShirtCharge") > 0 && have(template_string_$skill(_templateObject142 || (_templateObject142 = leveling_taggedTemplateLiteral(["Torso Awareness"]))))) {
        if (property_get("garbageShirtCharge") === 1) {
          if ((0,external_kolmafia_namespaceObject.equippedItem)($slot(_templateObject143 || (_templateObject143 = leveling_taggedTemplateLiteral(["shirt"])))) === template_string_$item(_templateObject144 || (_templateObject144 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject145 || (_templateObject145 = leveling_taggedTemplateLiteral(["shirt"]))), template_string_$item.none);
        } else {
          if (!have(template_string_$item(_templateObject146 || (_templateObject146 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("fold makeshift garbage shirt");
          (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject147 || (_templateObject147 = leveling_taggedTemplateLiteral(["shirt"]))), template_string_$item(_templateObject148 || (_templateObject148 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))));
        }
      }

      if (have(template_string_$item(_templateObject149 || (_templateObject149 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject150 || (_templateObject150 = leveling_taggedTemplateLiteral(["back"]))), template_string_$item(_templateObject151 || (_templateObject151 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))));
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
      (0,external_kolmafia_namespaceObject.restoreMp)(50);
    },
    ready: () => getKramcoWandererChance() >= 1.0,
    completed: () => getKramcoWandererChance() < 1.0 || !have(template_string_$item(_templateObject152 || (_templateObject152 = leveling_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))),
    do: $location(_templateObject153 || (_templateObject153 = leveling_taggedTemplateLiteral(["Noob Cave"]))),
    outfit: {
      offhand: template_string_$item(_templateObject154 || (_templateObject154 = leveling_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))),
      acc1: template_string_$item(_templateObject155 || (_templateObject155 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject156 || (_templateObject156 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    post: () => {
      if (have(template_string_$item(_templateObject157 || (_templateObject157 = leveling_taggedTemplateLiteral(["magical sausage casing"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject158 || (_templateObject158 = leveling_taggedTemplateLiteral(["magical sausage"]))), (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject159 || (_templateObject159 = leveling_taggedTemplateLiteral(["magical sausage casing"])))));
      (0,external_kolmafia_namespaceObject.eat)((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject160 || (_templateObject160 = leveling_taggedTemplateLiteral(["magical sausage"])))), template_string_$item(_templateObject161 || (_templateObject161 = leveling_taggedTemplateLiteral(["magical sausage"]))));
      if (have(template_string_$item(_templateObject162 || (_templateObject162 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");
    }
  }, {
    name: "BoomBox Meat",
    ...
    completed: () => monstersReminisced().includes($monster(_templateObject168 || (_templateObject168 = leveling_taggedTemplateLiteral(["red skeleton"])))),
    do: () => reminisce($monster(_templateObject169 || (_templateObject169 = leveling_taggedTemplateLiteral(["red skeleton"])))),
    combat: new CombatStrategy().macro(combat_Macro.tryItem(template_string_$item(_templateObject170 || (_templateObject170 = leveling_taggedTemplateLiteral(["yellow rocket"])))).abort()),
    outfit: {
    ...
    post: () => {
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject174 || (_templateObject174 = leveling_taggedTemplateLiteral(["red box"]))), 1);
      if (have(template_string_$item(_templateObject175 || (_templateObject175 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");
    },
    limit: {
      tries: 1
    }
    ...
    prepare: () => {
      ...
      if (property_get("umbrellaState") !== "broken") (0,external_kolmafia_namespaceObject.cliExecute)("umbrella ml");
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
      tryAcquiringEffect($effect(_templateObject176 || (_templateObject176 = leveling_taggedTemplateLiteral(["Comic Violence"]))));
    },
    ...
    combat: new CombatStrategy().macro(combat_Macro.if_($monster(_templateObject177 || (_templateObject177 = leveling_taggedTemplateLiteral(["LOV Enforcer"]))), combat_Macro.attack().repeat()).if_($monster(_templateObject178 || (_templateObject178 = leveling_taggedTemplateLiteral(["LOV Engineer"]))), combat_Macro["default"]()).if_($monster(_templateObject179 || (_templateObject179 = leveling_taggedTemplateLiteral(["LOV Equivocator"]))), combat_Macro["default"]())),
    outfit: {
    ...
    post: () => {
      if (have($effect(_templateObject183 || (_templateObject183 = leveling_taggedTemplateLiteral(["Beaten Up"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("hottub");
      if (have(template_string_$item(_templateObject184 || (_templateObject184 = leveling_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"]))))) (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject185 || (_templateObject185 = leveling_taggedTemplateLiteral(["LOV Extraterrestrial Chocolate"]))), 1);
    ...
    do: $location(_templateObject191 || (_templateObject191 = leveling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
    ...
    post: () => {
      if (have(template_string_$item(_templateObject195 || (_templateObject195 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");
    }
  }, {
    name: "God Lobster",
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));
      if (have(template_string_$item(_templateObject196 || (_templateObject196 = leveling_taggedTemplateLiteral(["unbreakable umbrella"])))) && property_get("umbrellaState") !== "broken") (0,external_kolmafia_namespaceObject.cliExecute)("umbrella ml");
      if (have(template_string_$item(_templateObject197 || (_templateObject197 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject198 || (_templateObject198 = leveling_taggedTemplateLiteral(["back"]))), template_string_$item(_templateObject199 || (_templateObject199 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))));
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
      (0,external_kolmafia_namespaceObject.restoreMp)(50);
    },
    completed: () => property_get("_godLobsterFights") >= 3 || !have(template_string_$familiar(_templateObject200 || (_templateObject200 = leveling_taggedTemplateLiteral(["God Lobster"])))),
    do: () => (0,external_kolmafia_namespaceObject.visitUrl)("main.php?fightgodlobster=1"),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    choices: {
      1310: () => have(template_string_$item(_templateObject201 || (_templateObject201 = leveling_taggedTemplateLiteral(["God Lobster's Ring"])))) ? 2 : 3
    },
    ...
    outfit: {
      ...
      famequip: template_string_$items(_templateObject204 || (_templateObject204 = leveling_taggedTemplateLiteral(["God Lobster's Ring, God Lobster's Scepter, none"]))),
      familiar: template_string_$familiar(_templateObject205 || (_templateObject205 = leveling_taggedTemplateLiteral(["God Lobster"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    acquire: [{
      item: template_string_$item(_templateObject206 || (_templateObject206 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }],
    limit: {
      tries: 3
    },
    post: () => {
      if (have(template_string_$item(_templateObject207 || (_templateObject207 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");
    }
  }, {
    name: "Eldritch Tentacle",
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));
      if (have(template_string_$item(_templateObject208 || (_templateObject208 = leveling_taggedTemplateLiteral(["unbreakable umbrella"])))) && property_get("umbrellaState") !== "broken") (0,external_kolmafia_namespaceObject.cliExecute)("umbrella ml");
      if (have(template_string_$item(_templateObject209 || (_templateObject209 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject210 || (_templateObject210 = leveling_taggedTemplateLiteral(["back"]))), template_string_$item(_templateObject211 || (_templateObject211 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))));
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
      (0,external_kolmafia_namespaceObject.restoreMp)(50);
    },
    completed: () => property_get("_eldritchHorrorEvoked") || !have(template_string_$skill(_templateObject212 || (_templateObject212 = leveling_taggedTemplateLiteral(["Evoke Eldritch Horror"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject213 || (_templateObject213 = leveling_taggedTemplateLiteral(["Evoke Eldritch Horror"])))),
    post: () => {
      if (have($effect(_templateObject214 || (_templateObject214 = leveling_taggedTemplateLiteral(["Beaten Up"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("hottub");
      if (have(template_string_$item(_templateObject215 || (_templateObject215 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");
    },
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      ...
      familiar: template_string_$familiar(_templateObject218 || (_templateObject218 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 1
    ...
    do: () => fightPiece($monster(_templateObject223 || (_templateObject223 = leveling_taggedTemplateLiteral(["Witchess Bishop"])))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
    ...
    post: () => {
      if (have(template_string_$item(_templateObject227 || (_templateObject227 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");
    },
    limit: {
      tries: 5
    }
    ...
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));
      if (have(template_string_$item(_templateObject228 || (_templateObject228 = leveling_taggedTemplateLiteral(["unbreakable umbrella"])))) && property_get("umbrellaState") !== "broken") (0,external_kolmafia_namespaceObject.cliExecute)("umbrella ml");
      if (have(template_string_$item(_templateObject229 || (_templateObject229 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject230 || (_templateObject230 = leveling_taggedTemplateLiteral(["back"]))), template_string_$item(_templateObject231 || (_templateObject231 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))));
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
      (0,external_kolmafia_namespaceObject.restoreMp)(50);
    },
    completed: () => property_get("_machineTunnelsAdv") >= 5 || !have(template_string_$familiar(_templateObject232 || (_templateObject232 = leveling_taggedTemplateLiteral(["Machine Elf"])))),
    do: () => (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject233 || (_templateObject233 = leveling_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), -1),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
      ...
      familiar: template_string_$familiar(_templateObject236 || (_templateObject236 = leveling_taggedTemplateLiteral(["Machine Elf"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    limit: {
      tries: 5
    ...
    name: "Powerlevel",
    completed: () => (0,external_kolmafia_namespaceObject.myBasestat)($stat(_templateObject238 || (_templateObject238 = leveling_taggedTemplateLiteral(["Mysticality"])))) >= 175 && ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject239 || (_templateObject239 = leveling_taggedTemplateLiteral(["Yeast of Boris"])))) >= 3 && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject240 || (_templateObject240 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 3 && (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject241 || (_templateObject241 = leveling_taggedTemplateLiteral(["St. Sneaky Pete's Whey"])))) >= 6 || craftedCBBFoods.every(it => have(it) || have((0,external_kolmafia_namespaceObject.effectModifier)(it, "effect")))) && (powerlevelingLocation() !== $location(_templateObject242 || (_templateObject242 = leveling_taggedTemplateLiteral(["The Neverending Party"]))) || property_get("_neverendingPartyFreeTurns") >= 10),
    do: powerlevelingLocation(),
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));
      if (have(template_string_$item(_templateObject243 || (_templateObject243 = leveling_taggedTemplateLiteral(["unbreakable umbrella"])))) && property_get("umbrellaState") !== "broken") (0,external_kolmafia_namespaceObject.cliExecute)("umbrella ml");

      if (have(template_string_$item(_templateObject244 || (_templateObject244 = leveling_taggedTemplateLiteral(["January's Garbage Tote"])))) && property_get("garbageShirtCharge") > 0 && have(template_string_$skill(_templateObject245 || (_templateObject245 = leveling_taggedTemplateLiteral(["Torso Awareness"]))))) {
        if (property_get("garbageShirtCharge") === 1) {
          if ((0,external_kolmafia_namespaceObject.equippedItem)($slot(_templateObject246 || (_templateObject246 = leveling_taggedTemplateLiteral(["shirt"])))) === template_string_$item(_templateObject247 || (_templateObject247 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject248 || (_templateObject248 = leveling_taggedTemplateLiteral(["shirt"]))), template_string_$item.none);
        } else {
          if (!have(template_string_$item(_templateObject249 || (_templateObject249 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("fold makeshift garbage shirt");
          (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject250 || (_templateObject250 = leveling_taggedTemplateLiteral(["shirt"]))), template_string_$item(_templateObject251 || (_templateObject251 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))));
        }
      }

      if (have(template_string_$item(_templateObject252 || (_templateObject252 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject253 || (_templateObject253 = leveling_taggedTemplateLiteral(["back"]))), template_string_$item(_templateObject254 || (_templateObject254 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))));
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
      (0,external_kolmafia_namespaceObject.restoreMp)(50);
    },
    outfit: {
    ...
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject258 || (_templateObject258 = leveling_taggedTemplateLiteral(["Bowl Sideways"])))).default()),
    post: () => {
      if (have(template_string_$item(_templateObject259 || (_templateObject259 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))))) (0,external_kolmafia_namespaceObject.chew)(template_string_$item(_templateObject260 || (_templateObject260 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))), 1);
      if (have(template_string_$item(_templateObject261 || (_templateObject261 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");
    }
  }, {
    ...
    do: () => {
      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject262 || (_templateObject262 = leveling_taggedTemplateLiteral(["wad of dough"])))) < 2) {
        (0,external_kolmafia_namespaceObject.buy)(template_string_$item(_templateObject263 || (_templateObject263 = leveling_taggedTemplateLiteral(["all-purpose flower"]))), 1);
        (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject264 || (_templateObject264 = leveling_taggedTemplateLiteral(["all-purpose flower"]))), 1);
      }

      if (property_get("_speakeasyDrinksDrunk") === 0) {
        tryAcquiringEffect($effect(_templateObject265 || (_templateObject265 = leveling_taggedTemplateLiteral(["Ode to Booze"]))));
      ...
      [].concat(leveling_toConsumableArray(craftedCBBFoods), [template_string_$item(_templateObject266 || (_templateObject266 = leveling_taggedTemplateLiteral(["Deep Dish of Legend"])))]).forEach(it => {
      ...
      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject267 || (_templateObject267 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 4 && !have($effect(_templateObject268 || (_templateObject268 = leveling_taggedTemplateLiteral(["Pretty Delicious"]))))) {
        if (!have(template_string_$item(_templateObject269 || (_templateObject269 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject270 || (_templateObject270 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
        (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject271 || (_templateObject271 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
      }
    },
    post: () => {
      tryAcquiringEffect($effect(_templateObject272 || (_templateObject272 = leveling_taggedTemplateLiteral(["Favored by Lyle"]))));
      tryAcquiringEffect($effect(_templateObject273 || (_templateObject273 = leveling_taggedTemplateLiteral(["Starry-Eyed"]))));
    }
  }, {
    name: "Witchess King",
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));
      if (have(template_string_$item(_templateObject274 || (_templateObject274 = leveling_taggedTemplateLiteral(["unbreakable umbrella"])))) && property_get("umbrellaState") !== "broken") (0,external_kolmafia_namespaceObject.cliExecute)("umbrella ml");

      if (have(template_string_$item(_templateObject275 || (_templateObject275 = leveling_taggedTemplateLiteral(["January's Garbage Tote"])))) && property_get("garbageShirtCharge") > 0 && have(template_string_$skill(_templateObject276 || (_templateObject276 = leveling_taggedTemplateLiteral(["Torso Awareness"]))))) {
        if (property_get("garbageShirtCharge") === 1) {
          if ((0,external_kolmafia_namespaceObject.equippedItem)($slot(_templateObject277 || (_templateObject277 = leveling_taggedTemplateLiteral(["shirt"])))) === template_string_$item(_templateObject278 || (_templateObject278 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject279 || (_templateObject279 = leveling_taggedTemplateLiteral(["shirt"]))), template_string_$item.none);
        } else {
          if (!have(template_string_$item(_templateObject280 || (_templateObject280 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("fold makeshift garbage shirt");
          (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject281 || (_templateObject281 = leveling_taggedTemplateLiteral(["shirt"]))), template_string_$item(_templateObject282 || (_templateObject282 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))));
        }
      }

      if (have(template_string_$item(_templateObject283 || (_templateObject283 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject284 || (_templateObject284 = leveling_taggedTemplateLiteral(["back"]))), template_string_$item(_templateObject285 || (_templateObject285 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))));
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
      (0,external_kolmafia_namespaceObject.restoreMp)(50);
    },
    completed: () => monstersReminisced().includes($monster(_templateObject286 || (_templateObject286 = leveling_taggedTemplateLiteral(["Witchess King"])))),
    do: () => reminisce($monster(_templateObject287 || (_templateObject287 = leveling_taggedTemplateLiteral(["Witchess King"])))),
    combat: new CombatStrategy().macro(combat_Macro["default"]()),
    outfit: {
    ...
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)(clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)()));
      if (have(template_string_$item(_templateObject291 || (_templateObject291 = leveling_taggedTemplateLiteral(["unbreakable umbrella"])))) && property_get("umbrellaState") !== "broken") (0,external_kolmafia_namespaceObject.cliExecute)("umbrella ml");

      if (have(template_string_$item(_templateObject292 || (_templateObject292 = leveling_taggedTemplateLiteral(["January's Garbage Tote"])))) && property_get("garbageShirtCharge") > 0 && have(template_string_$skill(_templateObject293 || (_templateObject293 = leveling_taggedTemplateLiteral(["Torso Awareness"]))))) {
        if (property_get("garbageShirtCharge") === 1) {
          if ((0,external_kolmafia_namespaceObject.equippedItem)($slot(_templateObject294 || (_templateObject294 = leveling_taggedTemplateLiteral(["shirt"])))) === template_string_$item(_templateObject295 || (_templateObject295 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject296 || (_templateObject296 = leveling_taggedTemplateLiteral(["shirt"]))), template_string_$item.none);
        } else {
          if (!have(template_string_$item(_templateObject297 || (_templateObject297 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("fold makeshift garbage shirt");
          (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject298 || (_templateObject298 = leveling_taggedTemplateLiteral(["shirt"]))), template_string_$item(_templateObject299 || (_templateObject299 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))));
        }
      }

      if (have(template_string_$item(_templateObject300 || (_templateObject300 = leveling_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))) && property_get("_chestXRayUsed") < 3) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject301 || (_templateObject301 = leveling_taggedTemplateLiteral(["acc3"]))), template_string_$item(_templateObject302 || (_templateObject302 = leveling_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
      if (have(template_string_$item(_templateObject303 || (_templateObject303 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))))) (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject304 || (_templateObject304 = leveling_taggedTemplateLiteral(["back"]))), template_string_$item(_templateObject305 || (_templateObject305 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))));
      (0,external_kolmafia_namespaceObject.restoreMp)(50);
      usefulEffects.forEach(ef => tryAcquiringEffect(ef));
    },
    outfit: {
      offhand: template_string_$item(_templateObject306 || (_templateObject306 = leveling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      acc1: template_string_$item(_templateObject307 || (_templateObject307 = leveling_taggedTemplateLiteral(["codpiece"]))),
      familiar: template_string_$familiar(_templateObject308 || (_templateObject308 = leveling_taggedTemplateLiteral(["Cookbookbat"]))),
      modifier: "0.25 mys, 0.33 ML, -equip tinsel tights, -equip wad of used tape"
    },
    completed: () => property_get("_shatteringPunchUsed") >= 3 && property_get("_gingerbreadMobHitUsed") && have($effect(_templateObject309 || (_templateObject309 = leveling_taggedTemplateLiteral(["Pretty Delicious"])))) && (have($effect(_templateObject310 || (_templateObject310 = leveling_taggedTemplateLiteral(["Awfully Wily"])))) || (0,external_kolmafia_namespaceObject.myBasestat)($stat(_templateObject311 || (_templateObject311 = leveling_taggedTemplateLiteral(["Mysticality"])))) >= 190),
    do: powerlevelingLocation(),
    combat: new CombatStrategy().macro(combat_Macro.trySkill(template_string_$skill(_templateObject312 || (_templateObject312 = leveling_taggedTemplateLiteral(["Feel Pride"])))).trySkill(template_string_$skill(_templateObject313 || (_templateObject313 = leveling_taggedTemplateLiteral(["Chest X-Ray"])))).trySkill(template_string_$skill(_templateObject314 || (_templateObject314 = leveling_taggedTemplateLiteral(["Shattering Punch"])))).trySkill(template_string_$skill(_templateObject315 || (_templateObject315 = leveling_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).trySkill(template_string_$skill(_templateObject316 || (_templateObject316 = leveling_taggedTemplateLiteral(["Bowl Sideways"])))).default()),
    choices: {
      1094: 5,
      1115: 6,
      1322: 2,
    ...
    post: () => {
      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject317 || (_templateObject317 = leveling_taggedTemplateLiteral(["Vegetable of Jarlsberg"])))) >= 4 && !have($effect(_templateObject318 || (_templateObject318 = leveling_taggedTemplateLiteral(["Pretty Delicious"]))))) {
        if (!have(template_string_$item(_templateObject319 || (_templateObject319 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))))) (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject320 || (_templateObject320 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
        (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject321 || (_templateObject321 = leveling_taggedTemplateLiteral(["baked veggie ricotta casserole"]))), 1);
      }

      if ((0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject322 || (_templateObject322 = leveling_taggedTemplateLiteral(["St. Sneaky Pete's Whey"])))) >= 1 && !have($effect(_templateObject323 || (_templateObject323 = leveling_taggedTemplateLiteral(["Awfully Wily"]))))) {
        (0,external_kolmafia_namespaceObject.create)(template_string_$item(_templateObject324 || (_templateObject324 = leveling_taggedTemplateLiteral(["Pete's wiley whey bar"]))), 1);
        (0,external_kolmafia_namespaceObject.eat)(template_string_$item(_templateObject325 || (_templateObject325 = leveling_taggedTemplateLiteral(["Pete's wiley whey bar"]))), 1);
      }

      if (have(template_string_$item(_templateObject326 || (_templateObject326 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))))) (0,external_kolmafia_namespaceObject.chew)(template_string_$item(_templateObject327 || (_templateObject327 = leveling_taggedTemplateLiteral(["SMOOCH coffee cup"]))), 1);
      if (have(template_string_$item(_templateObject328 || (_templateObject328 = leveling_taggedTemplateLiteral(["autumn-aton"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("autumnaton send Shadow Rift");
    },
    limit: {
      tries: 20
    }
