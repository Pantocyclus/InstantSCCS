...
const defaultHandlers = {
    [LogLevels.INFO]: (message) => {
        require$$0.printHtml(`<b>[Libram Info]</b> ${message}`);
        require$$0.logprint(`[Libram] ${message}`);
        return;
    },
    [LogLevels.WARNING]: (message) => {
        require$$0.printHtml(`<span style="background: orange; color: white;"><b>[Libram Warning]</b> ${message}</span>`);
        require$$0.logprint(`[Libram] ${message}`);
        return;
    },
    [LogLevels.ERROR]: (error) => {
        require$$0.printHtml(`<span style="background: red; color: white;"><b>[Libram Error]</b> ${error.toString()}</span>`);
        require$$0.logprint(`[Libram] ${error}`);
        return;
    },
    [LogLevels.DEBUG]: (message) => {
        require$$0.printHtml(`<span style="background: red; color: white;"><b>[Libram Debug]</b> ${message}</span>`);
        require$$0.logprint(`[Libram] ${message}`);
        return;
    },
};
...
const createPropertyGetter = (transform) => (property, default_) => {
    const value = require$$0.getProperty(property);
...
const getFamiliar = createMafiaClassPropertyGetter(require$$0.Familiar, require$$0.toFamiliar, familiarNumericProperties);
const getItem = createMafiaClassPropertyGetter(require$$0.Item, require$$0.toItem, itemNumericProperties);
const getLocation = createMafiaClassPropertyGetter(require$$0.Location, require$$0.toLocation);
const getMonster = createMafiaClassPropertyGetter(require$$0.Monster, require$$0.toMonster, monsterNumericProperties);
const getPhylum = createMafiaClassPropertyGetter(require$$0.Phylum, require$$0.toPhylum);
const getStat = createMafiaClassPropertyGetter(require$$0.Stat, require$$0.toStat);
/**
...
const handleTypeGetError = (Type, error) => {
    ...
    if (match) {
        require$$0.print(`${match[0]}; if you're certain that this ${Type.name} exists and is spelled correctly, please update KoLMafia`, "red");
    }
    else {
 ...
 * @category In-game constant
 */
const $effect = createSingleConstant(require$$0.Effect, require$$0.toEffect);
/**
 ...
 * @category In-game constant
 */
const $effects = createPluralConstant(require$$0.Effect);
/**
 * An Element specified by name.
 *
 * @category In-game constant
 */
const $element = createSingleConstant(require$$0.Element, require$$0.toElement);
/**
 ...
 * @category In-game constant
 */
const $familiar = createSingleConstant(require$$0.Familiar, require$$0.toFamiliar);
/**
 ...
 * @category In-game constant
 */
const $item = createSingleConstant(require$$0.Item, require$$0.toItem);
/**
 ...
 * @category In-game constant
 */
const $items = createPluralConstant(require$$0.Item);
/**
 ...
 * @category In-game constant
 */
const $monsters = createPluralConstant(require$$0.Monster);
/**
 * A Path specified by name.
 *
 * @category In-game constant
 */
const $path = createSingleConstant(require$$0.Path, require$$0.toPath);
/**
 ...
 * @category In-game constant
 */
const $skill = createSingleConstant(require$$0.Skill, require$$0.toSkill);
/**
 ...
 * @category In-game constant
 */
const $skills = createPluralConstant(require$$0.Skill);
/**
 * A Slot specified by name.
 *
 * @category In-game constant
 */
const $slot = createSingleConstant(require$$0.Slot, require$$0.toSlot);
/**
 ...
 * @category In-game constant
 */
const $slots = createPluralConstant(require$$0.Slot);
/**
 * A Stat specified by name.
 *
 * @category In-game constant
 */
const $stat = createSingleConstant(require$$0.Stat, require$$0.toStat);
/**
 ...
 * @category In-game constant
 */
const $stats = createPluralConstant(require$$0.Stat);
/**
 * A Thrall specified by name.
 *
 * @category In-game constant
 */
const $thrall = createSingleConstant(require$$0.Thrall, require$$0.toThrall);
/**
 ...
 */
function have(thing, quantity = 1) {
    ...
    if (thing instanceof require$$0.Thrall) {
        const thrall = require$$0.myThrall();
 ...
 */
function getFoldGroup(item, cache = true) {
    if (cache) {
        const cached = foldGroupCache.get(item);
        if (cached !== undefined)
            return cached;
    }
    const result = Object.entries(require$$0.getRelated(item, "fold"))
        .sort(([, a], [, b]) => a - b)
        .map(([i]) => require$$0.Item.get(i));
 ...
 */
function totalFamiliarWeight(familiar = require$$0.myFamiliar(), considerAdjustment = true) {
    return clamp(clamp(require$$0.familiarWeight(familiar), have($effect `Fidoxene`) ? 20 : 0, Infinity) +
        familiar.soupWeight +
        (considerAdjustment ? require$$0.weightAdjustment() : 0) +
        (familiar.feasted ? 10 : 0), 1, Infinity);
}
...
const modeableState = {
    ...
    retrocape: () => require$$0.getProperty("retroCapeSuperhero") +
        " " +
        require$$0.getProperty("retroCapeWashingInstructions"),
...
function saveOutfit(name) {
    require$$0.cliExecute(`outfit save ${name}`);
}
...
function canEquipItemCount() {
    const stats = $stats `Muscle, Mysticality, Moxie`.map((stat) => Math.min(require$$0.myBasestat(stat), 300));
...
function applyCached(entry, options) {
    ...
    if (outfitName) {
        ...
        if (familiarEquip)
            require$$0.equip($slot `familiar`, familiarEquip);
    }
    else {
    ...
    if (require$$0.equippedAmount($item `Crown of Thrones`) > 0 &&
        entry.rider.get($item `Crown of Thrones`)) {
        require$$0.enthroneFamiliar(entry.rider.get($item `Crown of Thrones`) || $familiar.none);
    }
    if (require$$0.equippedAmount($item `Buddy Bjorn`) > 0 &&
        entry.rider.get($item `Buddy Bjorn`)) {
        require$$0.bjornifyFamiliar(entry.rider.get($item `Buddy Bjorn`) || $familiar.none);
    }
...
function verifyCached(entry, warn = true) {
    ...
    for (const slotGroup of slotStructure) {
        ...
        const equippedSet = desiredSlots.map(([slot]) => require$$0.equippedItem(slot));
    ...
    if (require$$0.equippedAmount($item `Crown of Thrones`) > 0 &&
        entry.rider.get($item `Crown of Thrones`)) {
        if (entry.rider.get($item `Crown of Thrones`) !== require$$0.myEnthronedFamiliar()) {
            if (warn) {
    ...
    if (require$$0.equippedAmount($item `Buddy Bjorn`) > 0 &&
        entry.rider.get($item `Buddy Bjorn`)) {
        if (entry.rider.get($item `Buddy Bjorn`) !== require$$0.myBjornedFamiliar()) {
            if (warn) {
...
function saveCached(cacheKey, options) {
    ...
    for (const slot of cachedSlots) {
        equipment.set(slot, require$$0.equippedItem(slot));
    }
    if (require$$0.equippedAmount($item `card sleeve`) > 0) {
        equipment.set($slot `card-sleeve`, require$$0.equippedItem($slot `card-sleeve`));
    }
    if (require$$0.equippedAmount($item `Crown of Thrones`) > 0) {
        rider.set($item `Crown of Thrones`, require$$0.myEnthronedFamiliar());
    }
    if (require$$0.equippedAmount($item `Buddy Bjorn`) > 0) {
        rider.set($item `Buddy Bjorn`, require$$0.myBjornedFamiliar());
    }
    ...
    if (options.onlySlot && options.onlySlot.length > 0) {
        for (const slot of require$$0.Slot.all()) {
    ...
    const entry = new CacheEntry(equipment, rider, require$$0.myFamiliar(), canEquipItemCount(), { ...getCurrentModes(), ...options.modes });
...
function maximizeCached(objectives, options = {}) {
    ...
    const cacheKey = [
        objective,
        ...untouchedSlots
            .map((slot) => `${slot}:${require$$0.equippedItem(slot)}`)
            .sort(),
        have($effect `Offhand Remarkable`),
        options.updateOnLocationChange && require$$0.myLocation(),
    ].join("; ");
    ...
    const result = require$$0.maximize(objective, false);
...
const stringModifiers = ["Class", "Intrinsic Effect", "Equalize", "Wiki Name", "Modifiers", "Outfit", "Stat Tuning", "Equips On", "Familiar Effect", "Jiggle", "Equalize Muscle", "Equalize Mysticality", "Equalize Moxie", "Avatar", "Skill", "Floor Buffed Muscle", "Floor Buffed Mysticality", "Floor Buffed Moxie", "Plumber Stat", "Recipe", "Evaluated Modifiers", "Last Available"];
...
const multiStringModifiers = ["Effect", "Rollover Effect", "Conditional Skill (Equipped)", "Conditional Skill (Inventory)", "Lantern Element"];
...
function currentCostumes() {
    return new Map(Object.entries(require$$0.splitModifiers(get("_mummeryMods")))
        .map(([modifier, value]) => {
        ...
        if (!matcher)
            return null;
        return [
            require$$0.Familiar.get(matcher[2]),
...
const clanIdCache = {};
const toPlayerId = (player) => typeof player === "string" ? require$$0.getPlayerId(player) : player;
...
class Clan {
    ...
    name;
    static _join(id) {
        const result = require$$0.visitUrl(`showclan.php?recruiter=1&whichclan=${id}&pwd&whichclan=${id}&action=joinclan&apply=Apply+to+this+Clan&confirm=on`);
    ...
    static getWhitelisted() {
        const page = require$$0.visitUrl("clan_signup.php");
        return require$$0.xpath(page, '//select[@name="whichclan"]//option').map((option) => {
            const validHtml = `<select>${option}</select>`;
            const id = Number.parseInt(require$$0.xpath(validHtml, "//@value")[0]);
            const name = decodeHTML(require$$0.xpath(validHtml, "//text()")[0]);
     ...
     */
    check() {
        return require$$0.visitUrl("clan_hall.php").includes(`<b>${this.name}</b>`);
    }
    /**
    ...
    getCurrentFax() {
        this._check();
        const logs = require$$0.visitUrl("clan_log.php");
    ...
    getRanks() {
        this._check();
        const page = require$$0.visitUrl("clan_whitelist.php");
        return require$$0.xpath(page, '//select[@name="level"]//option')
            .map((option) => {
            const validHtml = `<select>${option}</select>`;
            const match = require$$0.xpath(validHtml, "//text()")[0].match(WHITELIST_DEGREE_PATTERN);
            const id = require$$0.xpath(validHtml, "//@value")[0];
            if (!match || !id)
                return null;
    ...
    addPlayerToWhitelist(player, rankName, title = "") {
        ...
        if (!rank)
            return false;
        const result = require$$0.visitUrl(`clan_whitelist.php?action=add&pwd&addwho=${playerId}&level=${rank.id}&title=${title}`);
    ...
    removePlayerFromWhitelist(player) {
        this._check();
        const playerId = toPlayerId(player);
        const result = require$$0.visitUrl(`clan_whitelist.php?action=updatewl&pwd&who=${playerId}&remove=Remove`);
    ...
    getMeatInCoffer() {
        this._check();
        const page = require$$0.visitUrl("clan_stash.php");
    ...
    putMeatInCoffer(amount) {
        this._check();
        const result = require$$0.visitUrl(`clan_stash.php?pwd&action=contribute&howmuch=${amount}`);
    ...
    take(items) {
        ...
        map.forEach((quantity, item) => {
            let needed = Math.max(0, quantity - require$$0.availableAmount(item));
            if (needed === 0) {
                return map.set(item, 0);
            }
            const foldGroup = getFoldGroup(item);
            for (const foldable of foldGroup) {
                const quantityToFold = Math.min(needed, require$$0.availableAmount(foldable));
                for (let i = 0; i < quantityToFold; i++) {
                    require$$0.cliExecute(`fold ${item.name}`);
                    needed--;
                }
            ...
            for (const matchingItem of [item, ...foldGroup]) {
                const quantityToTake = Math.min(needed, require$$0.stashAmount(matchingItem));
                if (quantityToTake === 0)
                    continue;
                // If we can't take from the stash, there's no sense in iterating through the whole fold group
                if (!require$$0.takeStash(quantityToTake, matchingItem))
                    return;
                if (matchingItem === item) {
                    ...
                    for (let i = 0; i < quantityToTake; i++) {
                        require$$0.cliExecute(`fold ${matchingItem.name}`);
                        needed--;
                    }
                }
            }
    ...
    put(items) {
        ...
        map.forEach((quantity, item) => {
            ...
            const returned = Math.min(quantity, require$$0.availableAmount(item));
...
const statCommunityServicePredictor = (stat) => {
    return () => 60 -
        Math.floor((1 / 30) *
            (require$$0.myBuffedstat(stat) -
                require$$0.myBasestat(thralls.get(stat) === require$$0.myThrall() && !have($effect `Expert Oiliness`)
                    ? $stat `mysticality`
                    : stat)));
};
const visitCouncil = () => require$$0.visitUrl("council.php");
...
function hypotheticalModifier(modifier, ...effects) {
    ...
    return (require$$0.numericModifier(modifier) +
        sum(newEffects, (effect) => require$$0.numericModifier(effect, modifier)));
}
class CommunityService {
     ...
     */
    startTimer() {
        this.timer ??= { time: Date.now(), turns: require$$0.myTurncount() };
    }
    ...
    static startTimer(name) {
        if (!this.taskTimers.has(name)) {
            this.taskTimers.set(name, { time: Date.now(), turns: require$$0.myTurncount() });
        }
    }
    ...
    do() {
        if (get("csServicesPerformed").trim().length === 0)
            visitCouncil();
        visitCouncil();
        const councilText = require$$0.runChoice(this.choice);
    ...
    static printLog(colour = "blue") {
        ...
        for (const [testName, testEntry] of logEntries) {
            ...
            if (type === "test") {
                require$$0.print(`We predicted the ${testName} test would take ${predictedTurns} turns, ${predictedTurns === turnCost ? "and" : "but"} it took ${turnCost} turns.`, colour);
                require$$0.print(`${testName} took ${seconds.toFixed(1)} seconds.`, colour);
            }
            else {
                if (!(predictedTurns === 0 && turnCost === 0)) {
                    require$$0.print(`We predicted the task ${testName} would take ${predictedTurns} turns, ${predictedTurns === turnCost ? "and" : "but"} it took ${turnCost} turns.`, colour);
                }
                require$$0.print(`The task ${testName} took ${seconds.toFixed(1)} seconds.`, colour);
            }
        }
        const totalTime = sum(logEntries, ([, testEntry]) => testEntry.seconds);
        require$$0.print(`All together, you have spent ${totalTime.toFixed(1)} seconds during this Community Service run`, colour);
    }
    // Below, we have the tests themselves.
    static HP = new CommunityService(1, "HP", "Donate Blood", () => 60 - Math.floor((require$$0.myMaxhp() - require$$0.myBuffedstat($stat `muscle`) - 3) / 30), new Requirement(["HP"], {}));
    ...
    static FamiliarWeight = new CommunityService(5, "Familiar Weight", "Breed More Collies", (...effects) => 60 -
        Math.floor((totalFamiliarWeight(require$$0.myFamiliar(), false) +
    ...
    static WeaponDamage = new CommunityService(6, "Weapon Damage", "Reduce Gazelle Population", (...effects) => {
        const weaponPower = require$$0.getPower(require$$0.equippedItem($slot `weapon`));
        const offhandPower = require$$0.toSlot(require$$0.equippedItem($slot `off-hand`)) === $slot `weapon`
            ? require$$0.getPower(require$$0.equippedItem($slot `off-hand`))
            : 0;
        const familiarPower = require$$0.toSlot(require$$0.equippedItem($slot `familiar`)) === $slot `weapon`
            ? require$$0.getPower(require$$0.equippedItem($slot `familiar`))
            : 0;
    ...
    static SpellDamage = new CommunityService(7, "Spell Damage", "Make Sausage", (...effects) => {
        const dragonfishDamage = require$$0.myFamiliar() === $familiar `Magic Dragonfish`
            ? require$$0.numericModifier($familiar `Magic Dragonfish`, "Spell Damage Percent", totalFamiliarWeight(), $item.none)
            : 0;
        // We add 0.001 because the floor function sometimes introduces weird rounding errors
        return (60 -
    ...
    static Noncombat = new CommunityService(8, "Non-Combat", "Be a Living Statue", (...effects) => {
        const noncombatRate = -1 * hypotheticalModifier("Raw Combat Rate", ...effects);
        const currentFamiliarModifier = -1 *
            require$$0.numericModifier(require$$0.myFamiliar(), "Raw Combat Rate", totalFamiliarWeight(), require$$0.equippedItem($slot `familiar`));
        const newFamiliarModifier = -1 *
            require$$0.numericModifier(require$$0.myFamiliar(), "Raw Combat Rate", totalFamiliarWeight(require$$0.myFamiliar(), false) +
                hypotheticalModifier("Familiar Weight", ...effects), require$$0.equippedItem($slot `familiar`));
        const adjustedRate = noncombatRate - currentFamiliarModifier + newFamiliarModifier;
    ...
    static BoozeDrop = new CommunityService(9, "Item Drop", "Make Margaritas", (...effects) => {
        const mummingCostume = currentCostumes().get(require$$0.myFamiliar());
        const mummingBuff = mummingCostume && mummingCostume[0] === "Item Drop"
            ? mummingCostume[1]
            : 0;
        const familiarItemDrop = require$$0.numericModifier(require$$0.myFamiliar(), "Item Drop", totalFamiliarWeight(), require$$0.equippedItem($slot `familiar`)) +
            mummingBuff -
            require$$0.numericModifier(require$$0.equippedItem($slot `familiar`), "Item Drop");
        const familiarBoozeDrop = require$$0.numericModifier(require$$0.myFamiliar(), "Booze Drop", totalFamiliarWeight(), require$$0.equippedItem($slot `familiar`)) - require$$0.numericModifier(require$$0.equippedItem($slot `familiar`), "Booze Drop");
        // Champagne doubling does NOT count for CS, so we undouble
        const multiplier = require$$0.haveEquipped($item `broken champagne bottle`) &&
        ...
        return (60 -
            Math.floor((multiplier *
                (hypotheticalModifier("Item Drop", ...effects) -
                    familiarItemDrop -
                    require$$0.numericModifier(require$$0.myThrall(), "Item Drop"))) /
                30 +
                0.001) -
    ...
    static HotRes = new CommunityService(10, "Hot Resistance", "Clean Steam Tunnels", (...effects) => {
        const currentFamiliarModifier = require$$0.numericModifier(require$$0.myFamiliar(), "Hot Resistance", totalFamiliarWeight(), require$$0.equippedItem($slot `familiar`));
        const newFamiliarModifier = require$$0.numericModifier(require$$0.myFamiliar(), "Hot Resistance", totalFamiliarWeight(require$$0.myFamiliar(), false) +
            hypotheticalModifier("Familiar Weight", ...effects), require$$0.equippedItem($slot `familiar`));
        return (60 -
